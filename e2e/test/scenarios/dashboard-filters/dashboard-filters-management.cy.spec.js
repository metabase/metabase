...
describe("scenarios > dashboard > filters > management", () => {
  ...
  describe("change parameter type", () => {
    it("should reset existing filter mappings, default value and generate unique label", () => {
      ...
      sidebar().within(() => {
        cy.findByLabelText("Label").should("have.value", "Between");
  ...
  describe("change parameter operator", () => {
    it("should not reset filter mappings, but reset default value and label", () => {
      createDashboardWithFilterAndQuestionMapped();
