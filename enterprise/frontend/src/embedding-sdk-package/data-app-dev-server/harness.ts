// The data-app dev harness. This file is NOT compiled by this repo — the dev
// server plugin reads it verbatim and serves it as a Vite virtual module, so it
// runs in the consumer's app where `react`, `react-dom`, and
...
async function loadAndRender() {
  ...
  if (!res.ok) {
    throw new Error(
      "Failed to load the data-app bundle: " +
        res.status +
        " " +
        res.statusText +
        ".",
