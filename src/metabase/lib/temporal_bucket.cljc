  ...
  (let [n    (interval-n->int n)
    ...
    (case (keyword unit)
      :millisecond     (temporal-interval-tru n
                                              ...
                                              (i18n/trun "Previus millisecond" "Previous {0} milliseconds" (abs n))
      ...
      :second          (temporal-interval-tru n
                                              ...
                                              (i18n/trun "Previus second" "Previous {0} seconds" (abs n))
