...
(mu/defn remote-synced-collection-ids :- [:maybe [:set ms/PositiveInt]]
...
(mu/defn is-remote-synced-by-id :- [:sequential [:map {:closed true} [:id ms/PositiveInt] [:is_remote_synced :any]]]
