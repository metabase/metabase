import { useQuestionVisualization } from "embedding-sdk/components/private/Question/hooks/use-question-visualization";
 ...
 * @category Question
 */
export type QuestionChartTypeSelectorProps = StackProps;
...
export const ChartTypeSelector = ({
  ...stackProps
}: QuestionChartTypeSelectorProps) => {
