...
const testColumns: DatasetColumn[] = [
  ...
  },
  {
    ...
    unit: "default",
    name: "CREATED_AT",
    desired_column_alias: "CREATED_AT",
    settings: {},
    source: "fields",
    field_ref: [
      "field",
