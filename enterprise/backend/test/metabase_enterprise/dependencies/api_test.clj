...
(deftest ^{:parallel false} table-dependents-all-types-test
...
(deftest ^{:parallel false} dependents-multiple-types-test
...
(deftest ^{:parallel false} dependents-multiple-card-types-test
...
(deftest ^{:parallel false} dependents-inactive-table-test
...
(deftest ^{:parallel false} dependents-broken-parameter-test
...
#_(deftest ^{:parallel false} graph-archived-measure-in-chain-test
...
(deftest ^{:parallel false} graph-view-count-test
...
(deftest ^{:parallel false} unreferenced-questions-test
...
(deftest ^{:parallel false} unreferenced-tables-test
...
(deftest ^{:parallel false} unreferenced-transforms-test
...
(deftest ^{:parallel false} unreferenced-snippets-test
...
(deftest ^{:parallel false} unreferenced-dashboards-test
...
(deftest ^{:parallel false} unreferenced-documents-test
...
(deftest ^{:parallel false} unreferenced-sandboxes-test
...
(deftest ^{:parallel false} unreferenced-card-types-test
...
(deftest ^{:parallel false} unreferenced-archived-card-test
...
(deftest ^{:parallel false} unreferenced-archived-dashboard-test
...
(deftest ^{:parallel false} unreferenced-archived-document-test
...
(deftest ^{:parallel false} unreferenced-archived-snippet-test
...
(deftest ^{:parallel false} unreferenced-excludes-internal-content-test
...
(deftest ^{:parallel false} breaking-entities-includes-internal-content-test
...
(deftest ^{:parallel false} unreferenced-archived-segment-test
...
(deftest ^{:parallel false} unreferenced-archived-table-test
...
(deftest ^{:parallel false} unreferenced-pagination-test
...
(deftest ^{:parallel false} unreferenced-sample-db-test
...
(deftest ^{:parallel false} unreferenced-audit-db-test
...
(deftest ^{:parallel false} unreferenced-archived-measure-test
...
(deftest ^{:parallel false} unreferenced-personal-collection-card-test
...
(deftest ^{:parallel false} unreferenced-personal-collection-dashboard-test
...
(deftest ^{:parallel false} unreferenced-sort-by-name-test
...
(deftest ^{:parallel false} unreferenced-sort-by-location-test
...
(deftest ^{:parallel false} unreferenced-sort-by-location-with-root-collection-test
...
(deftest ^{:parallel false} breaking-entities-returns-source-of-errors-test
...
(deftest ^{:parallel false} breaking-entities-types-filtering-test
...
(deftest ^{:parallel false} breaking-entities-archived-card-test
...
(deftest ^{:parallel false} breaking-entities-inactive-table-test
  (testing "GET /api/ee/dependencies/graph/breaking?types=table includes an inactive table that breaks a non-archived dependent"
    (mt/with-premium-features #{:dependencies}
      (mt/with-temp [:model/Database db    {:engine :h2, :name "inactive-table-breaking-test"}
                     :model/Table    table {:db_id (:id db), :name "RETIRED_TABLE", :active true}
                     :model/Field    _field {:table_id (:id table), :name "ID"
                                             :base_type :type/Integer, :database_type "INTEGER"}
                     :model/User     user  {:email "test@test.com"}]
        (mt/with-model-cleanup [:model/Card :model/Dependency :model/DependencyStatus
                                :model/AnalysisFinding :model/AnalysisFindingError]
          (let [query (lib-be/with-metadata-provider-cache
                        (let [mp (lib-be/application-database-metadata-provider (:id db))]
                          (lib/query mp (lib.metadata/table mp (:id table)))))]
            (mt/with-temp [:model/Card card {:database_id   (:id db)
                                             :dataset_query query
                                             :type          :question
                                             :name          "Dependent of retired table"
                                             :creator_id    (:id user)}
...
(deftest ^{:parallel false} breaking-entities-multiple-dependents-test
...
(deftest ^{:parallel false} breaking-entities-personal-collection-card-test
...
(deftest ^{:parallel false} breaking-entities-pagination-test
...
(deftest ^{:parallel false} breaking-entities-sort-by-name-test
...
(deftest ^{:parallel false} breaking-entities-sort-by-location-test
...
(deftest ^{:parallel false} breaking-entities-sort-by-dependents-with-errors-count-test
...
(deftest ^{:parallel false} breaking-entities-sort-by-dependents-with-errors-test
  (testing "GET /api/ee/dependencies/graph/breaking - sorting by dependents with errors count"
    (mt/with-premium-features #{:dependencies}
      (mt/with-temp [:model/User user {:email "test@test.com"}]
        (mt/with-model-cleanup [:model/Card :model/Dependency :model/DependencyStatus :model/AnalysisFinding :model/AnalysisFindingError]
...
(deftest ^{:parallel false} dependents-query-filter-test
...
(deftest ^{:parallel false} dependents-query-filter-by-location-test
...
(deftest ^{:parallel false} dependents-personal-collections-test
...
(deftest ^{:parallel false} dependents-sort-by-name-test
...
(deftest ^{:parallel false} dependents-sort-by-location-test
...
(deftest ^{:parallel false} dependents-sort-by-view-count-test
...
(deftest ^{:parallel false} dependents-sort-view-count-mixed-types-test
...
(deftest ^{:parallel false} dependents-query-and-sort-combined-test
...
(deftest ^{:parallel false} node-errors-filtering-test
...
(deftest ^{:parallel false} node-downstream-errors-filtering-test
...
(deftest ^{:parallel false} broken-endpoint-error-visibility-filtering-test
...
(deftest ^{:parallel false} broken-endpoint-sort-by-visible-errors-only-test
...
(deftest ^{:parallel false} unreferenced-pagination-with-archived-items-test
...
(deftest ^{:parallel false} unreferenced-pagination-with-archived-dependents-test
...
(deftest ^{:parallel false} broken-dependents-source-filtering-test
...
(deftest ^{:parallel false} broken-count-and-sorting-test
...
(deftest ^{:parallel false} broken-requires-read-permission-test
...
(deftest ^{:parallel false} broken-no-transitive-breakage-test
...
(deftest ^{:parallel false} broken-filter-by-dependent-types-test
...
(deftest ^{:parallel false} broken-personal-collections-test
...
(deftest ^{:parallel false} unreferenced-table-owner-test
...
(deftest ^{:parallel false} unreferenced-transform-owner-test
