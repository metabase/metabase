...
(def legal-top-level-paths
  ...
  #{"actions" "channels" "collections" "custom_viz_plugins" "databases" "embedding_themes" "glossary" "metabots" "python_libraries" "python-libraries" "semantic_layer_index" "snippets" "transforms"})
