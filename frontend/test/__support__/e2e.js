 ...
 */
export const BROWSER_HISTORY_PUSH = `e2e-tests/BROWSER_HISTORY_PUSH`;
export const BROWSER_HISTORY_REPLACE = `e2e-tests/BROWSER_HISTORY_REPLACE`;
export const BROWSER_HISTORY_POP = `e2e-tests/BROWSER_HISTORY_POP`;
...
if (
  ...
  console.log(
    "Please use `yarn run test-e2e` or `yarn run test-e2e-watch` for running integration tests.",
  );
  process.quit(0);
}
