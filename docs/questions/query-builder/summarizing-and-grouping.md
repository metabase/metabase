...
This page covers the Summarize and Grouping steps in the [query builder](./editor.md).
...
If your admins have created any named [metrics](../../data-modeling/metrics.md) or [measures](../../semantic-layer/measures.md) that are specific to your company or organization, they will be in this dropdown under the **Metrics** or **Measures** section. These might be things like your company’s official way of calculating revenue.
