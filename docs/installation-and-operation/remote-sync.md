...
Remote Sync does NOT sync the data model, so if you're importing and exporting your [table metadata](../data-modeling/metadata-editing.md), you should stick with serialization.