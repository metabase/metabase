...
describe("collections reproductions", () => {
  before(() => {
    H.restore();
  });

  // Modifies collection permissions via UI
  ...
  // Modifies shared questions via API (moves ORDERS_QUESTION_ID)
  ...
  // Calls H.activateToken (modifies settings)
