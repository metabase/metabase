...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetabaseApi.ApiPulseTestPostRequest();
  });
  ...
  describe('ApiPulseTestPostRequest', function() {
    it('should create an instance of ApiPulseTestPostRequest', function() {
      // uncomment below and update the code to test ApiPulseTestPostRequest
      //var instance = new MetabaseApi.ApiPulseTestPostRequest();
      //expect(instance).to.be.a(MetabaseApi.ApiPulseTestPostRequest);
    });
