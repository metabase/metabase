...
2. Run `cd release && pnpm && pnpm release-offline v0.77.77 1234567890abcdef1234567890abcdef12345678 --build`
3. Wait for the build and test jobs to finish
...
5. If everything is successful, run `pnpm release-offline v0.77.77 1234567890abcdef1234567890abcdef12345678 --publish`
...
```
pnpm release-offline v0.77.77 1234567890abcdef1234567890abcdef12345678 --publish --without-github --not-latest
```
or
```
pnpm release-offline v0.77.77 1234567890abcdef1234567890abcdef12345678 --publish --without-github --latest
```
...
```sh
pnpm generate-changelog v0.77.0 > changelog.log
```
