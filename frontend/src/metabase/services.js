...
export const StoreApi = {
  ...
  billingInfo: () => {
    // TODO: use real endpoint, send along language, email, and token
    // GET("/api//api/v2/metabase/billing_info"),
      ...
      setTimeout(() => {
        resolve([
          ...
          },
          {
            ...
            type: "link",
            value: "https://store.metabase.com/",
