...
CREATE TABLE "test-data"."PUBLIC"."users" (
...
CREATE TABLE "test-data"."PUBLIC"."categories" (
  "id" INTEGER AUTOINCREMENT,
  "name" TEXT NOT NULL,
  PRIMARY KEY ("id")
);
...
CREATE TABLE "test-data"."PUBLIC"."venues" (
  "id" INTEGER AUTOINCREMENT,
  "name" TEXT,
  "category_id" INTEGER,
  "latitude" FLOAT,
...
CREATE TABLE "test-data"."PUBLIC"."checkins" (
  "id" INTEGER AUTOINCREMENT,
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER,
...
ALTER TABLE
  "test-data"."PUBLIC"."venues"
ADD
  CONSTRAINT "tegory_id_categories_927642602" FOREIGN KEY ("category_id") REFERENCES "test-data"."PUBLIC"."categories" ("id");

ALTER TABLE
  "test-data"."PUBLIC"."checkins"
ADD
  CONSTRAINT "ckins_user_id_users_-815717481" FOREIGN KEY ("user_id") REFERENCES "test-data"."PUBLIC"."users" ("id");

ALTER TABLE
  "test-data"."PUBLIC"."checkins"
ADD
  CONSTRAINT "ns_venue_id_venues_-1854903846" FOREIGN KEY ("venue_id") REFERENCES "test-data"."PUBLIC"."venues" ("id");

-- 15 rows
INSERT INTO "test-data"."PUBLIC"."users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "test-data"."PUBLIC"."categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "test-data"."PUBLIC"."venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "test-data"."PUBLIC"."checkins" ("date", "user_id", "venue_id")
VALUES
