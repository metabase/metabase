...
(defn- tool-input-schema
  "Derive a tool's MCP `inputSchema` from the endpoint's route/query/body Malli, applying the
  strict-tool transform so strict MCP clients (e.g. ChatGPT Apps SDK) accept it.
