...
import type { SDKFilterItem } from "embedding-sdk/components/private/Question/components/Filter/hooks/use-filter-data";
import {
  MultiStepPopover,
  type MultiStepState,
 ...
 * @category Question
 */
export type QuestionFilterDropdownProps = {
  /**
