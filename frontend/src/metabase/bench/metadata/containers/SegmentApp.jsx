...
import SegmentForm from "../pages/DataModel/components/SegmentForm";
import { updatePreviewSummary } from "../pages/DataModel/datamodelActions.js";
import { getPreviewSummary } from "../pages/DataModel/selectors";
  ...
  const handleSubmit = useCallback(
    async (segment) => {
      ...
      try {
        ...
        onChangeLocation("/bench/metadata/segments");
      } catch (error) {
        setIsDirty(isDirty);
      }
    },
