...
export interface MetabotState {
  ...
  experimental: {
    metabotIdOverride: string | undefined;
...
export const metabot = createSlice({
  ...
  reducers: {
    ...
    resetConversation: (state) => {
      ...
      state.experimental.metabotIdOverride = undefined;
    },
    ...
    setMetabotIdOverride: (
      ...
      state.experimental.metabotIdOverride = action.payload;
    },
