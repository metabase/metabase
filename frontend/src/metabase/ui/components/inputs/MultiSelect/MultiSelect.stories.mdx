...
Our themed wrapper around [Mantine MultiSelect](https://v6.mantine.dev/core/select/).
...
- [Mantine MultiSelect Docs](https://v6.mantine.dev/core/select/)
...
<Canvas>
  <Story name="Creatable, md">{CreatableMd}</Story>
</Canvas>
...
<Canvas>
  <Story name="Creatable, xs">{CreatableXs}</Story>
</Canvas>
