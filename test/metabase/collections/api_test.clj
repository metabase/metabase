...
(deftest in-report-cards-do-not-appear-in-collection-items
  (testing "GET /api/collection/:id/items excludes cards with type :in_document"
    (mt/with-temp [:model/Collection {coll-id :id} {}
                   :model/Card {normal-card-id :id} {:collection_id coll-id}
                   :model/Card _ {:collection_id coll-id :type :in_document}
                   :model/Dashboard {dash-id :id} {:collection_id coll-id}]
...
(deftest in-report-cards-do-not-appear-in-root-items
  (testing "GET /api/collection/root/items excludes cards with type :in_document"
