...
(mu/defn tenant-slug :- [:maybe :string]
...
(mu/defn tenant-name-or-slug-exists? :- :boolean
...
(mu/defn other-tenant-named? :- :boolean
...
(mu/defn deactivate-tenant-users! :- :int
...
(mu/defn reactivate-tenant-users! :- :int
