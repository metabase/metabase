...
(mr/def ::core-fn
  ...
  [:function
   ...
   [:=> [:cat #_route-params any? #_query-params any? #_body-params any? #_request any?] any?]])
...
(mu/defn -defendpoint-core-fn :- ::core-fn
  ...
  [f :- [:=> [:cat #_route-params any? #_query-params any? #_body-params any? #_request any?] any?]]
  (fn -core-fn
    ([]
     (f nil nil nil nil))
    ([route-params]
...
(defmacro defendpoint-core-fn-with-optimized-schemas
  ...
  we're defining something closer to
    ...
    (let [body-schema-5678 [:map
                            ...
                            [:default {:optional true} [:maybe :boolean]]]]
      (-defendpoint-core-fn
       (fn [_route-params _query-params body-params-1234 &request]
