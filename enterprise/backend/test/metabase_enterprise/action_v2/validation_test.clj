  ...
  (testing "Date type validation"
    (doseq [[expected inputs fields]
            [;; Valid cases
             ...
             ;; Invalid cases
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" "2024-3-15"}] [date-field]]
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" "2024-03-5"}] [date-field]]
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" "03/15/2024"}] [date-field]]
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" "15-03-2024"}] [date-field]]
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" "2024/03/15"}] [date-field]]
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" "March 15, 2024"}] [date-field]]
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" ""}] [date-field]]
             [[{"birth_date" "Must be a date in format YYYY-MM-DD"}] [{"birth_date" 123}] [date-field]]
  ...
  (testing "Time type validation"
    (doseq [[expected inputs fields]
            [;; Valid cases
             ...
             ;; Invalid cases
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" "2:30:00"}] [time-field]]
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" "14:3:00"}] [time-field]]
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" "14:30:0"}] [time-field]]
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" "14:30"}] [time-field]]
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" "2:30 PM"}] [time-field]]
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" "25:00:00"}] [time-field]]
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" ""}] [time-field]]
             [[{"start_time" "Must be a time in format HH:mm:ss"}] [{"start_time" 143000}] [time-field]]
  ...
  (testing "DateTime type validation"
    (doseq [[expected inputs fields]
            [;; Valid cases
             ...
             ;; Invalid cases
             [[{"created_at" "Must be a datetime in format YYYY-MM-DD HH:mm:ss or YYYY-MM-DDTHH:mm:ssZ"}]
