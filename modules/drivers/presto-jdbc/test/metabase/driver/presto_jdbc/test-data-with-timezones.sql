...
DROP TABLE IF EXISTS "test_data"."default"."test_data_with_timezones_users";

CREATE TABLE "test_data"."default"."test_data_with_timezones_users" (
  "id" INTEGER,
  "name" VARCHAR,
...
DROP TABLE IF EXISTS "test_data"."default"."data_with_timezones_categories";

CREATE TABLE "test_data"."default"."data_with_timezones_categories" ("id" INTEGER, "name" VARCHAR);

DROP TABLE IF EXISTS "test_data"."default"."est_data_with_timezones_venues";

CREATE TABLE "test_data"."default"."est_data_with_timezones_venues" (
  "id" INTEGER,
  "name" VARCHAR,
  "category_id" INTEGER,
  "latitude" DOUBLE,
...
DROP TABLE IF EXISTS "test_data"."default"."t_data_with_timezones_checkins";

CREATE TABLE "test_data"."default"."t_data_with_timezones_checkins" (
  "id" INTEGER,
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER
...
-- 15 rows
INSERT INTO "test_data"."default"."test_data_with_timezones_users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "test_data"."default"."data_with_timezones_categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "test_data"."default"."est_data_with_timezones_venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "test_data"."default"."t_data_with_timezones_checkins" ("date", "user_id", "venue_id")
VALUES
