...
(deftest ^{:parallel false} register-index-check!-migrates-a-legacy-registry-test
...
(deftest ^{:parallel false} run-measure!-test
  (let [calls (atom [])
        live  (atom #{})]
...
(deftest ^{:parallel false} inapplicable-measure-does-not-create-series-test
...
(deftest ^{:parallel false} failed-first-write-does-not-mark-series-live-test
...
(deftest ^{:parallel false} refresh-isolates-measure-failures-test
...
(deftest ^{:parallel false} pull-collector-refreshes-gauges-on-each-instance-test
...
(deftest ^{:parallel false} background-gauge-refresh-isolates-write-failures-test
