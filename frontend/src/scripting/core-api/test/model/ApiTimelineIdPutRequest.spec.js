...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetabaseApi.ApiTimelineIdPutRequest();
  });
  ...
  describe('ApiTimelineIdPutRequest', function() {
    it('should create an instance of ApiTimelineIdPutRequest', function() {
      // uncomment below and update the code to test ApiTimelineIdPutRequest
      //var instance = new MetabaseApi.ApiTimelineIdPutRequest();
      //expect(instance).to.be.a(MetabaseApi.ApiTimelineIdPutRequest);
    });
