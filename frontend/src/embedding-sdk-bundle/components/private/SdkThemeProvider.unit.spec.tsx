  ...
  it.each(THEME_CASES)(
    ...
    async ({ theme, expectedColor, unexpectedColor }) => {
      ...
      await waitFor(() => {
        ...
        // getPaletteCssVariables generates this CSS variable from the selected base Metabase theme.
        // Its light and dark values differ,
        // so the assertion shows which color scheme getMetabaseSdkCssVariables chose.
