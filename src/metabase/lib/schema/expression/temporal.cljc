...
(mbql-clause/define-tuple-mbql-clause :datetime :- :type/DateTime
  #_:value [:schema [:ref ::expression/string]] ;; need to support bytes type
  #_:modestring [:enum {:error/message "datetime mode string"
