...
DROP TABLE IF EXISTS "test-data-self-referencing-user"."PUBLIC"."users";

CREATE TABLE "test-data-self-referencing-user"."PUBLIC"."users" (
...
ADD
  CONSTRAINT "ers_created_by_users_406217275" FOREIGN KEY ("created_by") REFERENCES "test-data-self-referencing-user"."PUBLIC"."users" ("id");

-- 15 rows
INSERT INTO "test-data-self-referencing-user"."PUBLIC"."users" ("name", "last_login", "password", "created_by")
VALUES
