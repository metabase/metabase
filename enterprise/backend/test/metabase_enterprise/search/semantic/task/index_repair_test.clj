(ns metabase-enterprise.search.semantic.task.index-repair-test
  (:require
   [clojure.test :refer :all]
   [metabase-enterprise.search.semantic.core :as semantic-search.core]
   [metabase-enterprise.search.semantic.health :as semantic.health]
   [metabase-enterprise.search.semantic.repair :as semantic.repair]
   [metabase-enterprise.search.semantic.task.index-repair :as index-repair]
