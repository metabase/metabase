...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetabaseApi.ApiDashboardPostRequest();
  });
  ...
  describe('ApiDashboardPostRequest', function() {
    it('should create an instance of ApiDashboardPostRequest', function() {
      // uncomment below and update the code to test ApiDashboardPostRequest
      //var instance = new MetabaseApi.ApiDashboardPostRequest();
      //expect(instance).to.be.a(MetabaseApi.ApiDashboardPostRequest);
    });
