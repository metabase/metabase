...
export const darkTheme = defineMetabaseTheme({
  ...
  colors: {
    ...
    "text-disabled": darkColors.lightGrey,
...
const pugTheme: MetabaseTheme = {
  ...
  colors: {
    ...
    "text-disabled": pugColors.lightGrey,
    border: "#3B3F3F",
...
const stitchTheme: MetabaseTheme = {
  ...
  colors: {
    ...
    "text-disabled": stitchColors.lightGrey,
...
const luminaraTheme: MetabaseTheme = {
  ...
  colors: {
    ...
    "text-disabled": luminaraColors.green3,
