...
(mu/defn audit-database :- [:maybe ::warehouses.schema/database]
  "The audit Database, or nil."
  []
  (t2/select-one :model/Database :is_audit true))

(mu/defn non-audit-database-named :- [:maybe ::warehouses.schema/database]
...
(mu/defn collection-by-entity-id :- [:maybe ::collections.schema/collection]
