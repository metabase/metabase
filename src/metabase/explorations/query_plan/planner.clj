  ...
  (plan! [this ctx]
    ...
    for every implementation:
      ...
      {:thread-id          long
       ...
       :metric-dim-ctx     <output of qp.context/metric-and-dim-context>
       :metric-by-id       {metric-id metric-context-map}
       :creator-id         long|nil
       :thread-metrics     [ExplorationThreadMetric ...]
       :thread-dims        [ExplorationThreadDimension ...]}
