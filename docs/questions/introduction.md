...
- **+ New > SQL/Native query** to create a question using the native/SQL query editor. See [Native editor](../questions/native-editor/writing-sql.md).
  ...
  Even if you know SQL, you should still check out the [graphical query builder](./query-builder/editor.md), as you can use it to build [interactive charts](/docs/questions/visualizations/drill-through.md).
