...
import { QuestionActionsOverflowMenuWrapper } from "metabase/query_builder/components/view/ViewHeader/components/QuestionActions/QuestionActionsOverflowMenu";
...
import { QuestionActionsDivider } from "./QuestionActions.styled";
...
export const QuestionActions = ({
  ...
  return (
    <>
      ...
      <QuestionActionsOverflowMenuWrapper />
    </>
  );
};
