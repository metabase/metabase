...
This is more token-efficient than using edit-sql-query for major changes.
...
**Best Practices:**
- Use for major query changes (more token efficient than edit-sql-query)
- Use edit-sql-query for small targeted changes
