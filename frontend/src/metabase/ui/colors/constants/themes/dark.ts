...
const actualColors = {
  ...
  "button_label-light-brand-default": baseColors.brand[30],
  "button_label-light-brand-hover": baseColors.brand[20],
  ...
  "button_label-subtle-brand-default": baseColors.brand[30],
