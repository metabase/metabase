(ns metabase-enterprise.metabot-v3.agent.tools.slackbot-query-test
  ...
  (:require
   ...
   [metabase-enterprise.metabot-v3.agent.tools.slackbot-query]))
...
(deftest display-field-has-description-test
  (testing "display field in slackbot-query-schema has a description in JSON Schema"
    (let [schema  @#'metabase-enterprise.metabot-v3.agent.tools.slackbot-query/slackbot-query-schema
