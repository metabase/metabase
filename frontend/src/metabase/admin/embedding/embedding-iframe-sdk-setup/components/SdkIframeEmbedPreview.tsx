...
// preview reloads, and setupConfigWatcher drives that. Documented residual
// violation (feature/admin → app/embedding-iframe-sdk).
import { setupConfigWatcher } from "metabase/embedding-iframe-sdk/embed";
