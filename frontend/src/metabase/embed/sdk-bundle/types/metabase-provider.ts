...
import type { SdkStore } from "../store-types";
...
/**
 * Props accepted by the SDK ComponentProvider, which wraps sdk-bundle
 * with auth/theme/plugins config and (optionally) an injected Redux store.
 */
