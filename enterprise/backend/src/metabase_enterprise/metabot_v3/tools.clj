(ns metabase-enterprise.metabot-v3.tools
  (:require
   ...
   [metabase-enterprise.metabot-v3.tools.create-query]
   [metabase-enterprise.metabot-v3.tools.get-query-columns]
   [metabase-enterprise.metabot-v3.tools.get-query-sources]
...
(comment
  ...
  metabase-enterprise.metabot-v3.tools.create-query/keep-me
  metabase-enterprise.metabot-v3.tools.get-query-columns/keep-me
  metabase-enterprise.metabot-v3.tools.get-query-sources/keep-me
