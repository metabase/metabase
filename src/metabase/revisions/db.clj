...
(mu/defn dashboard-card-ids :- [:maybe [:sequential ms/PositiveInt]]
...
(mu/defn dashboard-series-card-ids :- [:maybe [:sequential ms/PositiveInt]]
...
(mu/defn card-queries :- [:map-of ms/PositiveInt :map]
...
(mu/defn revision :- [:maybe (ms/InstanceOf :model/Revision)]
...
(mu/defn active-card-ids-for-dashboard :- [:maybe [:set ms/PositiveInt]]
...
(mu/defn active-card-ids :- [:maybe [:set ms/PositiveInt]]
...
(mu/defn revisions :- [:sequential (ms/InstanceOf :model/Revision)]
...
(mu/defn latest-revision :- [:maybe (ms/InstanceOf :model/Revision)]
...
(mu/defn insert-revision-returning! :- (ms/InstanceOf :model/Revision)
...
(mu/defn latest-changes :- [:sequential [:map {:closed true}
  ...
  [card-ids      :- [:maybe [:seqable ms/PositiveInt]]
   dashboard-ids :- [:maybe [:seqable ms/PositiveInt]]]
