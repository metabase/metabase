...
describe("scenarios > dashboard > tabs", () => {
  ...
  it("should only fetch cards on the current tab", () => {
    ...
    cy.wait("@firstTabQuery").then(r => {
      firstQuestion().then(r => {
        expect(r.view_count).to.equal(3); // 3 = 1 (previously) + 1 (firstQuestion) + 1 (firstTabQuery)
      });
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(3); // 2 = 1 (previously) + 1 (secondQuestion)
      });
    });
    ...
    cy.wait("@secondTabQuery").then(r => {
      firstQuestion().then(r => {
        expect(r.view_count).to.equal(4); // 4 = 3 (previously) + 1 (firstQuestion)
      });
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(4); // 4 = 2 (previously) + 1 (secondQuestion) + 1 (secondTabQuery)
      });
    });
    ...
    firstQuestion().then(r => {
      expect(r.view_count).to.equal(5); // 5 = 4 (previously) + 1 (firstQuestion)
    });
    secondQuestion().then(r => {
      expect(r.view_count).to.equal(5); // 5 = 4 (previously) + 1 (secondQuestion)
    });
    ...
    cy.wait("@publicFirstTabQuery").then(r => {
      firstQuestion().then(r => {
        expect(r.view_count).to.equal(7); // 7 = 5 (previously) + 1 (firstQuestion) + 1 (publicFirstTabQuery)
      });
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(7); // 6 = 5 (previously) + 1 (secondQuestion)
      });
    });
    ...
    cy.wait("@publicSecondTabQuery").then(r => {
      firstQuestion().then(r => {
        expect(r.view_count).to.equal(8); // 8 = 7 (previously) + 1 (firstQuestion)
      });
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(8); // 8 = 6 (previously) + 1 (secondQuestion) + 1 (publicSecondTabQuery)
      });
    });
    ...
    cy.wait("@publicFirstTabQuery").then(r => {
      firstQuestion().then(r => {
        expect(r.view_count).to.equal(10); // 10 = 8 (previously) + 1 (firstQuestion) + 1 (publicFirstTabQuery)
      });
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(9); // 9 = 8 (previously) + 1 (secondQuestion)
      });
    });
  });
  ...
  it("should only fetch cards on the current tab of an embedded dashboard", () => {
    ...
    cy.wait("@firstTabQuery").then(r => {
      firstQuestion().then(r => {
        expect(r.view_count).to.equal(3); // 3 = 1 (previously) + 1 (firstQuestion) + 1 (first tab query)
      });
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(2); // 2 = 1 (previously) + 1 (secondQuestion)
      });
    });
    ...
    cy.wait("@secondTabQuery").then(r => {
      ...
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(4); // 4 = 2 (previously) + 1 (secondQuestion) + 1 (second tab query)
      });
    });
    ...
    cy.wait("@firstTabQuery").then(r => {
      firstQuestion().then(r => {
        expect(r.view_count).to.equal(6); // 6 = 4 (previously) + 1 (firstQuestion) + 1 (first tab query)
      });
      secondQuestion().then(r => {
        expect(r.view_count).to.equal(5); // 5 = 4 (previously) + 1 (secondQuestion)
      });
