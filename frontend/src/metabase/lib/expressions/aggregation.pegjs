...
aggregation
  = agg:aggregation_without_field _ "(" _ ")" { return [agg]; }
  / agg:aggregation_with_field _ "(" _ expr:expression _ ")"  { return [agg, expr]; }

aggregation_without_field
  = "count"
  / "cum_count"

aggregation_with_field
  = "sum"
  / "cum_sum"
  / "distinct"
  / "avg"
...
field "field name"
  = fieldName:StringLiteral { return ["field-id", getFieldIdForName(fieldName)]; }
  / fieldName:Identifier { return ["field-id", getFieldIdForName(fieldName)]; }
...
// The following are from the PEG.js JavaScript grammer
