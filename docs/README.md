...
The easiest way to get started with Metabase is to sign up for a free trial of [Metabase Cloud](https://store.metabase.com/checkout). You get support, backups, upgrades, an SMTP server, an SSL certificate, SOC 2 Type II security auditing, and more (plus your money goes toward improving Metabase). Check out our quick overview of [cloud vs. self-hosting](./cloud/cloud-vs-self-hosting.md). If you need to, you can always switch to [self-hosting](./installation-and-operation/installing-metabase.md) Metabase at any time (or vice versa).

### [Installing Metabase](./installation-and-operation/installing-metabase.md)

Run Metabase as a JAR, using Docker, or on [Metabase Cloud](https://store.metabase.com/checkout).

### [Setting up Metabase](./configuring-metabase/setting-up-metabase.md)

Once installed, set up Metabase and connect it to your data.

### [Getting started](https://www.metabase.com/learn/metabase-basics/getting-started/index)

With your data connected, get started by asking questions, creating dashboards, and sharing your work.

### [A tour of Metabase](https://www.metabase.com/learn/metabase-basics/overview/tour-of-metabase)

Metabase is a deep product with many tools to simplify business intelligence, from embeddable charts and interactive dashboards to GUI and SQL editors, auditing, row- and column-level security, and more.

## Documentation topics

Metabase reference documentation.
...
* [Monitoring Metabase](./installation-and-operation/monitoring-metabase.md)
...
* [SSL certificates](./databases/ssl-certificates.md)
...
* [Row- and column-level security](./permissions/row-and-column-security.md)
* [Row- and column-level security examples](./permissions/row-and-column-security-examples.md)
...
* [Time zones](./configuring-metabase/timezones.md)
...
* [Customizing the Metabase Jetty web server](./configuring-metabase/customizing-jetty-webserver.md)
...
[Learn Metabase](https://www.metabase.com/learn) has many articles on how to use Metabase, data best practices, and more.
