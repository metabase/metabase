...
> Prefer using [Data Studio > Tables](../semantic-layer/managing-tables.md) for metadata editing. The page _Admin > Table Metadata_ will be removed in future versions of Metabase.
