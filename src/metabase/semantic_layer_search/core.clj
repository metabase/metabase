(ns metabase.semantic-layer-search.core
  ...
  The semantic layer is a hand-curated library of saved search prompts, each mapped to the entities that
  answer it (see [[metabase.semantic-layer-search.models.semantic-layer-index]]).
