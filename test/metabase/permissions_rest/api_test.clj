...
(deftest ^:synchronized update-perms-graph-test
...
(deftest ^:synchronized update-perms-graph-perms-for-new-db-test
  (testing "PUT /api/permissions/graph"
...
(deftest ^:synchronized update-perms-graph-perms-for-new-db-with-no-tables-test
  (testing "PUT /api/permissions/graph"
...
(deftest ^:synchronized update-perms-graph-with-skip-graph-test
  (testing "PUT /api/permissions/graph"
...
(deftest ^:synchronized update-perms-graph-force-test
  (testing "PUT /api/permissions/graph"
...
(deftest ^:synchronized can-revoke-permsissions-via-graph-test
  (testing "PUT /api/permissions/graph"
