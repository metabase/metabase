...
;; TODO(slice-17/query): restore when the execute_sql/query tool lands and registers agent:query:run.
;; The live scope-gating assertions stay in the test above; only this grantability check needs the
;; query tool present in the registry.
