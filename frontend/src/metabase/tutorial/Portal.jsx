...
export default class Portal extends Component {
    ...
    componentWillMount() {
        ...
        this._timer = setInterval(() => {
          ...
          const p2 = this.props.target && this.props.target !== true && this.props.target.getBoundingClientRect();
          if (p1 && p2 && (p1.left !== p2.left || p1.top !== p2.top || p1.width !== p2.width || p1.height !== p2.height)) {
