...
DROP TABLE IF EXISTS "schema_201"."diff_time_zones_cases_times" CASCADE;

CREATE TABLE "schema_201"."diff_time_zones_cases_times" (
...
-- 35 rows
INSERT INTO "schema_201"."diff_time_zones_cases_times" ("id", "a_dt_tz", "b_dt_tz", "a_dt_tz_text", "b_dt_tz_text")
VALUES
