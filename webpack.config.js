...
var LIB_SRC_PATH = path.resolve(__dirname + '/frontend/src/metabase-lib');
var TEST_SUPPORT_PATH = path.resolve(__dirname + '/frontend/test/__support__');
var BUILD_PATH = path.resolve(__dirname + '/resources/frontend_client');
...
var config = module.exports = {
    ...
    // output to "dist"
    output: {
        path: path.resolve(BUILD_PATH + '/app/dist'),
    ...
    resolve: {
        ...
        alias: {
            ...
            'style':                path.resolve(SRC_PATH + '/css/core/index.css'),
            'ace':                  path.resolve(__dirname + '/node_modules/ace-builds/src-min-noconflict'),
        }
    },
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            template: path.resolve(__dirname + '/resources/frontend_client/index_template.html'),
            inject: 'head',
        ...
        new HtmlWebpackHarddiskPlugin({
            outputPath: path.resolve(__dirname + '/resources/frontend_client/app/dist')
        }),
