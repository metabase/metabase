(ns metabase-enterprise.search.entity-retrieval.appdb-mode-test
  ...
  Opt-in and self-gated like [[metabase-enterprise.search.semantic.appdb-pgvector-mode-test]]: the round
  ...
  (:require
   ...
   [metabase-enterprise.search.semantic.db.migration.impl :as semantic.migration.impl]
