...
describe("issue 39487", () => {
  ...
  it(
    ...
    () => {
      createTimeSeriesQuestionWithFilter([
        "between",
        CREATED_AT_FIELD,
        "2030-05-01", // 5 day rows
        "2030-06-01", // 6 day rows
      ]);
      ...
      H.popover().within(() => {
        ...
        cy.findAllByRole("textbox").first().clear().type("2030/05/01");
        cy.findByText("May 2030").should("be.visible");
        cy.findByLabelText("1 May 2030").should(
          "have.attr",
          "data-first-in-range",
          "true",
        );
        ...
        cy.findAllByRole("textbox")
          ...
          .clear()
          .type("2030/06/01");
        cy.findAllByLabelText("1 June 2030")
          .filter(":visible")
      ...
      H.popover().findByText("Filter by this column").click();
      H.popover().findByText("Fixed date range…").click();
      H.popover().findAllByRole("textbox").first().clear().type("2030/05/01");
      H.popover()
  ...
  function checkDateRangeFilter() {
    ...
    nextButton().click(); // go to 2030-07 - 5 day rows
    assertNoLayoutShift();
  }
...
describe("issue 54920", () => {
  ...
  it("should not break downstream queries when an unused field with the same name as a used field is removed from a base question (metabase#54920)", () => {
    ...
    H.popover().within(() => {
      ...
      cy.findByText("Fixed date range…").click();
      cy.findByLabelText("Start date").clear().type("10/12/2030");
      cy.findByLabelText("End date").clear().type("10/15/2030");
      cy.button("Add filter").click();
    });
    H.visualize();
...
describe("issue 68574", () => {
  ...
  it("should be possible to run a query for a empty required parameter without a default value (metabase#68574)", () => {
    ...
    visitQuestion("2030-01-01");
    assertParameterFormat("1 January, 2030");
    ...
    visitQuestion("2030-01-01");
    assertParameterFormat("Tuesday, January 1, 2030");
