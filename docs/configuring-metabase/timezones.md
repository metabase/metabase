...
Depending on your database, you can make your database columns time zone aware by storing them as specific data types, such as:
...
Metabase features that depend on time zone awareness at the data type level:
