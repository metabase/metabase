(ns metabase-enterprise.search.entity-retrieval.task.sync
  ...
  reconcile (see [[metabase-enterprise.search.entity-retrieval.core/request-entity-sync!]]) within seconds. This
  ...
  (:require
   ...
   [metabase-enterprise.search.entity-retrieval.core :as entity-retrieval.core]
