...
(deftest content->html-marks-test
  ...
  (testing "link mark"
    (is (= "<p><a href=\"https://example.com\">click</a></p>"
           (render/content->html {:type    "doc"
                                  :content [{:type    "paragraph"
                                             :content [{:type  "text"
                                                        :text  "click"
...
(deftest content->html-smart-link-test
  (testing "smartLink with label and href"
    (mt/with-temporary-setting-values [site-url "http://localhost"]
      (is (= "<a href=\"http://localhost/question/42\">My Question</a>"
             (render/content->html {:type    "doc"
  ...
  (testing "smartLink user mention without href"
    (is (= "@42"
           (render/content->html {:type    "doc"
                                  :content [{:type  "smartLink"
                                             :attrs {:entityId 42
...
(deftest content->html-xss-test
  ...
  (testing "HTML in link href is escaped"
    (is (= "<p><a href=\"javascript:alert(&quot;xss&quot;)\">click</a></p>"
           (render/content->html {:type    "doc"
                                  :content [{:type    "paragraph"
                                             :content [{:type  "text"
                                                        :text  "click"
...
(deftest content->html-unknown-nodes-test
  (testing "unknown node type with children renders children"
    (is (= "<p>still works</p>"
           (render/content->html {:type    "doc"
  ...
  (testing "unknown node type without children renders empty"
    (is (= ""
           (render/content->html {:type    "doc"
                                  :content [{:type "futureNodeType"}]})))))
