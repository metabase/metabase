...
JSON object of primary colors used in charts and throughout Metabase. E.g.: {"brand": "#ff003b", "filter": "#FF003B", "summarize": "#FF003B"} if you want to change the user interface colors, or {"accent0": "#FF0005", "accent1": "#E6C367", "accent2": "#B9E68A", "accent3": "#8AE69F", "accent4": "#8AE6E4", "accent5": "#8AA2E6", "accent6": "#B68AE6", "accent7": "#E68AD0"} if you want to change the chart colors.
