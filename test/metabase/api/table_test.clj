...
(expect
    (match-$ (db/sel-1 Table :id (id :users))
      {:description     nil
       :entity_type     nil
       :visibility_type nil
       :db              (db-details)
       ...
       :name            "USERS"
       :display_name    "Users"
       :fields          [(match-$ (db/sel-1 Field :id (id :users :id))
                           {:description     nil
                            :table_id        (id :users)
                            :special_type    "id"
                            :name            "ID"
                            ...
                            :raw_column_id   $
                            :last_analyzed   $})
                         (match-$ (db/sel-1 Field :id (id :users :last_login))
                           {:description     nil
                            :table_id        (id :users)
                            :special_type    nil
                            :name            "LAST_LOGIN"
                            ...
                            :raw_column_id   $
                            :last_analyzed   $})
                         (match-$ (db/sel-1 Field :id (id :users :name))
                           {:description     nil
                            :table_id        (id :users)
                            :special_type    "name"
                            :name            "NAME"
                            ...
                            :raw_column_id   $
                            :last_analyzed   $})
                         (match-$ (db/sel-1 Field :table_id (id :users) :name "PASSWORD")
                           {:description     nil
                            :table_id        (id :users)
...
(expect
  (let [checkins-user-field (db/sel-1 Field :table_id (id :checkins) :name "USER_ID")
        users-id-field (db/sel-1 Field :table_id (id :users) :name "ID")]
...
(expect-eval-actual-first
    {:result "success"}
  (let [categories-id-field   (db/sel-1 Field :table_id (id :categories) :name "ID")
        categories-name-field (db/sel-1 Field :table_id (id :categories) :name "NAME")
