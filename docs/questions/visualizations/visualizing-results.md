...
On [Pro and Enterprise plans](https://www.metabase.com/pricing/), admins can add [custom visualizations](./custom-visualizations.md): chart types you build with the Custom Visualizations SDK and upload to Metabase. Once a custom visualization is installed, it shows up in the visualization picker alongside the built-in charts.
