...
DROP TABLE IF EXISTS "schema_20"."ta_self_referencing_user_users" CASCADE;

CREATE TABLE "schema_20"."ta_self_referencing_user_users" (
...
ALTER TABLE
  "schema_20"."ta_self_referencing_user_users"
ADD
  CONSTRAINT "ers_created_by_users_406217275" FOREIGN KEY ("created_by") REFERENCES "schema_20"."ta_self_referencing_user_users" ("id");

-- 15 rows
INSERT INTO "schema_20"."ta_self_referencing_user_users" ("name", "last_login", "password", "created_by")
VALUES
