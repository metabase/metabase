...
For tests of the config itself, use `./bin/mage project-tests invariants`. After editing Clojure files, run `clj-paren-repair`. After editing `config.edn`, re-run the modules-test.
