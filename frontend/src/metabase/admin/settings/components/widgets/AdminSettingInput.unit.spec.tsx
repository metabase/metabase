...
describe("AdminSettingInput", () => {
  ...
  it("should resend a queued value that matches a failed save", async () => {
    setup({
      title: "Enable X-rays",
      name: "enable-xrays",
      inputType: "boolean",
    ...
    // false, back to true, then false again: the queue ends up holding the same
    // value as the request in flight
