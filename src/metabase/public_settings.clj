...
(defn ldap-enabled?
  "Is LDAP enabled?"
  []
  ((requiring-resolve 'metabase.sso.settings/ldap-enabled)))
...
;;; `native-query-autocomplete-match-style` is only used by the FE client AFAIK
...
;;; TODO -- move this to the future `user` module
