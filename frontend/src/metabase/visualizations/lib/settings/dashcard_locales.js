...
const TITLE_LOCALES_BN = {
  ...
  'school.dashboard.ict.equipment.stat': {
    ...
    'bn': 'আইসিটি সরঞ্জামের পরিসংখ্যান'
  },
  'school.dashboard.ict.facility.info': {
    'en': 'Information of ICT facilities',
    'bn': 'আইসিটি সুবিধার তথ্য'
  },
  'school.dashboard.furniture.total': {
    'en': 'Total',
    'bn': 'সর্বমোট'
  },
  'school.dashboard.furniture.usable': {
    'en': 'Usable',
    'bn': 'ব্যবহারযোগ্য'
  },
  'school.dashboard.furniture.repairable': {
    'en': 'Repairable',
    'bn': 'মেরামতযোগ্য'
  },
  'school.dashboard.furniture.worn-out': {
    'en': 'Worn out',
    'bn': 'অমেরামতযোগ্য'
  },
  'school.dashboard.furniture.types': {
    'en': 'Statistics of types of furniture',
    'bn': 'আসবাবপত্রের ধরণের পরিসংখ্যান'
  },
  'school.dashboard.infrastructure.building': {
    'en': 'Buildings',
    'bn': 'দালান'
  },
  'school.dashboard.infrastructure.room': {
    'en': 'Rooms',
    'bn': 'কক্ষ'
  },
  'school.dashboard.infrastructure.furniture': {
    'en': 'Furnitures',
    'bn': 'আসবাবপত্র'
  },
  'school.dashboard.infrastructure.toilet': {
    'en': 'Toilets',
    'bn': 'টয়লেট'
  },
  'school.dashboard.infrastructure.facilities': {
    'en': 'Available facilities',
    'bn': 'সুযোগ সুবিধার তথ্য'
  },
  'school.dashboard.infrastructure.academic-geographic': {
    'en': 'Academic and geographical information',
    'bn': 'একডেমিক এবং ভৌগলিক তথ্য'
  },
  'school.dashboard.toilet.usage': {
    'en': 'Usage of toilets',
    'bn': 'টয়লেট ব্যবহার'
  },
  'school.dashboard.toilet.water-source': {
    'en': 'Source of water',
    'bn': 'পানির উৎস্য'
  },
  ...
  'venue.wise.urc.pti.dpeo.office.ddoffice.count': {
    ...
    'bn': 'ট্রেইনিং ভেন্যু (ইউআরসি-টিআরসি, পিটিআই, ইত্যাদি) পরিসংখ্যান'
  },
  ...
  'total.trainee.count.based.on.obtaining.certificate' : {
    ...
    'bn' : 'সম্পন্ন প্রশিক্ষণের সার্টিফিকেট অর্জন ভিত্তিক প্রশিক্ষণার্থীর পরিসংখ্যান'
  },
}
