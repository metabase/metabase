...
// Define semantic colors with light and dark variants
...
export function getThemeAwareColors(colorScheme: MantineColorScheme): Record<string, ColorShades> {
 ...
 */
export function getSemanticColor(colorName: SemanticColorName, colorScheme: MantineColorScheme): string {
