...
```sh
MB_EDITION=ee pnpm build-hot
```

Clear the Webpack cache using `pnpm remove-webpack-cache` if you previously ran OSS edition in dev mode to avoid unexpected application behavior.
