...
(deftest ^{:parallel false} complexity-endpoint-force-recalculation-advances-last-fingerprint-on-snowplow-publish-test
...
(deftest ^{:parallel false} complexity-endpoint-force-recalculation-keeps-fingerprint-stale-when-snowplow-publish-fails-test
...
(deftest ^{:parallel false} complexity-endpoint-force-recalculation-superuser-gets-consistent-totals-test
...
(deftest ^{:parallel false} complexity-endpoint-force-recalculation-metabot-catalog-test
...
(deftest ^{:parallel false} complexity-endpoint-force-recalculation-metabot-collection-scope-test
...
(deftest ^{:parallel false} complexity-endpoint-force-recalculation-allows-active-scheduled-claim-test
...
(deftest ^{:parallel false} complexity-endpoint-force-recalculation-rejects-concurrent-requests-test
