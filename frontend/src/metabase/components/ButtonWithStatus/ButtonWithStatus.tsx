...
const defaultTitleForState: TitleForState = {
  default: t`Save`,
  inProgress: t`Saving...`,
  completed: t`Saved!`,
...
interface ButtonWithStatusProps {
  onClickOperation: () => void | Promise<void>;
  titleForState?: Partial<TitleForState>;
  disabled: boolean;
  className?: string;
}

interface ButtonWithStatusState {
  progressState: keyof TitleForState;
}
