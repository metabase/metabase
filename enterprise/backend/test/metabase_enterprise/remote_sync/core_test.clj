...
(deftest ^:synchronized bulk-set-remote-sync-enables-single-collection-test
...
(deftest ^:synchronized bulk-set-remote-sync-disables-single-collection-test
...
(deftest ^:synchronized bulk-set-remote-sync-enables-multiple-collections-test
...
(deftest ^:synchronized bulk-set-remote-sync-mixed-operations-test
...
(deftest ^:synchronized bulk-set-remote-sync-cascades-to-descendants-test
...
(deftest ^:synchronized bulk-set-remote-sync-cascades-disable-to-descendants-test
...
(deftest ^:synchronized bulk-set-remote-sync-throws-on-non-remote-synced-dependencies-test
...
(deftest ^:synchronized bulk-set-remote-sync-throws-on-remote-synced-dependents-test
...
(deftest ^:synchronized bulk-set-remote-sync-empty-map-no-op-test
  (testing "bulk-set-remote-sync with empty map is a no-op"
    (mt/with-temp [:model/Collection {coll-id :id} {:name "Test Collection" :location "/" :is_remote_synced false}]
      (core/bulk-set-remote-sync {})
      (is (false? (:is_remote_synced (t2/select-one :model/Collection :id coll-id)))))))

(deftest ^:synchronized bulk-set-remote-sync-transaction-rollback-on-error-test
...
(deftest ^:synchronized bulk-set-remote-sync-allows-disabling-when-no-dependents-test
...
(deftest ^:synchronized bulk-set-remote-sync-skips-already-enabled-collections-test
...
(deftest ^:synchronized bulk-set-remote-sync-skips-already-disabled-collections-test
...
(deftest ^:synchronized bulk-set-remote-sync-only-updates-changed-descendants-test
...
(deftest ^:synchronized bulk-set-remote-sync-only-updates-changed-descendants-disable-test
...
(deftest ^:synchronized batch-model-eligible-for-remote-sync-cards-in-remote-synced-collection-test
...
(deftest ^:synchronized batch-model-eligible-for-remote-sync-cards-not-in-remote-synced-collection-test
...
(deftest ^:synchronized batch-model-eligible-for-remote-sync-snippets-library-synced-test
...
(deftest ^:synchronized batch-model-eligible-for-remote-sync-snippets-library-not-synced-test
...
(deftest ^:synchronized batch-model-eligible-for-remote-sync-unknown-model-test
