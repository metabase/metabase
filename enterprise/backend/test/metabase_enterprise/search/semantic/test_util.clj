(ns metabase-enterprise.search.semantic.test-util
  {:clj-kondo/config '{:linters {:deprecated-var {:exclude {metabase.test.data/mbql-query {:namespaces [metabase-enterprise.search.semantic.test-util]}}}}}}
  (:require
   ...
   [metabase-enterprise.search.semantic.db.migration :as semantic.db.migration]
   [metabase-enterprise.search.semantic.dlq :as semantic.dlq]
   [metabase-enterprise.search.semantic.embedding :as semantic.embedding]
   ...
   [metabase-enterprise.search.semantic.util :as semantic.util]
