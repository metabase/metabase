  ...
  {:scope metabot/agent-metric-update
   :tool  {:name "update_metric"
           :description (str "Update a saved metric. Patch semantics - only fields you pass are changed. "
                             ...
                             "To archive, set archived true. Archiving is a soft delete: when asked "
                             "to delete or remove a metric, archive it (set archived true). It can "
                             "be reversed by setting archived false. "
