    ...
    (mt/rows
     (qp/process-query
      {:database 881,
       ...
       :query
       {:source-table 2211,
        :breakout [[:field 8358 {:join-alias "table_2211"}] [:field 8360 nil]],
        :limit 3,
        :filter [:and [:not-null [:field 8358 {:join-alias "table_2211"}]]
                 [:= [:field 8363 {:join-alias "table_2212"}] "Europe"]],
        :order-by [[:asc [:field 8360 nil]]],
        :joins
        [{:source-table 2211,
          :condition [:= [:field 8346 {:join-alias "table_2208"}] [:field 8358 {:join-alias "table_2211"}]],
          :alias "table_2211"}
         {:source-table 2210,
          :condition [:= [:field 8361 {:join-alias "table_2212"}] [:field 8355 {:join-alias "table_2210"}]],
          :alias "table_2210"}
         {:source-table 2209,
          :condition [:= [:field 8359 nil] [:field 8350 {:join-alias "table_2209"}]],
          :alias "table_2209"}
         #_{:source-table 2210,
          :condition [:= [:field 8351 {:join-alias "table_2209"}] [:field 8354 {:join-alias "table_2210"}]],
          :alias "table_2210"}
         {:source-table 2212,
          :condition [:= [:field 8355 {:join-alias "table_2210"}] [:field 8361 {:join-alias "table_2212"}]],
          :alias "table_2212"}]},
