(ns ^:mb/driver-tests metabase.query-processor.date-bucketing-test
        ...
        (mt/with-metadata-provider (mt/id)
          (doseq [[n unit] [[3 :month]
            ...
            (testing (format "%d %s ^%s %s" n unit (.getCanonicalName (class t)) (pr-str t))
              (let [march-31 (sql.qp/->honeysql driver/*driver* (sql.qp/make-clause driver/*driver* :absolute-datetime t :day))
