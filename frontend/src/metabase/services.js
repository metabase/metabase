...
export const XRayApi = {
    // X-Rays
    field_thumbprint:            GET("api/xray/field/:fieldId"),
    table_thumbprint:            GET("api/xray/table/:tableId"),
    segment_thumbprint:          GET("api/xray/segment/:segmentId"),
    card_thumbprint:             GET("api/xray/card/:cardId"),
