...
Folder permissions should not be considered a security feature, but instead a feature that helps organize and standardize snippets. For more info, see the [discussion on permissions below](#permissions).
