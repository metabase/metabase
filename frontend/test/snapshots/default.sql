...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B66F2288_20F9_4251_86B7_359354C5264D START WITH 6 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_4C276AD3_E4E5_446D_A41D_2DB4C1646ADD START WITH 6 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_C972BB38_4DD8_4397_8176_79088EBE1088 START WITH 5 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_C870F284_CE33_49AE_9F05_189363E8BAAA START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_62C6A3AA_43CA_433C_8408_F347840039F6 START WITH 9 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_E492C576_6A4F_49A0_B5BB_92D2E58FDC61 START WITH 3 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_712C89EE_75CA_4FAE_86C8_06C4674C4C4A START WITH 3 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8A527FDE_084D_4CAA_81AE_8A9CBA6F00D7 START WITH 2 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_AE45A6EF_FA6A_4423_BB77_049CE69E469A START WITH 11 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B2330150_DBEC_4817_9E1C_B54EC1DEC97F START WITH 7 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_AC5202FA_F6EB_45BB_A385_C2C8BAF49F68 START WITH 2 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_72412C60_4289_4943_A321_B08DD5905EF9 START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_DBC04B8D_0B65_4752_9090_2A90FF18C8CC START WITH 2 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_2396E8BE_968B_42BB_A419_F621E9E35D9F START WITH 2 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_C3424C08_9C5E_4FCB_8075_C09719E8D4C4 START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_86BBC945_5DB4_4B79_BFE1_7C266FB9686E START WITH 6 BELONGS_TO_TABLE;     
...
(1, TIMESTAMP '2020-03-19 23:22:48.107', TIMESTAMP '2020-03-19 23:22:48.107', 2, 2, 0, 0, 1, 1, '[]', '{}');             
...
(1, '{"2":{"1":{"native":"write","schemas":"all"}},"1":{"1":{"native":"write","schemas":"all"}}}', '{"1":{"1":{"native":"none","schemas":"none"}},"4":{"1":{"schemas":"none","native":"none"}},"5":{"1":{"schemas":"all","native":"write"}}}', 1, TIMESTAMP '2020-03-19 23:22:47.464', NULL);   
...
('settings-last-updated', '2020-03-19 23:22:46.263');               
...
(1, '{"4":{"root":"none"},"1":{"root":"write"},"3":{"root":"write"},"2":{"root":"write"}}', '{"4":{"root":"write"},"1":{"root":"none"}}', 1, TIMESTAMP '2020-03-19 23:22:47.547', NULL);         
...
(1, TIMESTAMP '2020-03-19 23:22:48.079', TIMESTAMP '2020-03-19 23:22:48.079', 'Orders in a dashboard', NULL, 1, '[]', NULL, NULL, FALSE, NULL, NULL, FALSE, NULL, FALSE, NULL, NULL, NULL);
...
(1, 'admin@metabase.com', 'Bobby', 'Tables', '$2a$10$/76iUSsbd9YE5JOwzggjWOxn5d/uJvpTPQZBThNglJnu8bJxFj7dq', 'f6121fa5-bad7-4a65-a91a-ca03959db376', TIMESTAMP '2020-03-19 23:22:46.071', TIMESTAMP '2020-03-19 23:22:46.184', TRUE, TRUE, NULL, NULL, FALSE, FALSE, FALSE, NULL, TIMESTAMP '2020-03-19 23:22:48.156'),
(2, 'normal@metabase.com', 'Robert', 'Tableton', '$2a$10$7ZQywUe.PqeDjVgjLb9zmeuQBto29ol0wKH6Zw.BbalHGwF/lEGse', '4f180bf4-620f-461b-87a2-d43a01400a10', TIMESTAMP '2020-03-19 23:22:46.663', NULL, FALSE, TRUE, '$2a$10$bkULm7Ri2ysEp33Vt3HlfuzEo0qAXZGyb.Dwx/IzjNEd4RWQ3yAXu', 1584685366671, TRUE, FALSE, FALSE, NULL, TIMESTAMP '2020-03-19 23:22:46.663'),
(3, 'nodata@metabase.com', 'No Data', 'Tableton', '$2a$10$PWOI1rCG81urleFZovZIBOP6lbLrtC1oywibSDT8vN9ihfye23Yui', '1da7c73f-e3ee-47de-85dd-c61ca018c33b', TIMESTAMP '2020-03-19 23:22:46.861', NULL, FALSE, TRUE, '$2a$10$RjUOQg6mW5Qb1ylzXyeqOuMGHlv9tguerniVH1/caKhHzXq.Q.RO6', 1584685366863, TRUE, FALSE, FALSE, NULL, TIMESTAMP '2020-03-19 23:22:46.861'),
(4, 'nocollection@metabase.com', 'No Collection', 'Tableton', '$2a$10$sSEqo1NTrcjoEylkPssoiu2KWb0CTG7JFMs6VmU7Jv76qj8OEja7a', '193c7577-fb07-4698-ac47-a444e9f16546', TIMESTAMP '2020-03-19 23:22:47.032', NULL, FALSE, TRUE, '$2a$10$CpKkBD08xB2EchRxd9OpuuH8YiR0vJTIBhpSvj5EKcXSxZx8Q2eNu', 1584685367034, TRUE, FALSE, FALSE, NULL, TIMESTAMP '2020-03-19 23:22:47.032'),
(5, 'none@metabase.com', 'None', 'Tableton', '$2a$10$8RxTYlJRWAV4tSp26xOTjeBwFg1GGt2WH/FF2tFW1O0aZIwDnRtYe', '2bd7e536-f5a3-453f-9015-10b232970a11', TIMESTAMP '2020-03-19 23:22:47.207', NULL, FALSE, TRUE, '$2a$10$neWcCAg7Eerm3Y1QqpH0POK4lRnnoT/h0bwTWIzvdQe4F.x0W1qsO', 1584685367209, TRUE, FALSE, FALSE, NULL, TIMESTAMP '2020-03-19 23:22:47.207');              
...
(2, 'user-joined', TIMESTAMP '2020-03-19 23:22:46.183', 1, 'user', 1, NULL, NULL, NULL, '{}'),
(3, 'card-create', TIMESTAMP '2020-03-19 23:22:47.754', 1, 'card', 1, 1, 2, NULL, '{"name":"Orders","description":null}'),
(4, 'card-create', TIMESTAMP '2020-03-19 23:22:48.053', 1, 'card', 2, 1, 2, NULL, '{"name":"Orders, Count","description":null}'),
(5, 'dashboard-create', TIMESTAMP '2020-03-19 23:22:48.084', 1, 'dashboard', 1, NULL, NULL, NULL, '{"description":null,"name":"Orders in a dashboard"}'),
(6, 'dashboard-add-cards', TIMESTAMP '2020-03-19 23:22:48.128', 1, 'dashboard', 1, NULL, NULL, NULL, '{"description":null,"name":"Orders in a dashboard","dashcards":[{"name":"Orders","description":null,"id":1,"card_id":1}]}');     
...
(1, TIMESTAMP '2020-03-19 23:22:23.564', TIMESTAMP '2020-03-19 23:22:46.397', 'Sample Dataset', NULL, '{"db":"./resources/sample-dataset.db;USER=GUEST;PASSWORD=guest"}', 'h2', TRUE, TRUE, NULL, NULL, '0 0 * * * ? *', '0 0 0 * * ? *', 'America/Los_Angeles', FALSE, NULL, TRUE); 
...
(1, 1, 'card', 1, TIMESTAMP '2020-03-19 23:22:47.749'),
(2, 1, 'card', 2, TIMESTAMP '2020-03-19 23:22:48.048');    
...
('e2e1ca34-06ab-4895-8195-9af4edce6edb', 1, TIMESTAMP '2020-03-19 23:22:46.181');              
...
(1, 'Card', 1, 1, TIMESTAMP '2020-03-19 23:22:47.752', '{"description":null,"archived":false,"collection_position":null,"table_id":2,"database_id":1,"enable_embedding":false,"collection_id":null,"query_type":"query","name":"Orders","read_permissions":null,"creator_id":1,"made_public_by_id":null,"embedding_params":null,"cache_ttl":null,"dataset_query":{"database":1,"query":{"source-table":2},"type":"query"},"id":1,"display":"table","visualization_settings":{},"public_uuid":null}', FALSE, TRUE, NULL),
(2, 'Card', 2, 1, TIMESTAMP '2020-03-19 23:22:48.051', '{"description":null,"archived":false,"collection_position":null,"table_id":2,"database_id":1,"enable_embedding":false,"collection_id":null,"query_type":"query","name":"Orders, Count","read_permissions":null,"creator_id":1,"made_public_by_id":null,"embedding_params":null,"cache_ttl":null,"dataset_query":{"database":1,"query":{"source-table":2,"aggregation":[["count"]]},"type":"query"},"id":2,"display":"table","visualization_settings":{},"public_uuid":null}', FALSE, TRUE, NULL),
(3, 'Dashboard', 1, 1, TIMESTAMP '2020-03-19 23:22:48.087', '{"description":null,"name":"Orders in a dashboard","cards":[]}', FALSE, TRUE, NULL),
(4, 'Dashboard', 1, 1, TIMESTAMP '2020-03-19 23:22:48.131', '{"description":null,"name":"Orders in a dashboard","cards":[{"sizeX":2,"sizeY":2,"row":0,"col":0,"id":1,"card_id":1,"series":[]}]}', FALSE, FALSE, NULL);            
...
('MetabaseScheduler', 'If.local1584685343423', 1584685366012, 7500);            
