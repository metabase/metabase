...
(mu/defmethod notification.payload/notification-payload :notification/dashboard
  [{:keys [creator_id dashboard_subscription] :as notification-info} :- ::notification.payload/Notification]
