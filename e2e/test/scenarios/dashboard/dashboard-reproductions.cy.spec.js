...
describe("dashboard reproductions", () => {
  before(() => {
    H.restore();
  });
  ...
  // needs own restore because it modifies collection permissions
  ...
  // needs own restore because it modifies permissions and activates token
