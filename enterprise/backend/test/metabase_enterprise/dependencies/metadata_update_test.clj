...
(deftest ^{:parallel false} card-update-updates-child-metadata-test
...
(deftest ^{:parallel false} native-card-update-does-not-update-children-test
...
(deftest ^{:parallel false} model-update-passes-down-new-values-test
...
(deftest ^{:parallel false} model-update-respects-child-overrides-test
...
(deftest ^{:parallel false} model-update-stops-recursing-when-child-metadata-is-unchanged-test
...
(deftest ^{:parallel false} sync-removed-column-triggers-reanalysis-test
...
(deftest ^{:parallel false} sync-without-changes-does-not-trigger-reanalysis-test
