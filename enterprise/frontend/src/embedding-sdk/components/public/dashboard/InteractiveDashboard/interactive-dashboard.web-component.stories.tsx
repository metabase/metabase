...
import "./interactive-dashboard.web-component";
...
export default {
  title: "EmbeddingSDK/InteractiveDashboard/web-component",
...
export const Dashboard = () => (
  <interactive-dashboard dashboard-id={DASHBOARD_ID} />
);

export const WithDownloads = () => (
  <interactive-dashboard dashboard-id={DASHBOARD_ID} with-downloads="true" />
);
