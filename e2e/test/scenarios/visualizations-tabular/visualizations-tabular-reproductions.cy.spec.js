...
describe("visualizations tabular reproductions", () => {
  before(() => {
    H.restore();
  });
  ...
  // Uses H.restore("postgres-12") — non-default restore argument
  ...
  // Modifies field visibility_type via API
