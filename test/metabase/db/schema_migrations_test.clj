...
#_(deftest database-position-test
...
#_(deftest email-lowercasing-test
...
#_(deftest semantic-type-migration-tests
...
#_(deftest convert-text-to-longtext-migration-test
...
#_(deftest convert-query-cache-result-to-blob-test
...
#_(deftest remove-bigquery-driver-test
...
#_(deftest create-root-permissions-entry-for-admin-test
...
#_(deftest create-database-entries-for-all-users-group-test
...
#_(deftest migrate-legacy-site-url-setting-test
...
#_(deftest site-url-ensure-protocol-test
...
#_(deftest add-migrated-collections-test
...
#_(deftest grant-all-users-root-collection-readwrite-perms-test
...
#_(deftest clear-ldap-user-passwords-test
...
#_(deftest grant-download-perms-test
...
#_(deftest grant-subscription-permission-test
...
#_(deftest rename-general-permissions-to-application-test
...
#_(deftest add-parameter-to-cards-test
...
#_(deftest add-parameter-mappings-to-cards-test
...
#_(deftest grant-all-users-root-snippets-collection-readwrite-perms-test
