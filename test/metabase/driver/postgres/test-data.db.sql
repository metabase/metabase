...
CREATE TABLE "categories" ("id" SERIAL, "name" TEXT NOT NULL, PRIMARY KEY ("id"));
...
ALTER TABLE
  "venues"
ADD
  CONSTRAINT "tegory_id_categories_927642602" FOREIGN KEY ("category_id") REFERENCES "categories" ("id");

ALTER TABLE
  "checkins"
ADD
  CONSTRAINT "ckins_user_id_users_-815717481" FOREIGN KEY ("user_id") REFERENCES "users" ("id");

ALTER TABLE
  "checkins"
ADD
  CONSTRAINT "ns_venue_id_venues_-1854903846" FOREIGN KEY ("venue_id") REFERENCES "venues" ("id");
