...
describe("scenarios > dashboard > temporal unit parameters", () => {
  ...
  describe("mapping targets", () => {
    it("should connect a parameter to a question and drill thru", () => {
      ...
      H.queryBuilderMain().findByText("Created At: Year").should("be.visible");
      backToDashboard();
      H.editDashboard();
      removeQuestion();
      ...
      H.queryBuilderMain().findByText("Q2 2022").should("be.visible");
      backToDashboard();
      H.editDashboard();
      removeQuestion();
      ...
      H.queryBuilderMain().findByText("Date: Quarter").should("be.visible");
      backToDashboard();
      H.editDashboard();
      removeQuestion();
