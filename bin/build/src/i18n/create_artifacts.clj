  ...
  (u/step "Create resources/locales.clj"
    (let [file (u/filename u/project-root-directory "resources" "locales.json")]
      ...
      (spit file
            (with-out-str
              (println "{")
              (println "  \"_comment\": \"DO NOT EDIT THIS FILE! It is autogenerated by `i18n.create-artifacts` as part of the release process.\",")
              (println (format "  \"locales\": %s" (json/encode (conj (i18n/locales) "en"))))
              (println "}")))
      (u/assert-file-exists file))))
