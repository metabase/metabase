...
(deftest ^{:parallel false} dashboard-parameters
...
(deftest ^{:parallel false} dashboard-remapping-multi-field-permissions-test
...
(deftest ^{:parallel false} dashboard-remapping-restricted-permissions-test
  ;; Test for issue #47951: Dashboard filters should show remapped values even when
  ;; user has view-data but not create-queries permissions on the target table.
...
(deftest ^{:parallel false} dashboard-remapping-parallel-fks-test
...
(deftest ^{:parallel false} dashboard-remapping-conflict-scenarios-test
...
(deftest ^{:parallel false} field-values-without-create-queries-perms-test
...
(deftest ^{:parallel false} remapped-param-value-with-model-card-test
...
(deftest ^{:parallel false} implicit-fk-pk-name-remapped-value-single-field-test
