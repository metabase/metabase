...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."test_data_with_timezones_users" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."test_data_with_timezones_users" (
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."data_with_timezones_categories" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."data_with_timezones_categories" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  "name" VARCHAR2(4000) NOT NULL,
  PRIMARY KEY ("id")
);

BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."est_data_with_timezones_venues" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."est_data_with_timezones_venues" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  "name" VARCHAR2(4000),
  "category_id" INTEGER,
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."t_data_with_timezones_checkins" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."t_data_with_timezones_checkins" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER,
...
ALTER TABLE
  "CAM_24"."est_data_with_timezones_venues"
ADD
  CONSTRAINT "tegory_id_categories_341257635" FOREIGN KEY ("category_id") REFERENCES "CAM_24"."data_with_timezones_categories" ("id");

ALTER TABLE
  "CAM_24"."t_data_with_timezones_checkins"
ADD
  CONSTRAINT "eckins_user_id_users_660849906" FOREIGN KEY ("user_id") REFERENCES "CAM_24"."test_data_with_timezones_users" ("id");

ALTER TABLE
  "CAM_24"."t_data_with_timezones_checkins"
ADD
  CONSTRAINT "ins_venue_id_venues_1367144309" FOREIGN KEY ("venue_id") REFERENCES "CAM_24"."est_data_with_timezones_venues" ("id");

-- 15 rows
INSERT INTO "CAM_24"."test_data_with_timezones_users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "CAM_24"."data_with_timezones_categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "CAM_24"."est_data_with_timezones_venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "CAM_24"."t_data_with_timezones_checkins" ("date", "user_id", "venue_id")
VALUES
