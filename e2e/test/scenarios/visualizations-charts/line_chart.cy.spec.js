...
describe("scenarios > visualizations > line chart", () => {
  ...
  it("should correctly display tooltip values when X-axis is numeric and style is 'Ordinal' (metabase#15998)", () => {
    ...
    H.popover().within(() => {
      H.testPairedTooltipValues("Product → Rating", "2.7");
      H.testPairedTooltipValues("Count", "191");
      H.testPairedTooltipValues("Sum of Total", "14,747.05");
      H.testPairedTooltipValues("Average of Quantity", "4.3");
    });
  });
      ...
      createOrdersQuestionWithAggregation({
        ...
        createOrdersQuestionWithAggregation({
          ...
          cy.createDashboard().then(({ body: { id: dashboardId } }) => {
            ...
            H.popover().within(() => {
              H.testPairedTooltipValues("Created At", "2022");
              H.testPairedTooltipValues(RENAMED_FIRST_SERIES, "42,156.87");
            });

            showTooltipForFirstCircleInSeries("#98D9D9");
            H.popover().within(() => {
              H.testPairedTooltipValues("Created At", "2022");
              H.testPairedTooltipValues(RENAMED_SECOND_SERIES, "54.44");
            });
          });
        });
      });
      ...
      createOrdersQuestionWithAggregation({
        ...
        cy.createQuestion({
          ...
          cy.createDashboard().then(({ body: { id: dashboardId } }) => {
            ...
            H.popover().within(() => {
              H.testPairedTooltipValues("Created At", "2022");
              H.testPairedTooltipValues(RENAMED_SECOND_SERIES, "2,829.03");
            });
          });
        });
      });
