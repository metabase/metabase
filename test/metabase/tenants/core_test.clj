...
#_(deftest attribute-structure-oss-with-user-login-attributes-test
...
#_(deftest attribute-structure-oss-with-nil-login-attributes-test
...
#_(deftest attribute-structure-oss-with-empty-login-attributes-test
...
#_(deftest attribute-structure-oss-user-without-login-attributes-key-test
...
#_(deftest attribute-structure-oss-preserves-other-user-fields-test
