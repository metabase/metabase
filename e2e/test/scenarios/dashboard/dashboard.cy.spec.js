  ...
  describe("existing dashboard", () => {
    ...
    context("title and description", () => {
      ...
      it("should update the name and description without entering the dashboard edit mode", () => {
        ...
        H.toggleDashboardInfoSidebar();
        H.sidebar().findByText(newDescription);
        ...
        H.sidebar().findByText(newDescription).type("Baz{esc}");
        H.sidebar().findByText(newDescription);
        cy.get("@updateDashboardSpy").should("have.callCount", 2);
      });
    ...
    it(
      ...
      () => {
        ...
        H.getDashboardCards().eq(0).contains("top");
        H.getDashboardCards().eq(1).contains("bottom");
      },
    );
  });
