...
export interface DataApp {
  ...
  table_ids: number[];
  /** Whether any assigned group lacks access to a table used by this app. */
  has_group_permission_warnings?: boolean;
  /**
...
export interface GetDataAppGroupPermissionWarningsRequest {
  name: string;
  group_ids: number[];
}
