...
describe("scenarios > data studio > modeling > models", () => {
  ...
  it("should edit model name and description", () => {
    ...
    cy.findByRole("table").findByText("Orders Model").click();

    cy.log("Verify model overview page is visible");
    H.DataStudio.Models.overviewPage().should("be.visible");

    cy.log("Update the model name");
    H.DataStudio.Models.overviewPage()
      .findByDisplayValue("Orders Model")
      .clear()
  ...
  it("should navigate between tabs", () => {
    ...
    cy.log("Verify Overview tab is active");
    H.DataStudio.Models.overviewPage().should("be.visible");
    ...
    H.DataStudio.Models.fieldsPage().should("be.visible");
    H.DataStudio.Models.fieldsPage().findByText("ID").should("exist");
  ...
  it("should archive and restore a model", () => {
    ...
    H.DataStudio.Modeling.collectionPage()
      .findByText("No models or metrics yet")
      .should("be.visible");
    ...
    cy.visit("/data-studio/modeling/collections/root");
    H.DataStudio.Modeling.collectionPage().should("be.visible");
    cy.findByRole("table").findByText("Orders Model").should("be.visible");
  });
  ...
  it("should duplicate model via more menu", () => {
    ...
    H.modal().findByText('Duplicate "Orders Model"').should("be.visible");
    H.modal()
      .findByLabelText("Name")
      .should("have.value", "Orders Model - Duplicate");
    ...
    H.DataStudio.Models.overviewPage()
      .findByText("Orders Model - Duplicate")
      .should("be.visible");
  ...
  it("should move model to different collection via more menu", () => {
    ...
    cy.log("Verify model is no longer in Our analytics");
    cy.visit("/data-studio/modeling/collections/root");
    H.DataStudio.Modeling.collectionPage().should("be.visible");
    H.DataStudio.Modeling.collectionPage()
      .findByText("No models or metrics yet")
