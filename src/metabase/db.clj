...
(defn- migration-entries
  "Return a set of migration files (without path or prefix) that have already been ran.
...
(defn- has-unran-migration-files?
  "`true` if the set of migration files is the same as the set of migrations that have already been ran."
  ^Boolean []
  (not= (migration-files)
        (migration-entries)))
