...
Metabase will securely encrypt and store the connection details for any new Databases you add. If you added databases before setting this value, you can encrypt the connection details by going to each one of those databases in the Settings and clicking on the "Save" button. Also, any existing databases with unencrypted details will continue to work normally.
