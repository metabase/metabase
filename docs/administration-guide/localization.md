...
You can set the first day of the week (default: Sunday). Setting the first day of the week affects things like grouping by week and filtering in GUI queries ([simple](../users-guide/04-asking-questions.html) and [custom questions](../users-guide/custom-questions.html) composed in the notebook editor). This setting does not affect [SQL queries](../users-guide/writing-sql.html).
