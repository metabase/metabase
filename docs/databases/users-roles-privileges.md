...
You can [upload CSV](../databases/uploads.md) to supported databases. Metabase's database user write access (`INSERT`, `UPDATE`, `DELETE`) to the schema where you want to store the uploads. 
