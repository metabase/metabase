...
(defn scheduled-base-query-to-rerun
  "The unparameterized query definition of the Card with `card-id` executed after `started-after`, or nil."
...
(defn scheduled-parameterized-queries-to-rerun
  "The `limit` most common parameterized query definitions of the Card with `card-id` executed after
  `rerun-cutoff`."
