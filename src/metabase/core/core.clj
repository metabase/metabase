...
(comment
  ...
  ;; H2 is *not* here -- it's an optional driver loaded conditionally in [[metabase.driver.init]] when its JAR is on the
  ;; classpath. See [[metabase.config.core/h2-available?]].
