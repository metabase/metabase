...
- If replacing a table, that **original table can't be a target of a Metabase's [semantic foreign keys](../metadata/semantic-types.md)** from other tables.
...
- Targets for [actions](../../data-modeling/models/actions/introduction.md).
