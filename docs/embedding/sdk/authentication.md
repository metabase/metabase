...
In Admin Settings->Authentication->JWT SSO, ensure the field `JWT Identity Provider URI` is set to the URL of your JWT SSO endpoint, e.g. `http://localhost:9090/sso/metabase`.
