...
describe("scenarios > embedding > questions", () => {
  ...
  it("should display the GUI question with aggregation correctly", () => {
    ...
    H.cartesianChartCircle().last().realHover();

    H.popover().within(() => {
      H.testPairedTooltipValues("Created At", "Aug 2022");
      H.testPairedTooltipValues("Math", "2");
      H.testPairedTooltipValues("Count", "79");
    });
  });
  ...
  context("without token", () => {
    it("should not be possible to disable downloads", () => {
      cy.get("@questionId").then(questionId => {
        ...
        H.openStaticEmbeddingModal({ activeTab: "appearance" });
