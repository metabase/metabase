(ns metabase-enterprise.search.semantic.migration-test
  (:require
   ...
   [metabase-enterprise.search.semantic.db.connection :as semantic.db.connection]
    ...
    (semantic.tu/with-test-db-defaults!
      (letfn [(migrate-and-get-db-version
                ...
                (with-redefs [semantic.db.migration.impl/schema-version          attempted-version
                  ...
                  (log.capture/with-log-messages-for-level [messages [metabase-enterprise.search.semantic.db.migration :info]]
