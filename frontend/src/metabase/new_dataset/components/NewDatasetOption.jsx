...
<<<<<<<< HEAD:frontend/src/metabase/new_model/components/NewModelOption.jsx
export default class NewModelOption extends Component {
========
export default class NewDatasetOption extends Component {
>>>>>>>> 54cb71da9b (Clean up and update files around new query):frontend/src/metabase/new_dataset/components/NewDatasetOption.jsx
  state = {
    hover: false,
  };
