...
/**
 * Returns module-graph helpers for a given (elements, rules) config.
 */
function createAffectedModules(elements, rules) {
...
module.exports = { createAffectedModules, globToRegex };
