...
import type { DashboardStoryArgTypes } from "./arg-types";
...
export type DashboardStoryDefaultArgsProps = Partial<DashboardStoryArgTypes>;
export const dashboardStoryDefaultArgs = ({
  dashboardId = DASHBOARD_ID,
  ...rest
}: DashboardStoryDefaultArgsProps = {}): DashboardStoryArgTypes => ({
  mode: "editable",
  dashboardId,
  withTitle: true,
  withCardTitle: true,
