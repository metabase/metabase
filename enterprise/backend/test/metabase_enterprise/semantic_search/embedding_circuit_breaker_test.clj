...
(deftest ^{:parallel false} request-failure-does-not-change-service-failure-history-test
...
(deftest ^{:parallel false} unexpected-dimensions-do-not-trip-breaker-test
...
(deftest ^{:parallel false} invalid-vector-values-trip-breaker-test
...
(deftest ^{:parallel false} opens-after-threshold-and-fast-fails-test
...
(deftest ^{:parallel false} circuit-open-fast-failure-does-not-log-request-error-test
...
(deftest ^{:parallel false} throwable-releases-half-open-permit-test
...
(deftest ^{:parallel false} interruption-releases-half-open-permit-test
...
(deftest ^{:parallel false} local-bookkeeping-failure-does-not-trip-breaker-test
...
(deftest ^{:parallel false} malformed-response-trips-breaker-test
...
(deftest ^{:parallel false} endpoint-circuits-are-isolated-test
...
(deftest ^{:parallel false} kill-switch-bypasses-breaker-test
...
(deftest ^{:parallel false} probe-bypass-flag-bypasses-breaker-test
...
(deftest ^{:parallel false} circuit-untrusted?-covers-half-open-test
...
(deftest ^{:parallel false} open-circuit-recovery-waits-for-the-trial-window-test
...
(deftest ^{:parallel false} recovery-scheduling-failure-releases-claim-test
...
(deftest ^{:parallel false} failed-idle-recovery-schedules-another-trial-test
...
(deftest ^{:parallel false} state-change-persists-affected-checks-test
...
(deftest ^{:parallel false} state-changes-run-serially-in-arrival-order-test
