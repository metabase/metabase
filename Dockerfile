...
FROM metabase/ci:circleci-java-11-clj-1.10.3.929-07-27-2021-node-browsers as backend
...
FROM metabase/ci:circleci-java-11-clj-1.10.3.929-07-27-2021-node-browsers as drivers
