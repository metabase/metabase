...
describe("getUrl", () => {
  it("should generate URL with all params", () => {
    ...
    expect(getUrl(params)).toBe(
      "/bench/data/database/1/schema/1:public/table/2/field/3",
    );
  });
  ...
  it("should generate URL with database, schema, and table", () => {
    ...
    expect(getUrl(params)).toBe(
      "/bench/data/database/1/schema/1:public/table/2",
    );
  });
  ...
  it("should generate URL with database and schema", () => {
    ...
    expect(getUrl(params)).toBe("/bench/data/database/1/schema/1:public");
  });
  ...
  it("should generate URL with database", () => {
    ...
    expect(getUrl(params)).toBe("/bench/data/database/1");
  });
  ...
  it("should generate base URL when no params are provided", () => {
    ...
    expect(getUrl(params)).toBe("/bench/data");
  });
