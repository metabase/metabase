...
DROP TABLE IF EXISTS "schema_20"."test_data_users" CASCADE;

CREATE TABLE "schema_20"."test_data_users" (
...
DROP TABLE IF EXISTS "schema_20"."test_data_categories" CASCADE;

CREATE TABLE "schema_20"."test_data_categories" (
  "id" INTEGER IDENTITY(1, 1),
  "name" VARCHAR(1024) NOT NULL,
  PRIMARY KEY ("id")
);

DROP TABLE IF EXISTS "schema_20"."test_data_venues" CASCADE;

CREATE TABLE "schema_20"."test_data_venues" (
  "id" INTEGER IDENTITY(1, 1),
  "name" VARCHAR(1024),
  "category_id" INTEGER,
  "latitude" FLOAT8,
...
DROP TABLE IF EXISTS "schema_20"."test_data_checkins" CASCADE;

CREATE TABLE "schema_20"."test_data_checkins" (
  "id" INTEGER IDENTITY(1, 1),
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER,
...
ALTER TABLE
  "schema_20"."test_data_venues"
ADD
  CONSTRAINT "tegory_id_categories_927642602" FOREIGN KEY ("category_id") REFERENCES "schema_20"."test_data_categories" ("id");

ALTER TABLE
  "schema_20"."test_data_checkins"
ADD
  CONSTRAINT "ckins_user_id_users_-815717481" FOREIGN KEY ("user_id") REFERENCES "schema_20"."test_data_users" ("id");

ALTER TABLE
  "schema_20"."test_data_checkins"
ADD
  CONSTRAINT "ns_venue_id_venues_-1854903846" FOREIGN KEY ("venue_id") REFERENCES "schema_20"."test_data_venues" ("id");

-- 15 rows
INSERT INTO "schema_20"."test_data_users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "schema_20"."test_data_categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "schema_20"."test_data_venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "schema_20"."test_data_checkins" ("date", "user_id", "venue_id")
VALUES
