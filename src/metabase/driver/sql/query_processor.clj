...
(defmethod ->honeysql [:sql :percentile] [driver [_ field p]] (hsql/call :percentile     (->honeysql driver field) (->honeysql driver p)))
...
(defmethod ->honeysql [:sql :expt]  [driver [_ field]] (hsql/call :expt (->honeysql driver field)))
