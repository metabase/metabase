...
(deftest ^:parallel col-info-for-aggregation-merge-driver-info-test
  (mt/with-everything-store
...
(deftest ^:parallel col-info-for-aggregation-with-named-expression-test
  (mt/with-everything-store
...
(deftest aggregated-models-display-name-test
