...
(deftest ^:parallel table-width-test
...
(deftest ^:parallel installed-fonts-test
...
(deftest ^:parallel wrap-non-lato-characters-test
...
(deftest ^:parallel non-lato-characters-can-render-test
