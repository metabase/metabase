(ns metabase-enterprise.search.semantic.task.index-cleanup-test
  (:require
   ...
   [metabase-enterprise.search.semantic.repair :as repair]
   [metabase-enterprise.search.semantic.settings :as semantic.settings]
   [metabase-enterprise.search.semantic.task.index-cleanup :as sut]
