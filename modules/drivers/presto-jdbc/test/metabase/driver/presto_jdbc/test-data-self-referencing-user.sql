...
DROP TABLE IF EXISTS "test_data"."default"."ta_self_referencing_user_users";

CREATE TABLE "test_data"."default"."ta_self_referencing_user_users" (
  "id" INTEGER,
  "name" VARCHAR,
...
-- 15 rows
INSERT INTO "test_data"."default"."ta_self_referencing_user_users" ("name", "last_login", "password", "created_by")
VALUES
