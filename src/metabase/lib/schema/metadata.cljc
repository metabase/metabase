...
(mr/def ::persisted-info.definition
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:716"}
   [:table-name        ::lib.schema.common/non-blank-string]
   [:field-definitions [:maybe [:sequential
                                [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:719"}
...
(mr/def ::persisted-info
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:726"}
   [:active     :boolean]
...
(mr/def ::card
  ...
  [:map
   {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:845", :decode/normalize normalize-card
...
(mr/def ::segment
  ...
  [:map
   {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:902", :error/message "Valid Segment metadata"
...
(mr/def ::dimension-group
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:941"}
   [:id :string]
...
(mr/def ::dimension-source
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:950"}
...
(mr/def ::dimension-mapping
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:965"}
...
(mr/def ::persisted-dimension
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:982"}
   [:id               ::dimension-id]
...
(mr/def ::measure
  ...
  [:map
   {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1002", :error/message "Valid Measure metadata"
...
(mr/def ::native-query-snippet
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1029"}
...
(mr/def ::table
  ...
  kebab-case keys."
  [:map
   {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1043", :error/message "Valid Table metadata"}
...
(mr/def ::database
  ...
  [:map
   {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1087", :error/message "Valid Database metadata"}
   [:lib/type [:= :metadata/database]]
   [:id ::lib.schema.id/database]
   ;; TODO -- this should validate against the driver features list in [[metabase.driver/features]] if we're in
   ;; Clj mode
   [:dbms-version    {:optional true} [:maybe [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1092"}
...
(mr/def ::transform.source-incremental-strategy
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1178"}
   [:type                       [:or :keyword :string]]
   [:checkpoint-filter-field-id {:optional true} [:maybe ::lib.schema.id/field]]
   [:lookback                   {:optional true} [:maybe [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1181"}
                                                          [:value pos-int?]
                                                          [:unit  :string]]]]])

(mr/def ::transform.target-incremental-strategy
  "Incremental strategy of a Transform target, as stored in the app DB."
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1187"}
   [:type       [:or :keyword :string]]
   [:unique-key {:optional true} [:sequential [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1189"}
                                               [:name     {:optional true} :string]
                                               [:field-id {:optional true} [:maybe ::lib.schema.id/field]]]]]])

(mr/def ::transform.source-table
  "One source table entry of a Python Transform source, as stored in the app DB."
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1195"}
   [:alias       :string]
...
(mr/def ::transform.source
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1204"}
...
(mr/def ::transform.target
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1214"}
   [:type                        {:optional true} [:or :keyword :string]]
...
(mr/def ::transform
  ...
  [:map {:closed true, :probe/id "src/metabase/lib/schema/metadata.cljc:1223"}
