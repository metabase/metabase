...
export const EmbeddingSwitchWidget = ({
  ...
  <Stack spacing={"md"} className={CS.textMeasure}>
    <Text lh={1.5}>
      {t`Embed dashboards, questions, or the entire Omniloy app into your application. Integrate with your server code to create a secure environment, limited to specific users or organizations.`}
    </Text>
    <Switch
      labelPosition="left"
