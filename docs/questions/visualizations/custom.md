...
- Each custom visualization lists the Metabase versions it supports (for example, "Requires Metabase >=1.62 <1.64"). If your Metabase version isn't in that range, Metabase rejects the upload and tells you which version the visualization needs.
