...
(def TokenStatus
  ...
  [:map {:closed true, :probe/id "src/metabase/premium_features/token_check.clj:168"}
   [:valid                          :boolean]
   [:status                         [:string {:min 1}]]
   ...
   [:store-users   {:optional true} [:maybe [:sequential [:map {:closed true, :probe/id "src/metabase/premium_features/token_check.clj:179"}
                                                          [:email :string]]]]]
   [:meters        {:optional true} Meters]
   [:quotas        {:optional true} [:sequential [:map {:closed true, :probe/id "src/metabase/premium_features/token_check.clj:182"}
