...
(s/defn ->field :- (s/maybe (mi/InstanceOf:Schema Field))
...
(s/defn ^:private collect-metrics :- (s/maybe [(mi/InstanceOf:Schema Metric)])
  [root question]
...
(s/defn ^:private collect-breakout-fields :- (s/maybe [(mi/InstanceOf:Schema Field)])
  [root question]
