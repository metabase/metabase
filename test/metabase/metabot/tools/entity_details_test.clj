...
(deftest ^:parallel get-document-details-invalid-document-id-test
...
(deftest ^:parallel get-document-details-valid-document-test
...
(deftest ^:parallel get-document-details-nonexistent-document-test
...
(deftest ^:parallel get-document-details-archived-document-test
...
(deftest ^:parallel get-document-details-minimal-document-test
...
(deftest ^:parallel get-document-details-empty-document-content-test
...
(deftest ^:parallel get-query-details-mbql-v4-test
...
(deftest ^:parallel get-query-details-mbql-v5-test
...
(deftest ^:parallel get-query-details-native-query-test
...
(deftest ^:parallel related-tables-exclude-implicitly-joinable-fields-test
...
(deftest ^:parallel get-table-details-with-measures-test
...
(deftest ^:parallel get-table-details-with-segments-test
...
(deftest ^:parallel get-table-details-measures-scoped-to-table-test
...
(deftest ^:parallel get-metric-details-with-segments-test
