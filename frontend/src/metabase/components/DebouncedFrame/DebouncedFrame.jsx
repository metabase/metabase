...
const DebouncedFrameForwardRef = forwardRef((props, ref) => {
  return <DebouncedFrame {...props} forwardedRef={ref}></DebouncedFrame>;
});

DebouncedFrameForwardRef.displayName = "DebouncedFrame";
