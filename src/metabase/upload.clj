...
(defn- derive-display-names [driver header]
  (let [generator-fn (legacy-mbql/unique-name-generator :unique-alias-fn (unique-alias-fn driver " "))]
    (mapv generator-fn
          (for [h header]
...
(defn- derive-column-names [driver header]
  (let [generator-fn (legacy-mbql/unique-name-generator :unique-alias-fn (unique-alias-fn driver "_"))]
