...
describe("scenarios > data studio > library > tables", () => {
  ...
  it("should show, edit, and unpublish a table from the library", () => {
  ...
  it("should rename fields, close field panels, and view the table in the query builder", () => {
    ...
    cy.log("close field details and preview panels");
    ...
    cy.log("renamed field shows up in the overview");
