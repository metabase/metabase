...
(mr/def ::json-value
  "A JSON-shaped value: a scalar, a sequence of JSON values, or a JSON object. Object keys are strings, or keywords
  at any depth once decoded with `json/decode+kw`."
  [:or
   :string
   :keyword
   number?
