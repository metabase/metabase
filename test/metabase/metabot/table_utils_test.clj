(ns metabase.metabot.table-utils-test
  (:require
...
(deftest ^:synchronized find-matching-tables-test
...
(deftest ^:synchronized enhanced-database-tables-test
...
(deftest ^:synchronized schema-sample-basic-functionality-test
...
(deftest ^:synchronized schema-sample-special-characters-test
...
(deftest ^:parallel schema-sample-h2-ddl-test
  (mt/test-driver :h2
...
(deftest ^:parallel schema-sample-postgres-ddl-test
