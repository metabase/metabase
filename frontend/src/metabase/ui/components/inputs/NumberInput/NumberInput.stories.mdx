...
export const sampleArgs = {
  value: 1234,
  label: "Goal value",
  description: "Constant line added as a marker to a chart",
  placeholder: "0",
  error: "required",
};
...
- [Figma File](https://www.figma.com/file/YWyb541aUHtYXJVPzyYSbg/Input-%2F-Numbers?type=design&node-id=1-96&mode=design&t=2eUYOsqZZeMc4OGT-0)
