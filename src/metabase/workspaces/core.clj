(ns metabase.workspaces.core
  "OSS-side public API for workspace mode.
   ...
   the gates are no-ops. The EE impl in `metabase-enterprise.workspaces-deprecated.core`
...
(defenterprise workspace-mode?
  "True if this instance is running in workspace mode — a `:workspace` section
   ...
   `metabase-enterprise.workspaces-deprecated.core/db-workspace-namespace` (returns the
  ...
  metabase-enterprise.workspaces-deprecated.core
  []
  false)
