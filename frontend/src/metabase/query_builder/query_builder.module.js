...
QueryBuilderModule.config(['$routeProvider', function($routeProvider) {
    let QB = {
        template: '<div id="qb" />',
        controller: ['$scope', '$rootScope', '$location', '$route', '$routeParams', '$window', 'AppState',
            function($scope, $rootScope, $location, $route, $routeParams, $window, AppState) {
                ...
                let debouncedRenderAll = _.debounce(render, 400);
                ...
                $scope.$on("$destroy", function() {
                    ...
                    ReactDOM.unmountComponentAtNode(document.getElementById('qb'));
                });
