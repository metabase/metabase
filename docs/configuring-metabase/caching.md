...
If you select "Don't cache results" for a question, dashboard, or database, Metabase won't cache results; it'll always run the query against the database to refresh results.
