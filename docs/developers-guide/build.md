...
4. [Bun package manager for Node.js](https://bun.sh/) - latest release - you can install it in any OS by running:
...
```
sudo apt install openjdk-21-jdk nodejs && sudo npm install --global bun
```
