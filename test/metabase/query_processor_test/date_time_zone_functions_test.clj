...
(deftest convert-timezone-timestamp-without-time-zone-test
...
(deftest convert-timezone-timestamp-without-time-zone-test-2
  (mt/test-drivers (mt/normal-drivers-with-feature :convert-timezone)
    (mt/dataset times-mixed
      (testing "timestamp with out timezone columns"
        (mt/with-report-timezone-id! "UTC"
...
(deftest convert-timezone-timestamp-without-time-zone-test-3
  (mt/test-drivers (mt/normal-drivers-with-feature :convert-timezone)
    (mt/dataset times-mixed
      (testing "timestamp with out timezone columns"
...
(deftest convert-timezone-timestamp-with-time-zone-test
  (mt/test-drivers (mt/normal-drivers-with-feature :convert-timezone)
    (mt/dataset times-mixed
...
(deftest convert-timezone-timestamp-with-time-zone-test-2
  (mt/test-drivers (mt/normal-drivers-with-feature :convert-timezone)
    (mt/dataset times-mixed
      (testing "timestamp with time zone columns"
        (mt/with-report-timezone-id! "UTC"
...
(deftest convert-timezone-timestamp-with-time-zone-test-e
  (mt/test-drivers (mt/normal-drivers-with-feature :convert-timezone)
    (mt/dataset times-mixed
      (testing "timestamp with time zone columns"
        (when (driver/database-supports? driver/*driver* :set-timezone (mt/db))
...
(deftest convert-timezone-literal-datetime-test
  (mt/test-drivers (mt/normal-drivers-with-feature :convert-timezone)
    (mt/dataset times-mixed
    ...
    (mt/with-report-timezone-id! "UTC"
      (mt/dataset times-mixed
        (testing "convert-timezone nested with date-math, date-extract"
          (is (= ["2004-03-19T09:19:09" ; original
                  "2004-03-19T18:19:09" ; converted
                  "2004-03-19T20:19:09" ; date-added
                  20]                   ; hour
                 (->> (mt/run-mbql-query
                        times
    ...
    (mt/with-report-timezone-id! "UTC"
      (mt/dataset times-mixed
        (testing "extract hour should respect daylight savings times"
          (is (= [["2004-03-19T09:19:09" "2004-03-19T01:19:09" 1]  ; Before DST -- UTC-8
                  ["2008-06-20T10:20:10" "2008-06-20T03:20:10" 3]] ; During DST -- UTC-7
                 (->> (mt/run-mbql-query
                        times
    ...
    (mt/with-report-timezone-id! "UTC"
      (mt/dataset times-mixed
        (testing "convert-timezone twice should works"
          (is (= ["2004-03-19T09:19:09"  ; original column
                  "2004-03-19T16:19:09"  ; at +07
                  "2004-03-19T18:19:09"] ; at +09
                 (->> (mt/run-mbql-query
                        times
