...
// Generated by the SDK package build and gitignored, so it is not source.
const GENERATED_DIRECTORY = "cli-snippets-tmp";
    ...
    fs
      ...
      .filter(
        (entry) =>
          ...
          !entry.parentPath.includes(GENERATED_DIRECTORY),
      )
      .map((entry) =>
        path
