(ns metabase-enterprise.search.entity-retrieval.index-table
...
(def index-schema
  ...
  Its own, not semantic search's: [[metabase-enterprise.search.semantic.db.migration.impl]] wipes the
...
(def schema-version
  ...
  format. Bump on ANY compatibility-affecting change in [[metabase-enterprise.search.entity-retrieval.reconcile]]
...
(defn- ensure-embedding-space-column!
  ...
  transaction — [[metabase-enterprise.search.entity-retrieval.core/retrieval-status]] reports it as `:unreachable`
