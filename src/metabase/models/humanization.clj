...
(defsetting ^{:added "0.28.0"} humanization-strategy
  (str (deferred-tru "Certilytics can attempt to transform your table and field names into more sensible, human-readable versions, e.g. \"somehorriblename\" becomes \"Some Horrible Name\".")
       " "
