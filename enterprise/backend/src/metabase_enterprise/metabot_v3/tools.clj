(ns metabase-enterprise.metabot-v3.tools
  (:require
   ...
   [metabase-enterprise.metabot-v3.tools.visualization]
...
(comment
  metabase-enterprise.metabot-v3.tools.query/keep-me
  metabase-enterprise.metabot-v3.tools.visualization/keep-me
