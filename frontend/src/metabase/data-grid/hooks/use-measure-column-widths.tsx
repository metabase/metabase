 ...
 * @param truncateLongCellWidth Maximum width for any column
 * @param theme DataGrid theme settings
 * @param setMeasuredColumnSizing Function to update column sizing state
...
export const useMeasureColumnWidths = <TData, TValue>(
  ...
  const measureColumnWidths = useCallback(
    ...
    ): Promise<ColumnSizingState> => {
      return new Promise<ColumnSizingState>((resolve) => {
        ...
        const onMeasureHeaderRender = (div: HTMLDivElement) => {
          ...
          const elementsMeasures = Array.from(
            ...
            .map((element) => {
              ...
              // Skip measurement for columns with preserved sizing
          ...
          // Resolve with the calculated column sizing map instead of mutating the table here.
          resolve(columnSizingMap);
