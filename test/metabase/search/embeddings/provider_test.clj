(ns metabase.search.embeddings.provider-test
  (:require
   [clojure.test :refer :all]
   [metabase.search.embeddings.provider :as embedding.provider]))
      ...
      (let [resolved (embedding.provider/resolve-model requested)]
        ...
        (try
          ...
          (catch clojure.lang.ExceptionInfo e
            (is (= :metabase.search.embeddings.provider/embedding-space-changed (:type (ex-data e))))))))
