...
function filter_by_time(query){
	return [{target : query, source: RECOMMENDER_NAME, source_weight: RECOMMENDER_WEIGHT,  score: 1}]
}
...
function filter_by_linked_time(query){
	return [{target : query, source: RECOMMENDER_NAME, source_weight: LINKED_RECOMMENDER_WEIGHT,  score: 1}]
}
