...
1. If you are self-hosting Metabase, make sure your Metabase instance and any [community database drivers](/developers-guide/community-drivers) are up to date.
