...
class Overworld extends React.Component {
  MainBlock({ url, imgSrc, name, desc, unit, bg } = {}) {
    return (
      <Link to={url} style={{ width: "48%", height: "60%" }}>
        <Card
          width={"100%"}
          height={"100%"}
          bg={bg}
          ...
          noborder
        >
          <Flex flexDirection="column" justify="center" align="center" style={{ height: "100%"}}>
            <img src={imgSrc} width="80%" className="block ml-auto mr-auto" />
            {/* <Text fontSize={30} color="white">{name}</Text> */}
          </Flex>
          {/* <Box className="text-centered" color="white">
            <Box>
              <img src={imgSrc} width="80%" className="block ml-auto mr-auto" />
            </Box>
            <Flex justify="center" mb={3}>
              <Text fontSize={60} color="white">{desc}</Text>
              <Text fontSize={30} color="white" ml={1} mt={1}>{unit}</Text>
            </Flex>
            <Text fontSize={30} color="white">{name}</Text>
          </Box> */}
        </Card>
  ...
  render() {
    ...
    return (
      <Flex style={style} px={2} justify="center" align="center">
        <Card flat transparent width={"80%"} height="100%">
          <Flex justify="space-between" align="center" style={{ height: "100%" }}>
            <this.MainBlock
              bg="rgba(28, 71, 157, .7)"
              url="/question/new"
              imgSrc="app/assets/img/zhenzhu12.svg"
              name="珍珠加工厂"
            />
            <this.MainBlock
              bg="rgba(28, 71, 157, .7)"
              // url="/collection/root"
              url="/guitai"
              imgSrc="app/assets/img/zhenzhu22.svg"
              name="珍珠柜台"
            />
            {/* <this.MainBlock
              bg="rgba(28, 71, 157, .7)"
              url="/zhenzhulian"
              imgSrc="app/assets/img/zhenzhu32.svg"
              name="珍珠链"
            /> */}
          </Flex>
          {/* <Box> */}
