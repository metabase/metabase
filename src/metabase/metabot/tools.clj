(ns metabase.metabot.tools
  ...
  (:require
   ...
   [metabase.metabot.tools.api-call :as tools.api-call]
   ...
   [metabase.metabot.tools.megabot :as tools.megabot]
...
(def ^:private state-dependent-tools
  ...
  #{"analyze_chart"
    "create_chart" "edit_chart" "save_entity" "todo_write" "todo_read"
