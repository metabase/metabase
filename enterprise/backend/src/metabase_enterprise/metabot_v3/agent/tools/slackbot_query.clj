(ns metabase-enterprise.metabot-v3.agent.tools.slackbot-query
  ...
  (:require
   ...
   [metabase-enterprise.metabot-v3.agent.tools.construct :as construct]
...
(def ^:private slackbot-query-schema
  [:map {:closed true}
   ...
   [:display {:optional true} [:maybe [:enum "table" "bar" "line" "pie" "area" "row" "scatter" "funnel"]]]])
