...
import {
  getPadding,
  getTicksOptions,
} from "metabase/visualizations/echarts/cartesian/option/ticks";
import { getTimeSeriesIntervalDuration } from "metabase/visualizations/echarts/cartesian/utils/timeseries";
import {
