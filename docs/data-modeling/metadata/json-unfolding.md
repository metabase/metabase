...
redirect_from:
  - /docs/latest/data-modeling/json-unfolding
---
...
Metabase will prefix the unfolded column names with the name of the original column that contained the JSON. You can change the column names in **Admin** > [Table metadata](./metadata-editing.md), or by creating a [model](../models/models.md) and editing the column metadata.

## Databases that support JSON unfolding

- [BigQuery](../../databases/connections/bigquery.md): automatically enabled, applies to `STRUCT` types only.
...
- [MongoDB](../../databases/connections/mongodb.md): automatically enabled for all nested fields.
