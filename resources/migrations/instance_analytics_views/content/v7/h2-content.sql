...
select
    ...
    from collection
    where collection.worktree_id is null
union
select
   ...
   'database_' || database_id as question_database_id,
    ...
    where report_card.worktree_id is null
union
select
    ...
    where report_dashboard.worktree_id is null
union
select
    ...
    cast(null as timestamp) as event_timestamp
    from document
    where document.worktree_id is null
union
select
    ...
    where event.worktree_id is null
union
select
    ...
    cast(null as timestamp) as event_timestamp
    from transform
    where transform.worktree_id is null
union
select
    ...
    cast(null as timestamp) as event_timestamp
    from glossary
    where glossary.worktree_id is null
