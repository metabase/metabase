...
1. [Clojure (ttps://clojure.org)](https://clojure.org/guides/getting_started) - latest release
2. [Java Development Kit JDK (https://adoptopenjdk.net/releases.html)](https://adoptopenjdk.net/releases.html) - you need to install JDK 8 (to build) and JDK 11 (to run Metabase) - more about [Java versions](./operations-guide/java-versions.md)
...
On a most recent stable Ubuntu/Debian, all the tools mentioned above can be installed by using:

```
sudo apt install clojure gettext openjdk-11-jdk openjdk-8-jdk nodejs leiningen && sudo npm install --global yarn
```
