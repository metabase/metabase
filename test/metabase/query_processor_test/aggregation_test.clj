...
(deftest ^:parallel cumulate-sum-without-breakout-test
  (mt/test-drivers (mt/normal-drivers)
...
(deftest ^:parallel simple-cumulate-sum-with-same-breakout-test
  (mt/test-drivers (mt/normal-drivers)
...
(deftest ^:parallel cumulate-sum-with-different-breakout-test
  (mt/test-drivers (mt/normal-drivers)
...
(deftest ^:parallel cumulate-sum-with-different-breakout-that-requires-grouping-test
  (mt/test-drivers (mt/normal-drivers)
