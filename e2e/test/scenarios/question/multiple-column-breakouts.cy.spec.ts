    ...
    describe("summarize sidebar", () => {
      it("should allow to change buckets for multiple breakouts of the same column", () => {
        ...
        H.assertTableData({
          ...
          firstRows: [["Q2 2028", "April 24, 2028 – April 30, 2028", "1"]],
        });
    ...
    describe("timeseries chrome", () => {
      it("should use the first breakout for the chrome in case there are multiple for this column", () => {
        ...
        H.assertTableData({
          ...
          firstRows: [["Q2 2028", "April 2028", "1"]],
        });
        ...
        H.popover().within(() => {
          cy.findByLabelText("Date").clear().type("August 14, 2029");
        ...
        H.assertTableData({
          columns: ["Created At: Quarter", "Created At: Month", "Count"],
          firstRows: [["Q3 2029", "August 2029", "9"]],
        });
        ...
        H.assertTableData({
          columns: ["Created At: Quarter", "Created At: Month", "Count"],
          firstRows: [["Q3 2028", "August 2028", "1"]],
        });
      });
    });
