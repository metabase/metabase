...
(deftest ^{:parallel false} native-transform-updates-dependencies-test
...
(deftest ^{:parallel false} mbql-transform-updates-dependencies-test
...
(deftest ^{:parallel false} python-transform-updates-dependencies-test
...
(deftest ^{:parallel false} database-delete-marks-source-transforms-stale-test
...
(deftest ^{:parallel false} transform-run-updates-dependencies-test
...
(deftest ^{:parallel false} python-transform-update-handles-downstream-dependencies-test
...
(deftest ^{:parallel false} query-transform-update-handles-downstream-dependencies-test
...
(deftest ^{:parallel false} card-update-works-with-no-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} card-update-updates-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} card-update-triggers-native-cards-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} card-update-stops-on-transforms-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} transform-update-works-with-no-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} transform-update-updates-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} transform-update-triggers-native-transforms-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} transform-run-works-with-no-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} transform-run-marks-dependents-stale-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} segment-update-works-with-no-analyses-test
  (run-with-dependencies-setup!
   (fn [_]
...
(deftest ^{:parallel false} segment-update-updates-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} table-metadata-update-triggers-dependent-analysis-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} table-metadata-update-works-with-no-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} field-metadata-update-triggers-dependent-analysis-test
  (run-with-dependencies-setup!
   (fn [mp]
...
(deftest ^{:parallel false} field-metadata-update-works-with-no-analyses-test
  (run-with-dependencies-setup!
   (fn [mp]
