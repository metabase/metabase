...
The plugin `mapQuestionClickActions` lets you customize what happens when people click a data point on a dashboard or chart. `mapQuestionClickActions` can be used globally, or on component level.
