...
(def ^:private encrypted-settings-v58
  ...
  ["admin-email" "ai-service-base-url" "allowed-iframe-hosts"
   ...
   "ee-embedding-service-base-url" "email-smtp-host" "email-smtp-host-override"
   ...
   "google-auth-client-id" "gsheets" "jwt-attribute-email"
   "jwt-attribute-firstname" "jwt-attribute-groups" "jwt-attribute-lastname"
   "jwt-attribute-tenant" "jwt-attribute-tenant-attributes" "jwt-group-mappings"
   "jwt-identity-provider-uri" "jwt-shared-secret" "ldap-attribute-email"
   ...
   "llm-zai-api-base-url" "llm-zai-api-key" "map-tile-server-url"
   "mcp-apps-cors-custom-origins" "mcp-apps-cors-enabled-clients" "metabot-chat-system-prompt"
   "metabot-nlq-system-prompt" "metabot-slack-signing-secret" "metabot-sql-system-prompt"
   "metaplow-url" "mfa-challenge-signing-key" "migration-dump-file"
   "notification-link-base-url" "oidc-providers" "premium-embedding-token"
   "python-runner-api-token" "python-runner-url" "python-storage-s-3-access-key"
   "python-storage-s-3-container-endpoint" "python-storage-s-3-endpoint" "python-storage-s-3-secret-key"
