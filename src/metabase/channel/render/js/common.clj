...
(def custom-viz-bundle-resource-path
  ...
  (ECharts/visx), which that isolate never renders. Cuts the isolate's cold-parse time and heap pressure.
  Built alongside the full bundle by `bun run build-static-viz`."
