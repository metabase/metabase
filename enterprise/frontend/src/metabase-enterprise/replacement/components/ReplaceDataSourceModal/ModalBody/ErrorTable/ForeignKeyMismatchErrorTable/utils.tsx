...
export function getColumns(): TreeTableColumnDef<ForeignKeyMismatchErrorItem>[] {
  return [getFieldColumn(), getFieldTypeColumn()];
}

function getFieldColumn(): TreeTableColumnDef<ForeignKeyMismatchErrorItem> {
  return {
    id: "name",
    header: t`Field`,
    width: "auto",
...
function getFieldTypeColumn(): TreeTableColumnDef<ForeignKeyMismatchErrorItem> {
  return {
    id: "database_type",
    header: t`Field type`,
    width: "auto",
