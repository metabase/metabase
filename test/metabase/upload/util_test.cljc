...
(deftest unique-name-generator-test
  (let [max-len  4
        ...
        expected ["abcd" "ab_2" "abc" "abd" "ab_3" "ab_4" "ab_5" "dcba" "dc_2" "abe" "abf" "ab_6" "ab_7"]]

    (testing "MBQL's util is not usable"
      (let [mbql-generator (mbql.u/unique-name-generator :unique-alias-fn (#'upload.u/unique-alias-with-max-length max-len))]
