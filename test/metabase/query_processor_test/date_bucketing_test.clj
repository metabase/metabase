...
(expect-with-non-timeseries-dbs-except #{:bigquery :oracle :teradata} 4 (count-of-grouping (checkins:4-per-minute) :minute "current"))

(expect-with-non-timeseries-dbs-except #{:bigquery :oracle :teradata} 4 (count-of-grouping (checkins:4-per-minute) :minute -1 "minute"))
(expect-with-non-timeseries-dbs-except #{:bigquery :oracle :teradata} 4 (count-of-grouping (checkins:4-per-minute) :minute  1 "minute"))
