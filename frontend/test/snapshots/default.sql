...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_CBC6B7BA_DDCF_48A6_8C01_9326FDDB5639 START WITH 2 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_4E3274F5_EEB5_420C_9F20_A9B58C638B89 START WITH 7 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_D2A0873C_DEBB_41AC_A98F_DF66FC331642 START WITH 2 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_6EB00214_60EC_49ED_BE46_39C79644A21B START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_36A713A6_5798_4451_988E_31BCACABFBBA START WITH 3 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_64AD5966_4BB5_4CB9_B3D3_D3023E7DC0E2 START WITH 4 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8EAE3C40_6DCE_4C70_BAB3_EC0D9CFBDCAA START WITH 4 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_ED9AC8EC_A138_461E_B4CF_B39364A6B3F7 START WITH 3 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_2A134A98_12C6_47CB_8F45_61A43FE8C6F5 START WITH 5 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_2FF5F489_9897_4910_BEEC_A6F40505F7D1 START WITH 6 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_28DAF321_117D_4B38_9D91_88383E03BA5F START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_C0CA54F7_6A16_4C8D_B43B_E6F120CA0907 START WITH 2 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_756D6481_0B8C_43CF_976B_8187B16E79B7 START WITH 3 BELONGS_TO_TABLE;     
...
(1, TIMESTAMP '2019-12-27 09:32:43.738', TIMESTAMP '2019-12-27 09:32:44.056', 4, 4, 0, 0, 1, 1, '[]', '{}');             
...
('site-uuid', 'bbf4b717-f835-4e73-be97-f44b95eeb046'),
('enable-public-sharing', 'true'),
('settings-last-updated', '2019-12-27 09:32:31.376');      
...
(1, TIMESTAMP '2019-12-27 09:32:42.524', TIMESTAMP '2019-12-27 09:32:44.18', 'orders in a dashboard', NULL, 1, '[]', NULL, NULL, FALSE, NULL, NULL, FALSE, NULL, FALSE, NULL, NULL, NULL); 
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.QUERY;    
INSERT INTO PUBLIC.QUERY(QUERY_HASH, AVERAGE_EXECUTION_TIME, QUERY) VALUES
(X'7cd6adce1230dc90e50acf28bc603ee99320d968ebb4191c1ff632c4a8f7b3f1', 486, '{"database":1,"type":"query","query":{"source-table":2},"parameters":[],"async?":true,"middleware":{"add-default-userland-constraints?":true,"userland-query?":true},"constraints":{"max-results":10000,"max-results-bare-rows":2000}}');               
...
(1, 'bob@metabase.com', 'Bobby', 'Tables', '$2a$10$YYeGzigqPmeEXsnCwKmYpuXWPX5xmISS5ATGlSJu1/1Vw5sSq2uUu', '7e2bcd5d-5b4f-4523-8346-925c6dc2acc7', TIMESTAMP '2019-12-27 09:32:28.143', TIMESTAMP '2019-12-27 09:32:28.433', TRUE, TRUE, NULL, NULL, TRUE, FALSE, FALSE, NULL, TIMESTAMP '2019-12-27 09:32:28.433'),
(2, 'robert@metabase.com', 'Robert', 'Tableton', '$2a$10$ZSehCDDKvAYwcZYqcUevT.pwGb/bLI6ypcFaGCnyRlXSaUgIBTrRG', 'dde286b1-162b-4b8f-9e03-5abe4f86c7bd', TIMESTAMP '2019-12-27 09:32:48.223', TIMESTAMP '2019-12-27 09:32:52.526', FALSE, TRUE, NULL, NULL, TRUE, FALSE, FALSE, NULL, TIMESTAMP '2019-12-27 09:32:55.553');               
...
(2, 'user-joined', TIMESTAMP '2019-12-27 09:32:28.437', 1, 'user', 1, NULL, NULL, NULL, '{}'),
(3, 'card-create', TIMESTAMP '2019-12-27 09:32:38.508', 1, 'card', 1, 1, 2, NULL, '{"name":"Orders","description":null}'),
(4, 'dashboard-create', TIMESTAMP '2019-12-27 09:32:42.532', 1, 'dashboard', 1, NULL, NULL, NULL, '{"description":null,"name":"orders in a dashboard"}'),
(5, 'dashboard-add-cards', TIMESTAMP '2019-12-27 09:32:43.759', 1, 'dashboard', 1, NULL, NULL, NULL, '{"description":null,"name":"orders in a dashboard","dashcards":[{"name":"Orders","description":null,"id":1,"card_id":1}]}'),
(6, 'user-joined', TIMESTAMP '2019-12-27 09:32:52.525', 2, 'user', 2, NULL, NULL, NULL, '{}');        
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.QUERY_EXECUTION;          
...
(1, X'7cd6adce1230dc90e50acf28bc603ee99320d968ebb4191c1ff632c4a8f7b3f1', TIMESTAMP '2019-12-27 09:32:36.193', 469, 2000, FALSE, 'ad-hoc', NULL, 1, NULL, NULL, NULL, 1),
(2, X'7cd6adce1230dc90e50acf28bc603ee99320d968ebb4191c1ff632c4a8f7b3f1', TIMESTAMP '2019-12-27 09:32:43.868', 636, 2000, FALSE, 'question', NULL, 1, 1, NULL, NULL, 1); 
...
(1, 1, 'card', 1, TIMESTAMP '2019-12-27 09:32:38.477'),
(2, 1, 'dashboard', 1, TIMESTAMP '2019-12-27 09:32:42.808'),
(3, 1, 'dashboard', 1, TIMESTAMP '2019-12-27 09:32:44.294');  
...
('50153627-b124-43e6-8f99-4da8447cf862', 2, TIMESTAMP '2019-12-27 09:32:52.524');              
...
(1, 'Card', 1, 1, TIMESTAMP '2019-12-27 09:32:38.484', '{"description":null,"archived":false,"collection_position":null,"table_id":2,"database_id":1,"enable_embedding":false,"collection_id":null,"query_type":"query","name":"Orders","read_permissions":null,"creator_id":1,"made_public_by_id":null,"embedding_params":null,"cache_ttl":null,"dataset_query":{"database":1,"type":"query","query":{"source-table":2}},"id":1,"display":"table","visualization_settings":{"table.pivot_column":"QUANTITY","table.cell_column":"DISCOUNT"},"public_uuid":null}', FALSE, TRUE, NULL),
(2, 'Dashboard', 1, 1, TIMESTAMP '2019-12-27 09:32:42.546', '{"description":null,"name":"orders in a dashboard","cards":[]}', FALSE, TRUE, NULL),
(3, 'Dashboard', 1, 1, TIMESTAMP '2019-12-27 09:32:43.76', '{"description":null,"name":"orders in a dashboard","cards":[{"sizeX":2,"sizeY":2,"row":0,"col":0,"id":1,"card_id":1,"series":[]}]}', FALSE, FALSE, NULL),
(4, 'Dashboard', 1, 1, TIMESTAMP '2019-12-27 09:32:44.067', '{"description":null,"name":"orders in a dashboard","cards":[{"sizeX":4,"sizeY":4,"row":0,"col":0,"id":1,"card_id":1,"series":[]}]}', FALSE, FALSE, NULL),
(5, 'Dashboard', 1, 1, TIMESTAMP '2019-12-27 09:32:44.186', '{"description":null,"name":"orders in a dashboard","cards":[{"sizeX":4,"sizeY":4,"row":0,"col":0,"id":1,"card_id":1,"series":[]}]}', FALSE, FALSE, NULL);           
...
('MetabaseScheduler', 'par.attlocal.net1577467923092', 1577467968215, 7500);    
