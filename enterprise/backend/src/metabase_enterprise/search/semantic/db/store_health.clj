(ns metabase-enterprise.search.semantic.db.store-health
  ...
  Index health lives in [[metabase-enterprise.search.semantic.health]]."
  (:require
   [metabase-enterprise.search.semantic.db.datasource :as semantic.datasource]
