...
(deftest ^:parallel dirty?-pending-objects-test
...
(deftest ^:parallel dirty?-error-objects-test
...
(deftest ^:parallel dirty?-mixed-status-test
...
(deftest ^:parallel dirty-objects-returns-dirty-items-test
...
(deftest ^:parallel dirty-objects-multiple-model-types-test
...
(deftest ^:parallel dirty-objects-includes-collections-test
...
(deftest ^:parallel dirty-objects-filters-synced-items-test
...
(deftest ^:parallel dirty-objects-includes-snippets-test
...
(deftest ^:parallel dirty-objects-includes-documents-test
...
(deftest ^:parallel dirty-objects-all-model-types-test
...
(deftest ^:parallel dirty-objects-includes-tables-test
...
(deftest ^:parallel dirty-objects-includes-fields-test
...
(deftest ^:parallel dirty-objects-includes-segments-test
