...
import type { BaseQuestionProps } from "embedding-sdk/components/public/Question";
...
export const AdHocQuestion = ({
  ...
  Omit<BaseQuestionProps, "questionId"> &
