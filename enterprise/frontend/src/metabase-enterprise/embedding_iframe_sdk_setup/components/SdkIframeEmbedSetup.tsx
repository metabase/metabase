...
//     201,
//   );
//   const [contentScenario, setContentScenario] =
//     useState<ContentScenario>("self-made");
...
//                           : undefined,
//                       borderWidth:
//                         selectedDashboard === dashboard.id ? "2px" : undefined,
//                     }}
...
//                     : undefined,
//                 borderWidth:
//                   selectedDashboard === exampleDashboard.id ? "2px" : undefined,
//               }}
...
//                 <Icon name="dashboard" size={20} color={colors.brand} />
//                 <Stack gap="xs" style={{ flex: 1 }}>
//                   <Text fw="bold">{exampleDashboard.name}</Text>
//                   <Text size="sm" c="text-medium">
...
//               value={
//                 selectedDashboard
//                   ? { id: selectedDashboard, model: "dashboard" }
//                   : undefined
//               }
//               onChange={(item) => {
...
//               This API key is for demonstration purposes only. In production,
//               you should create a least privileged and sandboxed API key to
//               prevent unwanted access to your Metabase instance.
//             </Text>
//             <TextInput
//               value={exampleApiKey}
//               readOnly
...
//             <Text size="lg" fw="bold" mb="md">
//               {selectedDashboard
//                 ? [...recentDashboards, ...exampleXRayDashboards].find(
...
//           </Card>
//         ) : (
//           <Tooltip label="Design callout" position="top" withArrow>
//             <Box
//               style={{
//                 position: "fixed",
//                 bottom: "2rem",
