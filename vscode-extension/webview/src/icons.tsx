...
export function FocusIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
      <path d="M3.75 2.5A1.25 1.25 0 0 0 2.5 3.75v1.5a.75.75 0 0 1-1.5 0v-1.5A2.75 2.75 0 0 1 3.75 1h1.5a.75.75 0 0 1 0 1.5h-1.5zM10 1.75a.75.75 0 0 1 .75-.75h1.5A2.75 2.75 0 0 1 15 3.75v1.5a.75.75 0 0 1-1.5 0v-1.5a1.25 1.25 0 0 0-1.25-1.25h-1.5a.75.75 0 0 1-.75-.75zM1.75 10a.75.75 0 0 1 .75.75v1.5a1.25 1.25 0 0 0 1.25 1.25h1.5a.75.75 0 0 1 0 1.5h-1.5A2.75 2.75 0 0 1 1 12.25v-1.5a.75.75 0 0 1 .75-.75zm12.5 0a.75.75 0 0 1 .75.75v1.5A2.75 2.75 0 0 1 12.25 15h-1.5a.75.75 0 0 1 0-1.5h1.5a1.25 1.25 0 0 0 1.25-1.25v-1.5a.75.75 0 0 1 .75-.75zM8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5z" />
    </SvgIcon>
  )
}
...
export function FilterIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
      <path d="M2.75 4.5a.75.75 0 0 0 0 1.5h10.5a.75.75 0 0 0 0-1.5H2.75zM5 8a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5A.75.75 0 0 1 5 8zm2.25 2.75a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5h-1.5z" />
    </SvgIcon>
  )
}
