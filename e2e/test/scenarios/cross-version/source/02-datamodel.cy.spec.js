...
it("should configure data model settings", () => {
  ...
  cy.findByTestId("metadata-table-list").findByText("Orders").click();
  ...
  cy.findByTestId("metadata-table-list").findByText("Reviews").click();
  ...
  // Hide PRODUCTS.EAN
  cy.visit(sampleDBDataModelPage);
  cy.findByTestId("metadata-table-list").findByText("Products").click();
  ...
  cy.findByTestId("metadata-table-list").findByText("People").click();
