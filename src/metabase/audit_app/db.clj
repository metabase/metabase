...
(mu/defn collection-with-entity-id :- [:maybe (ms/InstanceOf :model/Collection)]
  "The Collection with `entity-id`, or nil."
  [entity-id :- :string]
  (t2/select-one :model/Collection :entity_id entity-id))

(mu/defn dashboard-with-entity-id :- [:maybe (ms/InstanceOf :model/Dashboard)]
  "The Dashboard with `entity-id`, or nil."
  [entity-id :- :string]
  (t2/select-one :model/Dashboard :entity_id entity-id))

(mu/defn card-name-and-description :- [:maybe (ms/InstanceOf :model/Card)]
