...
import { type QuestionContextType, useQuestionContext } from "../../context";

/**
 * @expand
 * @category Question
 */
export type QuestionQuestionSettingsProps = StackProps;
...
const QuestionSettingsContent = ({
  ...
  question: Question;
  queryResults?: any[];
  updateQuestion: QuestionContextType["updateQuestion"];
}) => {
...
export const QuestionSettings = ({
  ...stackProps
}: QuestionQuestionSettingsProps) => {
  const { question, queryResults, updateQuestion } = useQuestionContext();
