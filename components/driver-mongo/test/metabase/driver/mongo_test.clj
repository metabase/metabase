...
(defn- missing-fields-db []
  (create-database-from-row-maps!
   "test-missing-fields"
   "coll"
   (json-from-file "components/driver-mongo/test/metabase/driver/missing-fields.json")))
...
(defn- array-fields-db []
  (create-database-from-row-maps!
   "test-16299"
   "coll"
   (json-from-file "components/driver-mongo/test/metabase/driver/array-fields.json")))
