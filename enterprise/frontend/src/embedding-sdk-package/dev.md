...
```
bun run add file:../metabase/resources/embedding-sdk
```
...
- install the sdk with `bun run add file:../metabase/resources/embedding-sdk` / `npm install --install-links ../metabase/resources/embedding-sdk`
- clean the cache of your bundler

An example for vite: `rm -rf node_modules/@metabase && rm -rf node_modules/.vite && bun run add file:../metabase/resources/embedding-sdk`
