 ...
 * `query_builder/actions`. The store imports the reducer on every page, and that
 * one import used to pull the whole query builder, its selectors and their
 * visualization dependencies into the initial bundle.
 */
