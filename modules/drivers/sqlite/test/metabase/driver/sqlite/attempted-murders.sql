2023-01-21 01:09:10,246 INFO data.sql :: No test data type mapping for driver :sqlite for base type :type/DateTimeWithLocalTZ, falling back to ancestor base type :type/DateTime
2023-01-21 01:09:10,246 INFO data.sql :: No test data type mapping for driver :sqlite for base type :type/DateTimeWithZoneOffset, falling back to ancestor base type :type/DateTime
2023-01-21 01:09:10,246 INFO data.sql :: No test data type mapping for driver :sqlite for base type :type/DateTimeWithZoneID, falling back to ancestor base type :type/DateTime
2023-01-21 01:09:10,246 INFO data.sql :: No test data type mapping for driver :sqlite for base type :type/TimeWithLocalTZ, falling back to ancestor base type :type/Time
2023-01-21 01:09:10,246 INFO data.sql :: No test data type mapping for driver :sqlite for base type :type/TimeWithZoneOffset, falling back to ancestor base type :type/Time
...
CREATE TABLE "attempts" (
  ...
  "date" DATE,
  "datetime" DATETIME,
  "datetime_ltz" DATETIME,
  "datetime_tz" DATETIME,
  "datetime_tz_id" DATETIME,
  "time" TIME,
  "time_ltz" TIME,
  "time_tz" TIME,
  "num_crows" INTEGER,
