...
DROP TABLE IF EXISTS "test-data"."default"."attempted_murders_attempts"

CREATE TABLE "test-data"."default"."attempted_murders_attempts" AS
SELECT
  *
FROM
  (
...
-- 20 rows
INSERT INTO "test-data"."default"."attempted_murders_attempts" ("date", "datetime", "datetime_ltz", "datetime_tz", "datetime_tz_id", "time", "time_ltz", "time_tz", "num_crows")
VALUES
(
  date '2019-11-01',
