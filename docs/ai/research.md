...
Without a connected provider, you can still use Research to build a data set manually, but Metabase won't use AI to rank the charts.
...
5. To refine your plan, send another prompt. To edit the plan yourself, use **+ Data** to add metrics and dimensions, or **+ Events** to add timelines.
6. Click **Start research**. Metabase generates the charts in the background, so you can browse the ones that are ready while the rest generate.

<!-- TODO: add AI ranking toggle + token cost note once UXW-4878 lands -->

### Build the plan yourself

1. Click **Manual setup**.
2. Click **+ Data** to add metrics and dimensions.
3. Click **+ Events** to add timelines.
4. Click **Start research**.

## Explore the results

In the sidebar, use the **All**, **Star**, and **Discussions** tabs to view all charts, starred charts, and charts with comments.
...
- After you create a Research, you can't add metrics, dimensions, or timelines to it.
