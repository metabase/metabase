...
DROP TABLE IF EXISTS "test_data"."default"."diff_time_zones_cases_times";

CREATE TABLE "test_data"."default"."diff_time_zones_cases_times" (
  "id" INTEGER,
...
-- 35 rows
INSERT INTO "test_data"."default"."diff_time_zones_cases_times" ("id", "a_dt_tz", "b_dt_tz", "a_dt_tz_text", "b_dt_tz_text")
VALUES
