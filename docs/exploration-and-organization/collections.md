...
Uploads will only be available if your admin has enabled uploads for your Metabase, and you're in a group with unrestricted access to the database used to store those uploads. See [Uploading data](../databases/uploads.md).
