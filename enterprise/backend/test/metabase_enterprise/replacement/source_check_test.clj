...
(deftest ^:synchronized same-source-returns-failure-test
...
(deftest ^:synchronized database-mismatch-table-test
...
(deftest ^:synchronized database-mismatch-card-test
...
(deftest ^:synchronized implicit-joins-with-incoming-fks-test
...
(deftest ^:synchronized no-implicit-joins-without-incoming-fks-test
...
(deftest ^:synchronized no-implicit-joins-for-card-source-test
...
(deftest ^:synchronized no-implicit-joins-for-empty-table-test
...
(deftest ^:synchronized successful-replacement-test
...
(deftest ^:synchronized missing-column-in-target-test
...
(deftest ^:synchronized column-type-mismatch-test
...
(deftest ^:synchronized extra-column-in-target-test
...
(deftest ^:synchronized database-mismatch-with-implicit-joins-test
...
(deftest ^:synchronized format-column-structure-test
...
(deftest ^:synchronized card-same-database-test
