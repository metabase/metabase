(ns metabase-enterprise.search.semantic.gate
...
(comment
  ...
  (def index-metadata ((requiring-resolve 'metabase-enterprise.search.semantic.env/get-index-metadata)))
  ...
  (def active-index-state
    ((requiring-resolve 'metabase-enterprise.search.semantic.index-metadata/get-active-index-state)
     pgvector
     index-metadata))
