...
(expect
  ...
  (with-store-contents
    (resolve-source-table (data/mbql-query venues))))
...
;; Does `resolve-source-table` resolve source tables in nested source queries?
(expect
  {:database "test-data", :tables #{"VENUES"}, :fields #{}}
  (with-store-contents
    (resolve-source-table
...
;; Does `resolve-source-table` resolve source tables in joins?
(expect
...
;; Does `resolve-source-table` resolve source tables in joins inside nested source queries?
(expect
  {:database "test-data", :tables #{"CATEGORIES" "VENUES"}, :fields #{}}
  (with-store-contents
    (resolve-source-table
...
;; Does `resolve-source-table` resolve source tables inside nested source queries inside joins?
(expect
  {:database "test-data", :tables #{"CATEGORIES" "VENUES"}, :fields #{}}
  (with-store-contents
    (resolve-source-table
...
;; Does `resolve-source-table` resolve source tables inside nested source queries inside joins inside nested source
;; queries?
(expect
  {:database "test-data", :tables #{"CATEGORIES" "VENUES"}, :fields #{}}
  (with-store-contents
