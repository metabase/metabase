...
type AlertEducationalScreenProps = {
  onProceed: () => void;
};

export const AlertEducationalScreen = ({
  onProceed,
}: AlertEducationalScreenProps) => {
  return (
    <div className={cx(CS.pt2, CS.pb4, CS.mlAuto, CS.mrAuto, CS.textCentered)}>
