(ns metabase-enterprise.workspaces-deprecated.remapping.core
  ...
  (:require
   [metabase-enterprise.workspaces-deprecated.models.table-remapping]
   [metabase.app-db.core :as app-db]
   [toucan2.core :as t2]))

(comment metabase-enterprise.workspaces-deprecated.models.table-remapping/keep-me)
...
(defprotocol RemappingStore
  "Protocol for accessing workspace table remappings.
   ...
   [[metabase-enterprise.workspaces-deprecated.table-remapping]] do this normalization.
