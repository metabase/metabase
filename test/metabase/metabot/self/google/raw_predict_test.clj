...
;;; ──────────────────────────────────────────────────────────────────
;;; count-tokens-body tests
;;; ──────────────────────────────────────────────────────────────────

(deftest ^:parallel count-tokens-body-test
  (testing "the count-tokens probe is a minimal Messages request naming the model in the body — that endpoint
            is not model-scoped in its URL, so the platform's `@` spelling is sent through untouched"
    (is (= {:anthropic_version @#'raw-predict/anthropic-version
            :model             "claude-haiku-4-5@20251001"
            :messages          [{:role "user" :content "hi"}]}
           (raw-predict/count-tokens-body "claude-haiku-4-5@20251001")))))
