...
(mr/def ::data-app.update
  ...
  [:map {:closed true}
   ...
   [:allowed_hosts   {:optional true} [:maybe [:or :string :map sequential?]]]
   ...
   [:sync_error      {:optional true} [:maybe [:or :string :map sequential?]]]
