...
describe("scenarios > question > native", () => {
  ...
  it("lets you create and run a SQL question", () => {
    H.openNativeEditor().type("select count(*) from orders");
    runQuery();
  ...
  it("should suggest the currently viewed collection when saving question", () => {
    ...
    H.openNativeEditor({ fromCurrentPage: true }).type(
  ...
  it("displays an error", () => {
    H.openNativeEditor().type("select * from not_a_table");
    runQuery();
    // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
  ...
  it("can save a question with no rows", () => {
    H.openNativeEditor().type("select * from people where false");
    runQuery();
    // eslint-disable-next-line no-unscoped-text-selectors -- deprecated usage
  ...
  it("should be able to add new columns after hiding some (metabase#15393)", () => {
    H.openNativeEditor().type("select 1 as visible, 2 as hidden");
