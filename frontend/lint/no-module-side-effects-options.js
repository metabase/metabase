...
const NO_MODULE_SIDE_EFFECTS_IGNORES = [
  ...
  "**/__support__/**",
  "**/*.d.ts",
  // Generated by the SDK CLI snippet type-check. The registry generator walks
  // the source roots with readdir, which does not read .gitignore, so these
  // appear whenever that job has run.
  "**/cli-snippets-tmp/**",
];
