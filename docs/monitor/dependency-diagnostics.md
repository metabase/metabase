...
redirect_from:
  ...
  - /docs/latest/data-studio/dependencies/diagnostics
---
...
Dependency diagnostics shows you content with broken dependencies, and content that nothing else references.

To open Dependency diagnostics:

1. Open [Monitor](./start.md).
2. In the left sidebar, click **Dependency diagnostics**.
...
- Quick links to open items or view them in the [dependency graph](../semantic-layer/dependencies/graph.md)
...
- Links to open the item or view it in the [dependency graph](../semantic-layer/dependencies/graph.md)
