...
The locale codes are relevant for setting the language in [guest embeds](../embedding/static-embedding-parameters.md#setting-the-language-for-a-static-embed).
