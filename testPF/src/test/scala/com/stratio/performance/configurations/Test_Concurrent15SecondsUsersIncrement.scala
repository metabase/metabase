...
trait Test_Concurrent15SecondsUsersIncrement extends Common {

  override val incrementUsers: Int = 0
  override val usersRampUpTime: FiniteDuration = 15 seconds
  override val usersSeparatedByTime: FiniteDuration = 1 seconds
