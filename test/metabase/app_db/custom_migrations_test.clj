...
(deftest backfill-legacy-library-root-collection-entity-ids-test
  (testing "v62.2026-05-13T12:00:00 : backfill canonical entity IDs for legacy Library root collections"
    (impl/test-migrations ["v62.2026-05-13T12:00:00"] [migrate!]
...
(deftest backfill-legacy-library-root-collection-entity-ids-skips-ambiguous-roots-test
  (testing "v62.2026-05-13T12:00:00 : ambiguous legacy Library roots are not modified"
    (impl/test-migrations ["v62.2026-05-13T12:00:00"] [migrate!]
      (let [library-id       (insert-legacy-library-collection! {:name "Library"
                                                                 :slug "library"
                                                                 :type "library"
