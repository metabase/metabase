(ns ^:mb/driver-tests metabase-enterprise.workspaces-deprecated.e2e-test
                        ...
                        (finally
                          ...
                          (let [deleted? (try (ws/delete-workspace! ws-id)
                                              ...
                                              (catch Throwable t
                                                ...
                                                false))]
                            (when-not deleted?
                              (t2/delete! :model/WorkspaceDatabaseDeprecated :workspace_id ws-id)
                              (t2/delete! :model/WorkspaceDeprecated :id ws-id)))))))
                  (finally
