...
(deftest ^:parallel dont-return-too-many-rows-test
  (testing "Make sure pivot queries don't return too many rows (#14329)"
    (let [results (qp.pivot/run-pivot-query (test-query))
      ...
      (is (= [["Doohickey" "Facebook" "2019-01-01" 0  263]
              ["Doohickey" "Facebook" "2020-01-01" 0  89]
              ["Doohickey" "Google"   "2019-01-01" 0  276]
              ["Doohickey" "Google"   "2020-01-01" 0  100]
              ["Gizmo"     "Facebook" "2019-01-01" 0  361]
              ["Gizmo"     "Facebook" "2020-01-01" 0  113]
              ["Gizmo"     "Google"   "2019-01-01" 0  325]
      ...
      (let  [query (mt/mbql-query reviews
        ...
        (mt/with-native-query-testing-context query
          (is (= [[1 "2020-01-01" 0 5]
                  ...
                  [5 "2019-01-01" 0 137]
                  [4 "2019-01-01" 0 236]
                  [nil "2020-01-01" 1 155]
                  [nil "2019-01-01" 1 452]
                  [1 nil 2 20]
                  [3 nil 2 43]
                  [2 nil 2 48]
                  [5 nil 2 182]
