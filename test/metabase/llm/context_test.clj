...
(deftest ^:synchronized build-schema-context-test
...
(deftest ^:synchronized build-schema-context-with-fk-test
  (mt/with-test-user :crowberto
    (mt/with-temp [:model/Database db     {}
...
(deftest ^:synchronized build-schema-context-with-field-values-test
  (mt/with-test-user :crowberto
    (mt/with-temp [:model/Database   db    {}
...
(deftest ^:synchronized build-schema-context-with-table-description-test
  (mt/with-test-user :crowberto
    (mt/with-temp [:model/Database db    {}
