    ...
    describe("Field name and description", () => {
      ...
      it("should allow changing the field description", () => {
        ...
        TableSection.getFieldDescriptionInput("Total")
          ...
          .blur();
        cy.wait("@updateField");
        H.undoToast().should("contain.text", "Description of Total updated");
  ...
  describe("Field section", () => {
    ...
    describe("Metadata", () => {
      describe("Semantic type", () => {
        ...
        it("should allow to change the type to 'Currency' and choose the currency", () => {
          ...
          cy.wait("@updateField");
          H.undoToast().should("contain.text", "Semantic type of Tax updated");
          H.undoToast().icon("close").click();
    ...
    describe("Behavior", () => {
      describe("Visibility", () => {
        it("should let you change field visibility to 'Everywhere'", () => {
          ...
          cy.wait("@updateField");
          H.undoToast().should("contain.text", "Visibility of Tax updated");
      ...
      describe("Filtering", () => {
        it("should let you change filtering to 'Search box'", () => {
          ...
          cy.wait("@updateField");
          H.undoToast().should("contain.text", "Filtering of Quantity updated");
      ...
      describe("Display values", () => {
        ...
        it("should allow 'Custom mapping' option only for 'Search box' filtering type (metabase#16322)", () => {
          ...
          H.popover().findByText("Search box").click();
          cy.wait("@updateField");
          H.undoToast().should("contain.text", "Filtering of Rating updated");
          H.undoToast().icon("close").click();
    ...
    describe("Formatting", () => {
      it("should let you to change field formatting", () => {
        ...
        cy.wait("@updateField");
        H.undoToast().should("contain.text", "Formatting of Quantity updated");
