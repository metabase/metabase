export const autoYSplit = [
  {
    ...
    data: {
      ...
      native_form: {
        query:
          'SELECT DATE_TRUNC(\'month\', "PUBLIC"."ORDERS"."CREATED_AT") AS "CREATED_AT", COUNT(*) AS "count", AVG("PUBLIC"."ORDERS"."DISCOUNT") AS "avg", SUM("PUBLIC"."ORDERS"."TAX") AS "sum", count(distinct "PUBLIC"."ORDERS"."PRODUCT_ID") AS "count_2", AVG("PUBLIC"."ORDERS"."SUBTOTAL") AS "avg_2" FROM "PUBLIC"."ORDERS" GROUP BY DATE_TRUNC(\'month\', "PUBLIC"."ORDERS"."CREATED_AT") ORDER BY DATE_TRUNC(\'month\', "PUBLIC"."ORDERS"."CREATED_AT") ASC',
        params: null,
      },
      "viz-settings": {
        "graph.dimensions": ["CREATED_AT"],
