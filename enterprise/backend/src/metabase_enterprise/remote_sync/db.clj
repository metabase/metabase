...
(def ^:private RemovalOpts
  "The `:scope-key`, `:synced-collection-ids`, `:entity-ids`, `:removal-conditions`, `:worktree-scoped?`, and
  `:worktree-id` describing which rows an import removes (see [[removal-exprs]])."
  [:map {:closed true}
