...
Metabase's automatic [drill-through](/docs/questions/visualizations/drill-through.md) won't work on public dashboards because public links don't give people access to your raw data.
