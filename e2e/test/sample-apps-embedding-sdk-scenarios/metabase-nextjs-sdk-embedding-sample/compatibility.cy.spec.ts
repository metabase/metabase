...
describe("Embedding SDK: metabase-nextjs-sdk-embedding-sample compatibility", () => {
  ...
  describe("Pages router", () => {
    it("should open an Interactive Question", () => {
      H.createQuestion(QUESTION).then(({ body: { id } }) => {
        ...
        cy.visit({
          url: "http://localhost:4301/interactive-question",
        });
      });
  ...
  describe("App router", () => {
    it("should open an Interactive Question", () => {
      H.createQuestion(QUESTION).then(({ body: { id } }) => {
        ...
        cy.visit({
          url: "http://localhost:4302/interactive-question",
        });
      });
