...
;; master also has `overlay-details-are-validated-the-way-they-are-resolved-test` here; this branch predates the
;; `:write_data_details`/`:admin_details` overlay columns, so there is nothing to exercise.
