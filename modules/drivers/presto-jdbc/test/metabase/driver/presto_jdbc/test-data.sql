...
DROP TABLE IF EXISTS "test_data"."default"."test_data_users";

CREATE TABLE "test_data"."default"."test_data_users" (
  "id" INTEGER,
  "name" VARCHAR,
...
DROP TABLE IF EXISTS "test_data"."default"."test_data_categories";

CREATE TABLE "test_data"."default"."test_data_categories" ("id" INTEGER, "name" VARCHAR);

DROP TABLE IF EXISTS "test_data"."default"."test_data_venues";

CREATE TABLE "test_data"."default"."test_data_venues" (
  "id" INTEGER,
  "name" VARCHAR,
  "category_id" INTEGER,
  "latitude" DOUBLE,
...
DROP TABLE IF EXISTS "test_data"."default"."test_data_checkins";

CREATE TABLE "test_data"."default"."test_data_checkins" (
  "id" INTEGER,
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER
...
-- 15 rows
INSERT INTO "test_data"."default"."test_data_users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "test_data"."default"."test_data_categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "test_data"."default"."test_data_venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "test_data"."default"."test_data_checkins" ("date", "user_id", "venue_id")
VALUES
