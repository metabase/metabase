...
(deftest ^{:parallel false} entity-retrieval-available?-requires-a-populated-index-test
...
(deftest ^{:parallel false} ranks-by-similarity-test
...
(deftest ^{:parallel false} crud-api-to-tool-end-to-end-test
...
(deftest ^{:parallel false} doc-type-boost-breaks-ties-test
...
(deftest ^{:parallel false} search-degrades-on-dimension-mismatch-test
