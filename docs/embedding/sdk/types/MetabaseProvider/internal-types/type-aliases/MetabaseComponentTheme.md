...
| <a id="collectionbrowser"></a> `collectionBrowser` | \{ `breadcrumbs`: \{ `expandButton`: \{ `backgroundColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `hoverBackgroundColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `hoverTextColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `textColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); \}; \}; `emptyContent`: \{ `icon`: \{ `height`: `CSSProperties`\[`"width"`\]; `width`: `CSSProperties`\[`"width"`\]; \}; `subtitle`: \{ `fontSize`: `CSSProperties`\[`"fontSize"`\]; \}; `title`: \{ `fontSize`: `CSSProperties`\[`"fontSize"`\]; \}; \}; \} | - |
| `collectionBrowser.breadcrumbs` | \{ `expandButton`: \{ `backgroundColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `hoverBackgroundColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `hoverTextColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `textColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); \}; \} | - |
| `collectionBrowser.breadcrumbs.expandButton` | \{ `backgroundColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `hoverBackgroundColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `hoverTextColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); `textColor`: [`ColorCssVariableOrString`](ColorCssVariableOrString.md); \} | - |
| `collectionBrowser.breadcrumbs.expandButton.backgroundColor` | [`ColorCssVariableOrString`](ColorCssVariableOrString.md) | - |
| `collectionBrowser.breadcrumbs.expandButton.hoverBackgroundColor` | [`ColorCssVariableOrString`](ColorCssVariableOrString.md) | - |
| `collectionBrowser.breadcrumbs.expandButton.hoverTextColor` | [`ColorCssVariableOrString`](ColorCssVariableOrString.md) | - |
| `collectionBrowser.breadcrumbs.expandButton.textColor` | [`ColorCssVariableOrString`](ColorCssVariableOrString.md) | - |
