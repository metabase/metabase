...
import Styles from "metabase/components/EntityIdCard/EntityIdCard.module.css";
          ...
          <Stack spacing="xs">
            ...
            <Flex gap="md" align="center">
              ...
              <Flex gap="sm" wrap="nowrap">
                {tabEntityId}
                <CopyButton className={Styles.CopyButton} value={tabEntityId} />
              </Flex>
            </Flex>
          </Stack>
        </>
