...
(defn ^:export process-pivot-table
  ...
  (let [data         (js->clj data :keywordize-keys true)
        ...
        format-rows? true]
    (clj->js (pivot/process-pivot-table data row-indexes col-indexes val-indexes cols top-formatters left-formatters  format-rows? settings col-settings make-color-getter))))
