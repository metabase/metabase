...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."ta_self_referencing_user_users" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."ta_self_referencing_user_users" (
...
ALTER TABLE
  "CAM_24"."ta_self_referencing_user_users"
ADD
  CONSTRAINT "ers_created_by_users_406217275" FOREIGN KEY ("created_by") REFERENCES "CAM_24"."ta_self_referencing_user_users" ("id");

-- 15 rows
INSERT INTO "CAM_24"."ta_self_referencing_user_users" ("name", "last_login", "password", "created_by")
VALUES
