...
If Metabase doesn't detect a primary key, it will create an ID column for you, including the column as the first (left-most) column of the uploaded CSV table.
