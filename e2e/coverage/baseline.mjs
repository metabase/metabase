/**
 * Baseline subtraction shared by the manifest builder
 * (build-coverage-manifest.mjs) and the offline analysis pipeline
 * (analyze-spec.mjs).
 *
...
// than it did in the baseline (boot-only) run. A function that fired the same
