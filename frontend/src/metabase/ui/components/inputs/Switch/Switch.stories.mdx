...
In most situations you should use the `sm` size variant, with the label on the left and the toggle on the right. (This allowes users to read what the setting or option is first.)
