...
export const UNABLE_TO_CHANGE_ADMIN_PERMISSIONS = t`Administrators always have the highest level of access to everything in Omniloy.`;
...
export const getLimitedPermissionAvailabilityMessage = () =>
  t`Only available in certain Omniloy plans.`;
