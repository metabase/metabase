(ns metabase.metabot.agent.tools.slackbot-query-test
  ...
  (:require
   ...
   [metabase.metabot.agent.tools.slackbot-query]))
...
(deftest display-field-has-description-test
  (testing "display field in slackbot-query-schema has a description in JSON Schema"
    (let [schema  @#'metabase.metabot.agent.tools.slackbot-query/slackbot-query-schema
