...
describe("model reproductions", () => {
  ...
  // needs own restore because it modifies a shared card
  ...
  // needs own restore because it modifies field settings
  ...
  // needs own restore because it modifies field dimensions/values
  ...
  // needs own restore because it modifies user locale
  ...
  // needs own restore because it enables actions for DB
