...
export const sampleData = {
  list: [
    ...
    { value: 3, label: "Foreign key" },
    { value: 4, label: "Category" },
    { value: 5, label: "Description" },
  ],
  groups: [
    { value: 1, label: "Entity key", group: "Overall row" },
    { value: 2, label: "Entity name", group: "Overall row" },
    { value: 3, label: "Foreign key", group: "Overall row" },
    { value: 4, label: "Category", group: "Common" },
    { value: 5, label: "Description", group: "Common" },
  ],
};
