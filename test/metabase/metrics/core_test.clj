...
(deftest metric-sync-dimensions-persists-schema-upgraded-dimensions-test
  (testing "sync-dimensions! persists dimensions generated by the legacy metric schema upgrade (UXW-4808)"
