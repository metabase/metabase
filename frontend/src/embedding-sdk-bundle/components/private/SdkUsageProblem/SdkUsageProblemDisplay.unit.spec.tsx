...
describe("SdkUsageProblemDisplay", () => {
  ...
  it("shows the SDK disabled error over the React 18 warning on localhost", async () => {
    expect(window.location.origin).toBe("http://localhost");
  ...
  it("shows the API key error instead of the React 18 warning outside localhost", async () => {
