...
class Perf200UsersMax5Minutes10UsersIncrementHighActivityCrossdata extends Simulation with Common with Test_200Users
    with Test_100MinutesDuration with Test_Concurrent15Seconds5MinutesUsersIncrement
    with Test_HighLoad with Test_CrossdataQuery {

  val executionName: String = "Launch Crossdata QUERY (200 users - 10 users every 5 minutes - 100 minutes - high activity)"
