...
describe("scenarios > visualizations > drillthroughs > chart drill", () => {
  ...
  it("should allow brush date filter", () => {
    ...
    H.queryBuilderMain().within(() => {
      ...
      H.echartsContainer().findByText("January 2029").should("exist");
    });
    ...
    H.queryBuilderMain().within(() => {
      H.echartsContainer().findByText("June 5, 2028"); // more granular axis labels
    ...
    it(`brush filter should work post-aggregation for ${granularity} granularity (metabase#18011)`, () => {
      ...
      if (granularity === "month") {
        cy.findByTestId("qb-filters-panel")
          .findByText(
            "Created At: Month is Sep 1, 2028, 12:00 AM – Feb 1, 2029, 12:00 AM",
          )
          .should("exist");
      }
  ...
  it("should drill through a with date filter (metabase#12496)", () => {
    ...
    H.echartsContainer().contains("January 2031");
