...
(defn- jetty-config []
  (cond-> (m/filter-vals
           ...
           {:port                 (config/config-int :mb-jetty-port)
            ...
            :request-header-size  (config/config-int :mb-jetty-max-request-header-size-bytes)
            :response-header-size (config/config-int :mb-jetty-max-response-header-size-bytes)
