...
const VisualizationWithRef = forwardRef((props, ref) => (
  <VisualizationMemoized {...props} forwardedRef={ref}></VisualizationMemoized>
));

VisualizationWithRef.displayName = "Visualization";
