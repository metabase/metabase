...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetabaseApi.ApiCachePutRequest();
  });
  ...
  describe('ApiCachePutRequest', function() {
    it('should create an instance of ApiCachePutRequest', function() {
      // uncomment below and update the code to test ApiCachePutRequest
      //var instance = new MetabaseApi.ApiCachePutRequest();
      //expect(instance).to.be.a(MetabaseApi.ApiCachePutRequest);
    });
