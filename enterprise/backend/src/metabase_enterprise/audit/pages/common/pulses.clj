(ns metabase-enterprise.audit.pages.common.pulses
  "Shared code for [[metabase-enterprise.audit.pages.dashboard-subscriptions]]
  and [[metabase-enterprise.audit.pages.alerts]]."
...
(def table-metadata
  "Common Metadata for the columns returned by both the [[metabase-enterprise.audit.pages.dashboard-subscriptions]]
  and [[metabase-enterprise.audit.pages.alerts]] audit queries. (These respective queries also return their own
  additional columns.)"
...
(def table-query-columns
  ...
  the [[metabase-enterprise.audit.pages.dashboard-subscriptions]] and [[metabase-enterprise.audit.pages.alerts]] audit
  queries."
  [:pulse_id
   :num_user_recipients
   :channel_id
...
(def table-query
  "Common HoneySQL base query for both the [[metabase-enterprise.audit.pages.dashboard-subscriptions]]
  and [[metabase-enterprise.audit.pages.alerts]] audit queries. (The respective implementations tweak this query and
