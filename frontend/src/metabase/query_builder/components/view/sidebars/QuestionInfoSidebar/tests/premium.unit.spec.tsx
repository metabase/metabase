...
describe("QuestionInfoSidebar > premium", () => {
  ...
  describe("tabs", () => {
    describe("for non-admins", () => {
      it("should show tabs for Overview, Relationships, and History and no Insights link", async () => {
        setupEnterprise({});
    ...
    describe("for admins", () => {
      it("should show tabs for Overview, Relationships, and History, and a link for Insights", async () => {
