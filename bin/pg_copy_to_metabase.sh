...
## 注意：uuuo-metabase は２基データベースを持つ。解析側（HEROKU_POSTGRESQL_COLOR_URL）を指定すること。
##

METABASE_COLOR_URL=HEROKU_POSTGRESQL_COLOR_URL

echo -e "\n`date -R`"
echo -e "<<<<<  Copying DB from the Production to the uuuo-etabase. >>>>>"
