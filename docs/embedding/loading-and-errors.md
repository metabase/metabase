...
While an embedded component is loading, or when it fails, the [modular embedding SDK](./sdk/introduction.md) renders its own loading and error screens. You can swap in your own React components instead, so both states match the rest of your app.
...
{% include_file "{{ dirname }}/sdk/api/snippets/SdkErrorComponentProps.md" snippet="properties" %}

## Further reading

- [Appearance](./appearance.md)
- [Modular embedding SDK config](./sdk/config.md)
