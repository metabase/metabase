      ...
      <Accordion.Item value="customization">
        ...
        <Accordion.Panel>
          <Stack spacing="1rem" py="1rem">
            ...
            />
            <Text>{t`Only available in certain Metabase plans.`}</Text>
          </Stack>
        </Accordion.Panel>
      </Accordion.Item>
        ...
        <Accordion.Panel>
          <Stack spacing="1rem" py="1rem">
            ...
            <Text>
              ...
              )} Allows the group to download results, and sets the maximum number of rows they can export. Only available in certain Metabase plans. Manage Data Model: The group can edit table metadata in the Admin panel.`}
            </Text>
            <Text>
              {jt`${(
