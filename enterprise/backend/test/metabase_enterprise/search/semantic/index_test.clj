(ns metabase-enterprise.search.semantic.index-test
  {:clj-kondo/config '{:linters {:deprecated-var {:exclude {metabase.test.data/mbql-query {:namespaces [metabase-enterprise.search.semantic.index-test]}}}}}}
  (:require
   ...
   [metabase-enterprise.search.semantic.spec-trace-test-util :as spec-trace]
