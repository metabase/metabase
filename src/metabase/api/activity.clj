...
(api/defendpoint POST "/recents"
  ...
  (let [moi model ;;moi is model-of-interest
    ...
    (recent-views/update-users-recent-views! *current-user-id* (recent-views/moi->model moi) model-id :selection)
    (recent-views/update-users-recent-views! *current-user-id* (recent-views/moi->model moi) model-id :view)))
