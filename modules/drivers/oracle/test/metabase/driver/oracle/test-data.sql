...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."test_data_users" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."test_data_users" (
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."test_data_categories" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."test_data_categories" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  "name" VARCHAR2(4000) NOT NULL,
  PRIMARY KEY ("id")
);

BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."test_data_venues" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."test_data_venues" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  "name" VARCHAR2(4000),
  "category_id" INTEGER,
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE "CAM_24"."test_data_checkins" CASCADE CONSTRAINTS' ⅋ EXCEPTION
WHEN OTHERS THEN IF SQLCODE ! = -942 THEN RAISE ⅋
END IF ⅋
END ⅋

CREATE TABLE "CAM_24"."test_data_checkins" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER,
...
ALTER TABLE
  "CAM_24"."test_data_venues"
ADD
  CONSTRAINT "tegory_id_categories_927642602" FOREIGN KEY ("category_id") REFERENCES "CAM_24"."test_data_categories" ("id");

ALTER TABLE
  "CAM_24"."test_data_checkins"
ADD
  CONSTRAINT "ckins_user_id_users_-815717481" FOREIGN KEY ("user_id") REFERENCES "CAM_24"."test_data_users" ("id");

ALTER TABLE
  "CAM_24"."test_data_checkins"
ADD
  CONSTRAINT "ns_venue_id_venues_-1854903846" FOREIGN KEY ("venue_id") REFERENCES "CAM_24"."test_data_venues" ("id");

-- 15 rows
INSERT INTO "CAM_24"."test_data_users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "CAM_24"."test_data_categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "CAM_24"."test_data_venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "CAM_24"."test_data_checkins" ("date", "user_id", "venue_id")
VALUES
