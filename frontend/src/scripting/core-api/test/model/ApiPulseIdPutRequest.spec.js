...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetabaseApi.ApiPulseIdPutRequest();
  });
  ...
  describe('ApiPulseIdPutRequest', function() {
    it('should create an instance of ApiPulseIdPutRequest', function() {
      // uncomment below and update the code to test ApiPulseIdPutRequest
      //var instance = new MetabaseApi.ApiPulseIdPutRequest();
      //expect(instance).to.be.a(MetabaseApi.ApiPulseIdPutRequest);
    });
