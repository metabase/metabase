...
(defn ^:private slack-branding-text
...
<<<<<<< HEAD:test/metabase/pulse/dashboard_subscription_test.clj
...
=======
         (is (= {:channel "#general"
                ...
                pulse-results))))}}))
>>>>>>> 4b6e6e7faa (simplify slack impl (#57634)):test/metabase/dashboard_subscription_test.clj
