...
describe("admin > database > database routing", () => {
  ...
  it.skip("should be able to configure db routing and manage destination databases", () => {
    ...
    cy.log(
      "should be able to bulk create destination databases from the API endpoint",
    );
    // create more databases via bulk endpoint
    // (this is how we expect most users to create databases)
  ...
  it.skip("not leak destinations databases in the application", () => {});
  // - [ ] visit admin databases page
  // - [ ] visit databases page

  it.skip("should interact with other settings correctly", () => {});
