...
(defn init!
  ...
  automatically created anyway as soon as those Users' permissions get calculated
  in [[metabase.permissions.core/user-permissions-set]]; better to do it now so the test results will be consistent."
  []
