...
You can't use static embeds with [row and column security](../permissions/row-and-column-security.md), [drill-through](/docs/questions/visualizations/drill-through.md), and user-specific data isn't captured in [usage analytics](../usage-and-performance-tools/usage-analytics.md) because signed JWTs don't create user sessions (server-side sessions). For those features, check out [Modular embedding](./modular-embedding.md).
...
If you want to embed charts with additional interactive features, like [drill-down](/docs/questions/visualizations/drill-through.md) and [self-service querying](../questions/query-builder/editor.md), see [Modular embedding](./modular-embedding.md).
