...
import { Divider, Icon, type IconName, NavLink, type NavLinkProps, Stack } from "metabase/ui";
  ...
  return (
    ...
    >
      ...
      <SettingsNavItem
        ...
        icon="lock"
      >
        <SettingsNavItem path="authentication/user-provisioning" label={t`User Provisioning`} />
      ...
      <SettingsNavItem path="notifications" label={t`Notification channels`} icon="bell">
      ...
      <SettingsNavItem path="localization" label={t`Localization`} icon="globe" />
      <SettingsNavItem path="whitelabel" label={t`Appearance`} icon="palette">
        <SettingsNavItem path="whitelabel/branding" label={t`Branding`} />
        <SettingsNavItem path="whitelabel/conceal-metabase" label={t`Conceal Metabase`} />
      </SettingsNavItem>
      <Divider />
      <SettingsNavItem path="uploads" label={t`Uploads`} icon="upload" />
      <SettingsNavItem path="public-sharing" label={t`Public Sharing`} icon="share" />
      <SettingsNavItem path="embedding-in-other-applications" label={t`Embedding`} icon="embed">
        <SettingsNavItem path="embedding-in-other-applications/standalone" label={t`Static Embedding`} />
        <SettingsNavItem path="embedding-in-other-applications/full-app" label={t`Interactive Embedding`} />
        <SettingsNavItem path="embedding-in-other-applications/sdk" label={t`Embedding SDK`} />
      </SettingsNavItem>
      <Divider />
...
function SettingsNavItem({
  ...
  icon,
  ...navLinkProps
}: { path: string, hidden?: boolean, icon?: IconName } & Omit<NavLinkProps, 'href'>) {
  ...
  return (
    <NavLink
      ...
      active={subpath === path || subpath === (path + '/') /* lol */}
      variant="admin-nav"
      label={label}
