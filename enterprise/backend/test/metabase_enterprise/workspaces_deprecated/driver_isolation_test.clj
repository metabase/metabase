(ns ^:mb/driver-tests metabase-enterprise.workspaces-deprecated.driver-isolation-test
            ...
            (let [thrown (with-redefs [driver.u/random-workspace-password
                                       (fn []
                                         (let [pw (gen-orig)]
                                           ...
                                           pw))]
                           (try
                             (driver/init-workspace-isolation!
                              driver low-priv-db
                              (with-isolation-details driver low-priv-db ws-b))
                             nil
                             (catch Throwable t t)))]
