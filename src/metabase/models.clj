...
(def :model/Action action/Action)
(def :model/HTTPAction action/:model/HTTPAction)
(def :model/ImplicitAction action/:model/ImplicitAction)
(def :model/QueryAction action/:model/QueryAction)
(def :model/CardBookmark bookmark/:model/CardBookmark)
(def :model/DashboardBookmark bookmark/:model/DashboardBookmark)
(def :model/CollectionBookmark bookmark/:model/CollectionBookmark)
(def :model/BookmarkOrdering bookmark/:model/BookmarkOrdering)
(def :model/CacheConfig cache-config/:model/CacheConfig)
(def :model/Card card/:model/Card)
(def :model/Collection collection/:model/Collection)
(def :model/CollectionPermissionGraphRevision c-perm-revision/:model/CollectionPermissionGraphRevision)
(def :model/Dashboard dashboard/:model/Dashboard)
(def :model/DashboardCard dashboard-card/:model/DashboardCard)
(def :model/DashboardCardSeries dashboard-card-series/:model/DashboardCardSeries)
(def :model/Database database/:model/Database)
(def :model/Dimension dimension/:model/Dimensions)
(def :model/Field field/:model/Field)
(def :model/FieldValues field-values/:model/FieldValues)
(def :model/LegacyMetric legacy-metric/:model/LegacyMetric)
(def :model/LoginHistory login-history/:model/LoginHistory)
(def :model/ModerationReview moderation-review/:model/ModerationReview)
(def :model/ModelIndex model-index/:model/ModelIndex)
(def :model/ModelIndexValue model-index/:model/ModelIndexValue)
(def :model/LegacyMetricImportantField legacy-metric-important-field/:model/LegacyMetricImportantField)
(def :model/NativeQuerySnippet native-query-snippet/:model/NativeQuerySnippet)
(def :model/ParameterCard parameter-card/:model/ParameterCard)
(def :model/Permissions perms/:model/Permissions)
(def :model/PermissionsGroup perms-group/:model/PermissionsGroup)
(def :model/PermissionsGroupMembership perms-group-membership/:model/PermissionsGroupMembership)
(def :model/PermissionsRevision perms-revision/:model/PermissionsRevision)
(def :model/ApplicationPermissionsRevision a-perm-revision/:model/ApplicationPermissionsRevision)
(def :model/PersistedInfo persisted-info/:model/PersistedInfo)
(def :model/Pulse models.pulse/:model/Pulse)
(def :model/PulseCard pulse-card/:model/PulseCard)
(def :model/PulseChannel pulse-channel/:model/PulseChannel)
(def :model/PulseChannelRecipient pulse-channel-recipient/:model/PulseChannelRecipient)
(def :model/QueryCache query-cache/:model/QueryCache)
(def :model/QueryExecution query-execution/:model/QueryExecution)
(def :model/Revision revision/:model/Revision)
(def :model/Secret secret/:model/Secret)
(def :model/Segment segment/:model/Segment)
(def :model/Session session/:model/Session)
(def :model/Setting setting/:model/Setting)
(def :model/Table table/:model/Table)
(def :model/TaskHistory task-history/:model/TaskHistory)
(def :model/Timeline timeline/:model/Timeline)
(def :model/TimelineEvent timeline-event/:model/TimelineEvent)
(def :model/User user/:model/User)
(def :model/ViewLog view-log/:model/ViewLog)
