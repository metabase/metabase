...
import {PublicDashboardRouterWrapper} from "metabase/public/containers/PublicDashboardRouterWrapper";
  ...
  return (
    <Route title={applicationName}>
      <Route path="public" component={PublicApp}>
        ...
        <Route path="dashboard/:uuid(/:tabSlug)" component={PublicDashboardRouterWrapper} />
