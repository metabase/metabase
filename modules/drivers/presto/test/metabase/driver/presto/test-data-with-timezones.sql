...
DROP TABLE IF EXISTS "test-data"."default"."test_data_with_timezones_users"

CREATE TABLE "test-data"."default"."test_data_with_timezones_users" AS
SELECT
  *
FROM
  (
...
DROP TABLE IF EXISTS "test-data"."default"."data_with_timezones_categories"

CREATE TABLE "test-data"."default"."data_with_timezones_categories" AS
SELECT
  *
FROM
  (
...
DROP TABLE IF EXISTS "test-data"."default"."est_data_with_timezones_venues"

CREATE TABLE "test-data"."default"."est_data_with_timezones_venues" AS
SELECT
  *
FROM
  (
...
DROP TABLE IF EXISTS "test-data"."default"."t_data_with_timezones_checkins"

CREATE TABLE "test-data"."default"."t_data_with_timezones_checkins" AS
SELECT
  *
FROM
  (
...
ALTER TABLE
  "test-data"."default"."est_data_with_timezones_venues"
ADD
  CONSTRAINT "tegory_id_categories_341257635" FOREIGN KEY ("category_id") REFERENCES "test-data"."default"."data_with_timezones_categories" ("id");

ALTER TABLE
  "test-data"."default"."t_data_with_timezones_checkins"
ADD
  CONSTRAINT "eckins_user_id_users_660849906" FOREIGN KEY ("user_id") REFERENCES "test-data"."default"."test_data_with_timezones_users" ("id");

ALTER TABLE
  "test-data"."default"."t_data_with_timezones_checkins"
ADD
  CONSTRAINT "ins_venue_id_venues_1367144309" FOREIGN KEY ("venue_id") REFERENCES "test-data"."default"."est_data_with_timezones_venues" ("id");

-- 15 rows
INSERT INTO "test-data"."default"."test_data_with_timezones_users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "test-data"."default"."data_with_timezones_categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "test-data"."default"."est_data_with_timezones_venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "test-data"."default"."t_data_with_timezones_checkins" ("date", "user_id", "venue_id")
VALUES
