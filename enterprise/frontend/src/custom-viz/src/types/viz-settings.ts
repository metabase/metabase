...
> = {
  ...
  /**
   * Ids of your own settings that must be computed before this setting.
   * Metabase's settings are always available and can't be listed here.
   *
  ...
  /**
   * Ids of your own settings whose current computed values are persisted
   * alongside this setting whenever it changes.
   *
  ...
  /**
   * Ids of your own settings that are reset to `null` whenever this setting
   * changes.
   *
