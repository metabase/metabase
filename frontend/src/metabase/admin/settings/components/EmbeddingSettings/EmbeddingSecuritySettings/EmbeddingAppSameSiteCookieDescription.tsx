...
export const EmbeddingAppSameSiteCookieDescription = () => {
  ...
  return (
    <Stack gap="sm">
      ...
      <Text>
        {t`Determines whether or not cookies are allowed to be sent on cross-site requests. Applies to Modular embedding and Full-app embedding. You'll likely need to change this to None if your embedding application is hosted under a different domain than Metabase. Otherwise, leave it set to Lax, as it's more secure.`}
      </Text>
