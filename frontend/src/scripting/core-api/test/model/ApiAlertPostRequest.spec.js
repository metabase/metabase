...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetabaseApi.ApiAlertPostRequest();
  });
  ...
  describe('ApiAlertPostRequest', function() {
    it('should create an instance of ApiAlertPostRequest', function() {
      // uncomment below and update the code to test ApiAlertPostRequest
      //var instance = new MetabaseApi.ApiAlertPostRequest();
      //expect(instance).to.be.a(MetabaseApi.ApiAlertPostRequest);
    });
