...
(def ^:private expected
  ...
  #{[:metabase-security-lint/weak-hash                                 "src/metabase/cmd/core.clj"                   7 :note    [:cli]]
    ...
    [:metabase-security-lint/driver-value-clause-guard-bypassed        "src/metabase/driver/thing.clj"              37 :error   []]
    [:metabase-security-lint/embed-endpoint-reaches-token-verification "src/metabase/embedding_rest/api/embed.clj"  16 :error   [:http]]
    [:metabase-security-lint/embed-endpoint-reaches-param-validation   "src/metabase/embedding_rest/api/embed.clj"  29 :error   [:http]]
    ...
    [:metabase-security-lint/middleware-acts-on-request-value          "src/metabase/server/middleware/misc.clj"    33 :warning [:middleware]]
    [:metabase-security-lint/public-endpoint-returns-unscrubbed-object "src/metabase/public_sharing_rest/api.clj"   20 :warning [:http]]
    [:metabase-security-lint/check-gated-on-current-user               "src/metabase/query_processor/permissions.clj" 13 :warning []]
    [:metabase-security-lint/public-endpoint-reaches-enablement-check  "src/metabase/public_sharing_rest/api.clj"   26 :error   [:http]]
    [:metabase-security-lint/hiccup1-unescaped-value                   "src/metabase/public_sharing_rest/api.clj"   29 :error   [:http]]
    ...
    [:metabase-security-lint/write-reached-under-read-check-only       "src/metabase/things/api.clj"                64 :warning [:http]]
    [:metabase-security-lint/write-reached-under-read-check-only       "src/metabase/things/api.clj"                90 :warning [:http]]
    ...
    [:metabase-security-lint/untyped-query-reaches-query-processor     "src/metabase/things/api.clj"               173 :error   [:http]]
    [:metabase-security-lint/write-reached-under-read-check-only       "src/metabase/things/api.clj"               183 :warning [:http]]
    [:metabase-security-lint/h2x-cast-from-dynamic                     "src/metabase/things/api.clj"               186 :error   [:http]]
    [:metabase-security-lint/privileged-column-from-request            "src/metabase/things/api.clj"               192 :error   [:http]]
    [:metabase-security-lint/unanchored-malli-regex                    "src/metabase/things/api.clj"               195 :warning [:startup]]
    [:metabase-security-lint/outbound-http-follows-redirects           "src/metabase/notify/payload.clj"            13 :warning [:http]]
    [:metabase-security-lint/outbound-http-follows-redirects           "src/metabase/things/api.clj"               120 :warning [:http]]
    [:metabase-security-lint/outbound-http-follows-redirects           "src/metabase/things/api.clj"               155 :warning [:http]]
    [:metabase-security-lint/outbound-http-follows-redirects           "src/metabase/things/settings.clj"           20 :note    []]
    [:metabase-security-lint/outbound-http-follows-redirects           "src/metabase/things/sync.clj"               16 :note    []]
    [:metabase-security-lint/request-id-never-checked                  "src/metabase/things/api.clj"               189 :warning [:http]]
    [:metabase-security-lint/write-reached-under-read-check-only       "src/metabase/things/api.clj"               189 :warning [:http]]
    ...
    [:metabase-security-lint/json-column-value-in-query-position       "src/metabase/things/db.clj"                 28 :warning []]
    [:metabase-security-lint/endpoint-mounted-without-auth             "src/metabase/things/internal_api.clj"       14 :warning [:http]]
    [:metabase-security-lint/namespace-authz-outlier                   "src/metabase/things/slack_api.clj"          21 :warning [:http]]
