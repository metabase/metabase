...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MetabaseApi.ApiSegmentPostRequest();
  });
  ...
  describe('ApiSegmentPostRequest', function() {
    it('should create an instance of ApiSegmentPostRequest', function() {
      // uncomment below and update the code to test ApiSegmentPostRequest
      //var instance = new MetabaseApi.ApiSegmentPostRequest();
      //expect(instance).to.be.a(MetabaseApi.ApiSegmentPostRequest);
    });
