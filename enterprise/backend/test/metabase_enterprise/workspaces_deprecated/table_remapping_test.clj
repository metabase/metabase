(ns metabase-enterprise.workspaces-deprecated.table-remapping-test
  "Tests for the public writer API in `metabase-enterprise.workspaces-deprecated.table-remapping`.
