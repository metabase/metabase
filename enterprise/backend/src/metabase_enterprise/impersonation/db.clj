...
(mu/defn impersonation :- [:maybe (ms/InstanceOf :model/ConnectionImpersonation)]
...
(mu/defn impersonation-for-group-and-database :- [:maybe (ms/InstanceOf :model/ConnectionImpersonation)]
...
(mu/defn all-impersonations :- [:sequential (ms/InstanceOf :model/ConnectionImpersonation)]
...
(mu/defn impersonations-for-groups-and-database :- [:sequential (ms/InstanceOf :model/ConnectionImpersonation)]
...
(mu/defn impersonations-matching :- [:sequential (ms/InstanceOf :model/ConnectionImpersonation)]
...
(mu/defn insert-impersonation! :- (ms/InstanceOf :model/ConnectionImpersonation)
  "Insert `impersonation` and return the new instance."
  [impersonation :- [:map {:closed true}
                     [:db_id     {:optional true} :any]
                     [:group_id  {:optional true} :any]
                     [:attribute {:optional true} :any]]]
...
(mu/defn view-data-permission-values :- [:maybe [:set :any]]
