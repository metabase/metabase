(ns metabase.test.domain-entities
  (:require [metabase.domain-entities
             ...
             [specs :as de.specs]]
            [metabase.models
             [domain-entity :refer [map->DomainEntityInstance]]
             [table :as table]]))
