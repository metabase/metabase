(ns metabase-enterprise.search.semantic.db.datasource
  (:require
...
(def app-db-schema
  ...
  [[metabase-enterprise.search.semantic.db.migration.impl]]) structurally incapable of touching
  application tables."
  "semantic_search")
...
(defn check-app-db-pgvector-support
  ...
  path ([[metabase-enterprise.search.semantic.pgvector-api/init-semantic-search!]]).
