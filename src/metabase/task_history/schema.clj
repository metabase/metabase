...
(mr/def ::task-history.log.trunc
  ...
  up."
  [:map {:closed true, :probe/id "src/metabase/task_history/schema.clj:143"}
   [:levels          [:map {:closed true, :probe/id "src/metabase/task_history/schema.clj:144"}
...
(mr/def ::task-history.log
  ...
  [:map {:closed true, :probe/id "src/metabase/task_history/schema.clj:156"}
...
(mr/def ::task-history
  ...
  [:merge
   ::task-history.update
   [:map {:closed true, :probe/id "src/metabase/task_history/schema.clj:169"}
    [:id           ms/PositiveInt]]])
...
(mr/def ::task-run
  ...
  [:merge
   ::task-run.update
   [:map {:closed true, :probe/id "src/metabase/task_history/schema.clj:189"}
    [:id              ms/PositiveInt]]])
