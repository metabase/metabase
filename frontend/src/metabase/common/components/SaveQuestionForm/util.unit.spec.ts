...
describe("SaveQuestionForm utils", () => {
  ...
  describe("getInitialValues", () => {
    ...
    // metabase#55631
    // while a new ad-hoc question is being saved the in-flight question carries the user-entered as its display name.
    // getInitialValues must keep that display name instead of falling back to the auto-generated query description
