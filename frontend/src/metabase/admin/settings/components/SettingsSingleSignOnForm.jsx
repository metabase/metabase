      ...
      <form noValidate>
        <div className="px2" style={{ maxWidth: "585px" }}>
          ...
          <p className="text-medium">
            {t`Allows users with existing Repente Insights accounts to login with a Google account that matches their email address in addition to their Repente Insights username and password.`}
          </p>
          <p className="text-medium">
            {jt`To allow users to sign in with Google you'll need to give Repente Insights a Google Developers console application client ID. It only takes a few steps and instructions on how to create a key can be found ${(
              <a
                className="link"
