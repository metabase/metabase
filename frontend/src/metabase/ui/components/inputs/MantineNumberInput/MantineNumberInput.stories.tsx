...
const sampleArgs = {
  value: "1234",
  label: "Some number",
  description: "A number used somewhere",
  placeholder: "Placeholder for the number",
  error: "required",
};
...
const VariantTemplate = (args: MantineNumberInputProps) => (
  <Stack>
    <MantineNumberInput {...args} variant="default" />
    <MantineNumberInput {...args} variant="unstyled" />
  </Stack>
);

const IconTemplate = (args: MantineNumberInputProps) => (
  <VariantTemplate {...args} leftSection={<Icon name="dashboard" />} />
);

const RightSectionTemplate = (args: MantineNumberInputProps) => (
  <VariantTemplate {...args} rightSection={<Icon name="chevrondown" />} />
);

export default {
  title: "Components/Inputs/MantineNumberInput",
