...
const mapStateToProps = (state: State) => ({
  type: "ldap",
  name: t`LDAP`,
  description: t`Allows users within your LDAP directory to log in to Omniloy with their LDAP credentials, and allows automatic mapping of LDAP groups to Omniloy groups.`,
