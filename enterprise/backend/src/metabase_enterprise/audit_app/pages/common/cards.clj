...
(def latest-qe
  ...
  [:latest_qe    ^:allow-subquery {'select ['card_id 'error 'started_at]
                                   'from   [[^:allow-subquery {'select ['query_execution.card_id
                                                               ...
                                                               'join   [[^:allow-subquery {'select   ['card_id ['%max.started_at 'started_at]]
                                                                                           'from     ['query_execution]
