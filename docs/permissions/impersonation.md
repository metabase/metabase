...
> For now, impersonation access is only available for PostgreSQL, Redshift, and Snowflake. If you want to switch database _connections_ based on who is logged in, check out [Database routing](./database-routing.md).
