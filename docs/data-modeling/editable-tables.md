...
Currently, editable tables are avavailable for the following databases:
...
_Currently, editable table data is only available for PostgreSQL, MySQL, and Metabase Sample Database._
