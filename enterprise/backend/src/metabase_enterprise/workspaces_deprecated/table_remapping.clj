(ns metabase-enterprise.workspaces-deprecated.table-remapping
...
;;; -------------------------------------------- Write API --------------------------------------------
;;;
;;; The convenience layer over [[metabase-enterprise.workspaces-deprecated.remapping.core]]. Accepts
