...
import { SegmentItem } from "../pages/DataModel/components/SegmentItem";
import FilteredToUrlTable from "../pages/DataModel/hoc/FilteredToUrlTable";
    ...
    return (
      ...
      >
        <div className={cx(CS.flex, CS.py2)}>
          {tableSelector}
          <Link to="/bench/metadata/segment/create" className={CS.mlAuto}>
