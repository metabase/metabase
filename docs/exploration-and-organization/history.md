...
1. Go to your transform in [Data studio](../semantic-layer/transforms/transforms-overview.md).
...
1. Go to your transform in [Data studio > Transforms](../semantic-layer/transforms/transforms-overview.md).
2. Click the **three dots** icon and select **History**.
3. Click the **back arrow** beside a version to revert your item to that point in time.

## History for segments and measures

1. Go to the table source for the segment or measure in [Data Studio > Tables](../semantic-layer/managing-tables.md).
