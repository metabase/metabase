 ...
 * @category Question
 */
export type QuestionBreakoutDropdownProps = Omit<
  PopoverProps,
  "children" | "onClose" | "opened"
>;

export const BreakoutDropdownInner = (
  popoverProps: QuestionBreakoutDropdownProps,
) => {
 ...
 * @param props
 */
export const BreakoutDropdown = (props: QuestionBreakoutDropdownProps) => {
