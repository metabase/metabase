...
(deftest create-collection-authority-test
  (testing "POST /api/collection/:id"
    (testing "can add an official collection if has :content-management feature"
      (premium-features-test/with-premium-features #{:content-management}
        ...
        (testing "but it requires an admin user"
...
(deftest update-collection-authority-test
  (testing "PUT /api/collection/:id"
    #_(testing "happy path\n"
        (testing "can update if has :content-management feature"
          (premium-features-test/with-premium-features #{:content-management}
