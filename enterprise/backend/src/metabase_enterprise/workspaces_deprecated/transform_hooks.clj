(ns metabase-enterprise.workspaces-deprecated.transform-hooks
...
(defenterprise resolve-transform-target
  "Enterprise impl of the transform-target rewrite hook.
   ...
   copy via the QP middleware (see `metabase-enterprise.workspaces-deprecated.query-processor.middleware`).
