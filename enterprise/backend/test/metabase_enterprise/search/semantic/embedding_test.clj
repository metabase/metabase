(ns metabase-enterprise.search.semantic.embedding-test
  (:require
   ...
   [metabase-enterprise.search.semantic.gate :as semantic.gate]
   ...
   [metabase-enterprise.search.semantic.models.token-tracking :as semantic.models.token-tracking]
...
(defn- encode-floats-to-base64
  "Helper function to base64 encode a vector of floats using little-endian byte order.
   Inverse of [[metabase-enterprise.search.semantic.embedding/extract-base64-response-embeddings]] "
  [float-vector]
