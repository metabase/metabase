...
/* MIT license */
var cssKeywords = __webpack_require__(126);
...
var _table_format = __webpack_require__(331);
...
var _colors = __webpack_require__(332);

var _underscore = __webpack_require__(342);
...
function makeCellBackgroundGetter(data, settings) {
  ...
  var colIndexes = _underscore2.default.object(cols.map(function (col, index) {
  ...
  if (Object.values(formatters).length === 0 && rowFormatters.length === 0) {
    ...
    return function (value, rowIndex, colName) {
      if (formatters[colName]) {
        ...
        try {
          for (var _iterator = formatters[colName][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (!pivot) {
        ...
        try {
          for (var _iterator2 = rowFormatters[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var rowFormatter = _step2.value;
...
function compileFormatters(formats, columnExtents) {
  ...
  try {
    for (var _iterator3 = formats[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      try {
        for (var _iterator4 = format.columns[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
function compileRowFormatters(formats) {
  ...
  try {
      ...
      if (formatter) {
        ...
        try {
          var _loop2 = function _loop2() {
            var colName = _step6.value;

            rowFormatters.push(function (row, colIndexes) {
              return formatter(row[colIndexes[colName]]);
            });
          };

          for (var _iterator6 = format.columns[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            _loop2();
          }
        } catch (err) {
    ...
    for (var _iterator5 = formats.filter(function (format) {
...
var _d2 = __webpack_require__(125);

var _d3 = _interopRequireDefault(_d2);

var _color = __webpack_require__(333);

var _color2 = _interopRequireDefault(_color);

var _colorHarmony = __webpack_require__(339);
...
var colorString = __webpack_require__(334);
var convert = __webpack_require__(337);
...
var swizzle = __webpack_require__(335);
...
var isArrayish = __webpack_require__(336);
...
var route = __webpack_require__(338);
...
var onecolor = __webpack_require__(340);
...
if ("function" === 'function' && !undef(__webpack_require__(341))) {
