...
const mapStateToProps = (state: State): StateProps => ({
  ...
  description: t`Allows users with existing Omniloy accounts to login with a Google account that matches their email address in addition to their Omniloy username and password.`,
