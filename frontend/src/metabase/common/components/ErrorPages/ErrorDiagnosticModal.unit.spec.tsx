...
describe("ErrorDiagnosticsModal", () => {
  ...
  describe("Bug Report Form", () => {
    ...
    it("should send the report attributed to the current user by default", async () => {
      ...
      expect(body.diagnosticInfo).not.toHaveProperty("reporter");
    });

    it("should send an anonymous report when name and email are unchecked", async () => {
