...
DROP TABLE IF EXISTS "test-data"."default"."ta_self_referencing_user_users"

CREATE TABLE "test-data"."default"."ta_self_referencing_user_users" AS
SELECT
  *
FROM
  (
  ...
  ) AS t ("id", "name", "last_login", "password", "created_by")
WHERE
  1 = 0

ALTER TABLE
  "test-data"."default"."ta_self_referencing_user_users"
ADD
  CONSTRAINT "ers_created_by_users_406217275" FOREIGN KEY ("created_by") REFERENCES "test-data"."default"."ta_self_referencing_user_users" ("id");

-- 15 rows
INSERT INTO "test-data"."default"."ta_self_referencing_user_users" ("name", "last_login", "password", "created_by")
VALUES
