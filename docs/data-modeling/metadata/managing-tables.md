...
redirect_from:
  ...
  - /docs/latest/data-modeling/managing-tables
---
...
See [Table metadata editing](./metadata-editing.md).

## Segments

Segments are saved filters on a table that people can use in the query builder. See [Segments](../semantic-layer/segments.md).
...
- [Table metadata editing](./metadata-editing.md)
