  ...
  (testing "/api/ldap"
    (mt/with-user-in-groups
      ...
      (letfn [(update-ldap-settings [user status]
                (testing (format "update ldap settings with %s user" (adv-perms/friendly-user-name user))
  ...
  (testing "/api/geojson"
    (mt/with-user-in-groups
      ...
      (letfn [(get-geojson [user status]
                (testing (format "get geojson with %s user" (adv-perms/friendly-user-name user))
  ...
  (testing "/api/permissions"
    (mt/with-user-in-groups
      ...
      (letfn [(get-permission-groups [user status]
                (testing (format "get permission groups with %s user" (adv-perms/friendly-user-name user))
    ...
    (mt/with-temporary-setting-values [enable-public-sharing true
      ...
      (mt/with-user-in-groups
        ...
        (letfn [(get-public-dashboards [user status]
                  (testing (format "get public dashboards with %s user" (adv-perms/friendly-user-name user))
                    (mt/user-http-request user :get status "dashboard/public")))

                (get-embeddable-dashboards [user status]
                  (testing (format "get embeddable dashboards with %s user" (adv-perms/friendly-user-name user))
                ...
                (delete-public-dashboard [user status]
                  (testing (format "delete public dashboard with %s user" (adv-perms/friendly-user-name user))
    ...
    (mt/with-temporary-setting-values [enable-public-sharing true
      ...
      (mt/with-user-in-groups
        ...
        (letfn [(get-public-cards [user status]
                  (testing (format "get public cards with %s user" (adv-perms/friendly-user-name user))
                ...
                (delete-public-card [user status]
                  (testing (format "delete public card with %s user" (adv-perms/friendly-user-name user))
