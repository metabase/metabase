...
(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :oracle :teradata} 4 (count-of-grouping (checkins:4-per-minute) :minute "current"))

(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :oracle :teradata} 4 (count-of-grouping (checkins:4-per-minute) :minute -1 "minute"))
(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :oracle :teradata} 4 (count-of-grouping (checkins:4-per-minute) :minute  1 "minute"))

(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata} 4 (count-of-grouping (checkins:4-per-hour) :hour "current"))
(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata} 4 (count-of-grouping (checkins:4-per-hour) :hour -1 "hour"))
(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata} 4 (count-of-grouping (checkins:4-per-hour) :hour  1 "hour"))

(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata} 1 (count-of-grouping (checkins:1-per-day) :day "current"))
(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata} 1 (count-of-grouping (checkins:1-per-day) :day -1 "day"))
(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata} 1 (count-of-grouping (checkins:1-per-day) :day  1 "day"))

(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata} 7 (count-of-grouping (checkins:1-per-day) :week "current"))

;; SYNTACTIC SUGAR
(expect-with-non-timeseries-dbs-except #{:snowflake :bigquery :teradata}
  1
