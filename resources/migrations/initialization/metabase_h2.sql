...
CREATE CACHED TABLE "PUBLIC"."COLLECTION" COMMENT 'Collections are an optional way to organize Cards and handle permissions for them.'(
    ...
    "NAMESPACE" CHARACTER VARYING(254) COMMENT 'The namespace (hierarchy) this Collection belongs to. NULL means the Collection is in the default namespace.',
...
CREATE CACHED TABLE "PUBLIC"."REPORT_CARD"(
    ...
    "PUBLIC_UUID" CHARACTER(36) COMMENT 'Unique UUID used to in publicly-accessible links to this Card.',
    "MADE_PUBLIC_BY_ID" INTEGER COMMENT 'The ID of the User who first publicly shared this Card.',
...
CREATE CACHED TABLE "PUBLIC"."REPORT_DASHBOARD"(
    ...
    "CAVEATS" CHARACTER LARGE OBJECT,
    "SHOW_IN_GETTING_STARTED" BOOLEAN DEFAULT FALSE NOT NULL,
    "PUBLIC_UUID" CHARACTER(36) COMMENT 'Unique UUID used to in publicly-accessible links to this Dashboard.',
    "MADE_PUBLIC_BY_ID" INTEGER COMMENT 'The ID of the User who first publicly shared this Dashboard.',
