...
import columnFormattingPercentagesOnChart from "./column-formatting-percentages-on-chart.json";
import columnFormatting from "./column-formatting.json";
import dateDimension from "./date-dimension.json";
