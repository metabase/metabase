...
(mr/def ::integer
  [:or
   ...
   (expression-schema :type/Text "expression returning an integer")])

(mr/def ::non-integer-real
  [:or
   (expression-schema :type/Float "expression returning a non-integer real number")
   (expression-schema :type/Text "expression returning a non-integer real number")])

(mr/def ::number
  [:or
   (expression-schema :type/Number "expression returning a number")
   (expression-schema :type/Text "expression returning a number")])
