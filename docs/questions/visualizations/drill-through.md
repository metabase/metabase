...
If you need native SQL but also want to use the full drill-through menu, write your SQL query as a [transform](../../semantic-layer/transforms/transforms-overview.md) and build the user-facing question with the query builder.
...
> To create transforms, you must have transform permissions. If you use Metabase Cloud, you must also have the [transform add-on](../../semantic-layer/transforms/addons.md).
