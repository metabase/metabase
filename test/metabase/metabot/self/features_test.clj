...
(deftest ^{:parallel false} feature-available?-known-feature-available-test
...
(deftest ^{:parallel false} feature-available?-known-feature-unavailable-test
...
(deftest ^{:parallel false} feature-available?-unknown-feature-test
...
(deftest ^{:parallel false} feature-available?-predicate-called-test
