...
(def ^:private AISDKPart
  ...
  by `:role` instead."
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:134"}
   ...
   [:error             {:optional true} [:maybe [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:143"}
                                                 [:message {:optional true} [:maybe :string]]
                                                 [:type    {:optional true} [:maybe :string]]]]]
...
(def ^:private ApiKeyCredentials
  ...
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:150"}
...
(def ^:private BedrockCredentials
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:156"}
...
(def ^:private GoogleCredentials
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:163"}
...
(def ^:private ReasoningConfig
  ...
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:175"}
   [:type    :string]
...
(def ^:private JSONSchemaLeaf
  ...
  an array-typed leaf."
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:182"}
   [:type        {:optional true} [:maybe :string]]
   [:description {:optional true} [:maybe :string]]
   [:items       {:optional true} [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:185"}
                                   [:type        {:optional true} [:maybe :string]]
                                   [:description {:optional true} [:maybe :string]]]]
...
(def ^:private JSONSchemaNode
  ...
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:200"}
   [:type                 {:optional true} [:maybe :string]]
...
(def LLMRequestOpts
  ...
  [:map {:closed true, :probe/id "src/metabase/metabot/self/core.clj:236"}
