(ns metabase.product-feedback.queries
...
(defn creator-sentiment-candidates
  "The email, join date, first name, and content counts of the active personal Users who created content after the
  Honey SQL timestamp `created-after`, with at least 10 Cards (2 native), and at least 1 Dashboard. `user-clause` is
  an extra Honey SQL condition on the User, or nil."
  [created-after user-clause]
