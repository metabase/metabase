...
import { trackStaticEmbedCodeCopied } from "metabase/embed/lib/analytics";
import { getIframeQueryWithoutDefaults } from "metabase/embed/lib/code-templates";
import { getSignedPreviewUrlWithoutHash } from "metabase/embed/lib/embed";
import type {
  EmbedResource,
