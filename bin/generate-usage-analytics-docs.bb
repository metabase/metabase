...
(defn- render-document
  [{:keys [title dashboards models]}]
  (str
   "---\n"
   "title: " title "\n"
   "---\n\n"
   "# " title "\n\n"
   "_This page is generated by `bin/generate-usage-analytics-docs.bb`. "
   "Do not edit by hand — re-run the script after changing the YAML._\n\n"
   "It enumerates every dashboard and model shipped in the Usage Analytics "
   "collection. For an overview of access, retention, and custom reports, see "
