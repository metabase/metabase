...
describe("scenarios > question > native query drill", () => {
  ...
  describe("query builder metadata", () => {
    it("should allow to save an ad-hoc native query when attempting to drill", () => {
      ...
      H.tableInteractive().findByText("October 7, 2029, 1:34 AM").click();
      H.popover().within(() => {
  ...
  describe("query builder drills", () => {
    it("column-extract drill", () => {
      ...
      H.assertTableData({
        ...
        firstRows: [
          ["1", "February 11, 2031, 9:40 PM", "2", "Q1"],
          ["2", "May 15, 2030, 8:04 AM", "3", "Q2"],
        ],
      });
    ...
    it("sort drill", () => {
      ...
      H.assertTableData({
        ...
        firstRows: [["1", "February 11, 2031, 9:40 PM", "2"]],
      });
      ...
      H.assertTableData({
        columns: ["ID", "CREATED_AT", "QUANTITY"],
        firstRows: [["8", "June 17, 2031, 2:37 AM", "7"]],
      });
    });
  ...
  describe("dashboard drills", () => {
    it("quick-filter drill", () => {
      ...
      H.getDashboardCard().findByText("May 15, 2030, 8:04 AM").click();
      H.popover().within(() => {
        cy.findByText("Filter by this date and time").should("be.visible");
        cy.findByText("On").click();
        cy.wait("@dataset");
