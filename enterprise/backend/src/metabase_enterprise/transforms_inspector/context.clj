...
(def ^:private TableRef
  ...
  [:map {:closed true, :probe/id "enterprise/backend/src/metabase_enterprise/transforms_inspector/context.clj:124"}
   [:table-id ::lib.schema.id/table]
   [:table-name :string]
   [:schema [:maybe :string]]
...
(mr/def ::join-structure-entry
  [:map {:closed true, :probe/id "enterprise/backend/src/metabase_enterprise/transforms_inspector/context.clj:226"}
...
(def ^:private QueryInfo
  [:map {:closed true, :probe/id "enterprise/backend/src/metabase_enterprise/transforms_inspector/context.clj:238"}
   ...
   [:visited-fields     {:optional true} [:maybe [:map {:closed true, :probe/id "enterprise/backend/src/metabase_enterprise/transforms_inspector/context.clj:244"} [:all {:optional true} [:maybe [:set ::lib.schema.id/field]]]]]]])
...
(def ^:private TransformInput
  ...
  [:map {:closed true, :probe/id "enterprise/backend/src/metabase_enterprise/transforms_inspector/context.clj:306"}
