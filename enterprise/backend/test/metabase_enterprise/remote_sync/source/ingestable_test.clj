...
(deftest ^:parallel ingestable-snapshot-test
...
(deftest ^:parallel callback-ingestable-test
...
(deftest ^:parallel root-dependency-ingestable-test
...
(deftest ^:parallel ingest-errors-test
