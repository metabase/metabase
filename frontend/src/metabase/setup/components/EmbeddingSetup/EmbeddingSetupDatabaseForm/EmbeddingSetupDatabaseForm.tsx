...
import DatabaseDetailField from "metabase/databases/components/DatabaseDetailField";
import DatabaseEngineWarning from "metabase/databases/components/DatabaseEngineWarning";
import DatabaseNameField from "metabase/databases/components/DatabaseNameField";
import { getEngines, getIsHosted } from "metabase/databases/selectors";
...
import { EmbeddingSetupDatabaseEngineField } from "./EmbeddingSetupDatabaseEngineField";
import { LinkButton, LinkFooter } from "./EmbeddingSetupDatabaseForm.styled";

export type EngineFieldState = "default" | "hidden" | "disabled";

export interface EmbeddingSetupDatabaseFormConfig {
...
interface DatabaseFormProps {
  ...
  config?: EmbeddingSetupDatabaseFormConfig;
}

export const EmbeddingSetupDatabaseForm = ({
  ...
  return (
    ...
    >
      <EmbeddingSetupDatabaseFormBody
        engine={engine}
        engineKey={engineKey}
        engines={engines}
...
const EmbeddingSetupDatabaseFormBody = ({
  engine,
  engineKey,
  engines,
  ...
  return (
    <Form data-testid="database-form" className="database-form">
      {engineFieldState !== "hidden" && (
        <>
          <EmbeddingSetupDatabaseEngineField
            engineKey={engineKey}
            engines={engines}
            isHosted={isHosted}
            isAdvanced={isAdvanced}
