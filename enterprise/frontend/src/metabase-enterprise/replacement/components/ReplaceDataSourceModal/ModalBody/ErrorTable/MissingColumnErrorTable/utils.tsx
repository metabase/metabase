...
export function getColumns(): TreeTableColumnDef<MissingColumnErrorItem>[] {
  return [getFieldColumn(), getFieldTypeColumn()];
}

function getFieldColumn(): TreeTableColumnDef<MissingColumnErrorItem> {
  return {
    id: "name",
    header: t`Field`,
    width: "auto",
...
function getFieldTypeColumn(): TreeTableColumnDef<MissingColumnErrorItem> {
  return {
    id: "database_type",
    header: t`Field type`,
    width: "auto",
