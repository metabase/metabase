...
(deftest ^:parallel same-app-by-client-id-test
...
(deftest ^:parallel same-app-by-https-redirect-test
...
(deftest ^:parallel same-app-by-loopback-redirect-test
...
(deftest ^:parallel same-app-never-by-name-alone-test
