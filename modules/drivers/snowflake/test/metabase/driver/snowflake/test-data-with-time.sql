...
DROP TABLE IF EXISTS "test-data-with-time"."PUBLIC"."users";

CREATE TABLE "test-data-with-time"."PUBLIC"."users" (
...
-- 15 rows
INSERT INTO "test-data-with-time"."PUBLIC"."users" ("name", "last_login_date", "last_login_time", "password")
VALUES
