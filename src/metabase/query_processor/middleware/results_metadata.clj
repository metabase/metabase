...
(defn- remove-remapped-columns
  ...
  We don't want to preserve these fields in the `results_metadata` because some pre-processing middleware like `source-metadata->fields`
   ...
   (fn [{final-base-type :base_type, :as final-col} {our-base-type :base_type, :as insights-col}]
     (merge
      (select-keys final-col [:id :description :display_name :semantic_type :fk_target_field_id
                              ...
                              :coercion_strategy :visibility_type :remapped_from :remapped_to])
      insights-col
