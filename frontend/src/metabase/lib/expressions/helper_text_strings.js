...
{
  name: case,
  structure: "case(" + t`condition` + ", " + t`output` + ", " + t`condition` + ", " + t`output` + "…)",
  ...
  example: "case( [" + t`Weight` + "] > 200, \"" + t`Large` + "\", [" + t`Weight` + "] > 150, \"" + t`Medium` +"\", \"" + t`Small` + "\" )",
  arg1: t`condition`,
...
},
{
  ...
  example: "coalesce( [" + t`Comments` + "], [" + t`Notes` + "], \"" + t`No comments` +"\" )",
  arg1: t`value1`,
...
},
{
  ...
  arg1: t`value1`,
  arg1Desc: t`value2 will be added on to the end of this value.`,
  arg2: t`value2`,
...
{
  name: replace,
  structure: "replace(" + t`text` + ", " + t`position` + ", " + t`length` + ", " + t`new_text`)",
  description: t`Replaces a part of the input text with new text.`,
  example: "replace([" + t`Order ID` +"] , 8, 3, [" + t`Updated Part of ID` + "] )",
  arg1: t`text`,
...
},
{
  ...
  example: "startsWith([" + t`Course Name` +"] , \"" + t`Computer Science` + "\" )",
  arg1: t`text`,
  arg1Desc: t`A column or string of text to check.`,
  arg2: t`comparison`,
...
{
  name: substring,
  structure: "substring(" + t`text` + ", " + t`position` + ", " + t`length` + ")",
...
},
{
  ...
  example: "sumif( [" + t`Subtotal` + "], [" + t`Order Status` + "] = \"" + t`Valid` + "\" )",
  arg1: t`column`,
  arg1Desc: t`The column to sum.`,
  arg2: t`condition`,
