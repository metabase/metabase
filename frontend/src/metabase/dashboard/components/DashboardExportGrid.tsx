...
} from "./DashboardExportGrid.styled";
...
class DashboardExportGrid extends Component<
  DashboardGridProps,
  DashboardGridState
> {
...
export const DashboardExportGridConnected = _.compose(
  ExplicitSize(),
  connector,
)(DashboardExportGrid) as ComponentType<OwnProps>;
