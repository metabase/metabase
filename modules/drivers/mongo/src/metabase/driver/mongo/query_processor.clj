...
(defmethod ->lvalue :aggregation
  [[_ index]]
  (annotate/aggregation-name (:query *query*) (mbql.u/aggregation-at-index *query* index)))
   ...
   (if (and (vector? aggr-expr) (seq aggr-expr))
     (let [[op & args] aggr-expr
       ...
       (cond
         ...
         (aggregation-op op)
         (let [aggr-name (str parent-name "~" (annotate/aggregation-name (:query *query*) aggr-expr))]
