...
declare const ColumnExtractAction: unique symbol;
export type ColumnExtractAction = unknown & {
  _opaque: typeof ColumnExtractAction;
};

export type ColumnExtractActionDisplayInfo = {
  displayName: string;
};
