...
(def ^:private state-dependent-tools
  ...
  #{"analyze-chart"
    "create-chart" "edit-chart" "todo-write" "todo-read" "navigate-user"
    "write-transform-sql" "write-transform-python" "create-autogenerated-dashboard"
    "create-sql-query" "edit-sql-query" "replace-sql-query"
    "document-schema-collect" "document-construct-sql-chart" "document-construct-model-chart"
    "create-alert" "create-dashboard-subscription" "static-viz"})
