...
describe("issue 12581", () => {
  ...
  it("should correctly display a revision state after a restore (metabase#12581)", () => {
    ...
    H.NativeEditor.type("{selectall}{backspace}", { delay: 50 });
    H.NativeEditor.type("{selectall}{backspace}SELECT 1");
    ...
    H.NativeEditor.get().should("be.visible").and("have.text", ORIGINAL_QUERY);
