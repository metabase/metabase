(ns metabase-enterprise.documents.revisions.impl-test
...
(deftest excluded-columns-test
  (testing "excluded columns constant contains expected fields"
    (let [excluded-columns @#'metabase-enterprise.documents.revisions.impl/excluded-columns-for-document-revision]
