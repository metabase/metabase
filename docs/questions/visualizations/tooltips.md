...
For example, if you have a question with two metrics (i.e., two summarizations - they don't have to be Metabase [metrics](../../data-modeling/semantic-layer/metrics.md)), like this question that has both the count and average of subtotal:
