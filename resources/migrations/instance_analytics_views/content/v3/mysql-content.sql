...
select
    ...
    null as event_timestamp
    from report_card
        left join moderation on concat('card_', report_card.id) = moderation.entity_qualified_id
union
select
    ...
    from report_dashboard
        left join moderation on concat('card_', report_dashboard.id) = moderation.entity_qualified_id
union
select
