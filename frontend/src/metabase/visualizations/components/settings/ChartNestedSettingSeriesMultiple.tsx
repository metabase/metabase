...
export interface ChartNestedSettingsSeriesMultipleProps extends ChartNestedSettingsSeriesSingleProps {
  objects: SingleSeries[];
  onChangeEditingObject: (object: SingleSeries | null) => void;
  settings: VisualizationSettings;
}

// various props injected by chartSettingNestedSettings HOC
export const ChartNestedSettingSeriesMultiple = ({
  objects,
  getObjectKey,
  ...
  const isSelected = (single: SingleSeries) =>
    objectKey === getObjectKey(single);
