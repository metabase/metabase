...
(def ^:private ToolCallArguments
  ...
  string keys off the wire, keyword keys when built in Clojure. Values are `::schema.v2/tool-io`: the tool's own
  schema validates their shape, and nested objects may be keyword-keyed (see [[parse-tool-arguments]])."
