...
import {
  ...
  ACCOUNTS_COUNT_BY_CREATED_AT_AREA,
  ORDERS_COUNT_BY_PRODUCT_CATEGORY,
  ORDERS_COUNT_PROGRESS,
  ORDERS_CREATED_AT_SCATTER,
  ORDERS_CREATED_AT_SMARTSCALAR,
  PEOPLE_LOCATION_MAP,
  PEOPLE_SOURCE_FUNNEL,
  PIVOT_TABLE_CARD,
  PRODUCTS_AVERAGE_BY_CATEGORY,
  PRODUCTS_AVERAGE_BY_CATEGORY_ROW,
  PRODUCTS_AVERAGE_BY_CATEGORY_WATERFALL,
  PRODUCTS_COUNT_BY_CATEGORY_PIE,
  PRODUCTS_COUNT_SUM_BY_CREATED_AT_COMBO,
  SAMPLE_FLOW_SANKEY,
  SCALAR_CARD,
  STEP_COLUMN_CARD,
  ...
  describe("Empty Document", () => {
    ...
    describe("Card Embeds", () => {
      ...
      const chartTypes: ChartSpec[] = [
        ...
        {
          label: "area",
          card: ACCOUNTS_COUNT_BY_CREATED_AT_AREA,
          paddingX: 16 + PADDING_CARD,
          selector: "[data-testid='chart-container'] > :first-child",
        },
        {
          label: "bar",
          card: PRODUCTS_AVERAGE_BY_CATEGORY,
          paddingX: 16 + PADDING_CARD,
          selector: "[data-testid='chart-container'] > :first-child",
        },
        {
          label: "row",
          card: PRODUCTS_AVERAGE_BY_CATEGORY_ROW,
          paddingX: 16 + PADDING_CARD,
          selector: "[data-testid='row-chart-container']",
        },
        {
          label: "waterfall",
          card: PRODUCTS_AVERAGE_BY_CATEGORY_WATERFALL,
          paddingX: 16 + PADDING_CARD,
          selector: "[data-testid='chart-container'] > :first-child",
        },
        {
          label: "combo",
          card: PRODUCTS_COUNT_SUM_BY_CREATED_AT_COMBO,
          paddingX: 16 + PADDING_CARD,
          selector: "[data-testid='chart-container'] > :first-child",
        },
        {
          label: "scatter",
          card: ORDERS_CREATED_AT_SCATTER,
          paddingX: 16 + PADDING_CARD,
          selector: "[data-testid='chart-container'] > :first-child",
        },
        {
          label: "map",
          card: PEOPLE_LOCATION_MAP,
          paddingX: PADDING_CARD,
        ...
        {
          label: "funnel",
          card: PEOPLE_SOURCE_FUNNEL,
          paddingX: 16 + 8 + PADDING_CARD,
          selector: "[data-testid='funnel-chart']",
        },
        {
          label: "sankey",
          card: SAMPLE_FLOW_SANKEY,
          paddingX: PADDING_CARD,
          selector: "[data-testid='chart-container'] > :first-child",
        },
        {
          label: "progress",
          card: ORDERS_COUNT_PROGRESS,
          paddingX: PADDING_CARD,
          selector: "[data-testid='progress-bar-root']",
        },
        {
          label: "table",
          card: STEP_COLUMN_CARD,
          paddingX: PADDING_CARD,
          selector: "[data-testid='table-root']",
        },
        {
          label: "pivot",
          card: PIVOT_TABLE_CARD,
          paddingX: PADDING_CARD,
          selector: "[data-testid='pivot-table']",
        },
        {
          label: "scalar",
          card: SCALAR_CARD.LANDING_PAGE_VIEWS,
          paddingX: PADDING_CARD,
          selector: "[data-testid='scalar-root']",
        },
        {
          label: "smartscalar",
          card: ORDERS_CREATED_AT_SMARTSCALAR,
          paddingX: PADDING_CARD,
          selector: "[data-testid='scalar-root']",
        },
      ];
