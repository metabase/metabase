...
DROP TABLE IF EXISTS "schema_20"."test_data_with_timezones_users" CASCADE;

CREATE TABLE "schema_20"."test_data_with_timezones_users" (
...
DROP TABLE IF EXISTS "schema_20"."data_with_timezones_categories" CASCADE;

CREATE TABLE "schema_20"."data_with_timezones_categories" (
  "id" INTEGER IDENTITY(1, 1),
  "name" VARCHAR(1024) NOT NULL,
  PRIMARY KEY ("id")
);

DROP TABLE IF EXISTS "schema_20"."est_data_with_timezones_venues" CASCADE;

CREATE TABLE "schema_20"."est_data_with_timezones_venues" (
  "id" INTEGER IDENTITY(1, 1),
  "name" VARCHAR(1024),
  "category_id" INTEGER,
  "latitude" FLOAT8,
...
DROP TABLE IF EXISTS "schema_20"."t_data_with_timezones_checkins" CASCADE;

CREATE TABLE "schema_20"."t_data_with_timezones_checkins" (
  "id" INTEGER IDENTITY(1, 1),
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER,
...
ALTER TABLE
  "schema_20"."est_data_with_timezones_venues"
ADD
  CONSTRAINT "tegory_id_categories_341257635" FOREIGN KEY ("category_id") REFERENCES "schema_20"."data_with_timezones_categories" ("id");

ALTER TABLE
  "schema_20"."t_data_with_timezones_checkins"
ADD
  CONSTRAINT "eckins_user_id_users_660849906" FOREIGN KEY ("user_id") REFERENCES "schema_20"."test_data_with_timezones_users" ("id");

ALTER TABLE
  "schema_20"."t_data_with_timezones_checkins"
ADD
  CONSTRAINT "ins_venue_id_venues_1367144309" FOREIGN KEY ("venue_id") REFERENCES "schema_20"."est_data_with_timezones_venues" ("id");

-- 15 rows
INSERT INTO "schema_20"."test_data_with_timezones_users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "schema_20"."data_with_timezones_categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "schema_20"."est_data_with_timezones_venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "schema_20"."t_data_with_timezones_checkins" ("date", "user_id", "venue_id")
VALUES
