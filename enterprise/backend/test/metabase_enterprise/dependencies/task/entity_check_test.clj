...
(deftest ^{:parallel false} batch-size-zero-suppresses-event-triggers-but-stays-warm-test
...
(deftest ^{:parallel false} post-run-reschedule-licence-states-test
...
(deftest ^{:parallel false} token-event-restarts-the-job-test
