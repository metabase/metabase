...
redirect_from:
  - /docs/latest/data-modeling/model-persistence
---

# Model persistence

> Prefer [Transforms](../transforms/transforms-overview.md) instead of model persistence. Model persistence remains supported for now, but it will be deprecated in future versions of Metabase. You can [convert models to transforms in bulk](../transforms/query.md#convert-models-to-transforms).
...
You can view the logs for model persistence in **Monitor** > **Model persistence log**. See [Model persistence log](../../monitor/model-persistence-log.md).
