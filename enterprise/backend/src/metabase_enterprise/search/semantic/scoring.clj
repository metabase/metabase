(ns metabase-enterprise.search.semantic.scoring
  (:require
...
(comment
  (def embedding-model ((requiring-resolve 'metabase-enterprise.search.semantic.embedding/get-configured-model)))
  (def index ((requiring-resolve 'metabase-enterprise.search.semantic.index/default-index) embedding-model))
