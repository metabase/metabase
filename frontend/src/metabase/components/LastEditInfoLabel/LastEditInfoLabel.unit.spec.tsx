...
describe("LastEditInfoLabel", () => {
  ...
  it("should display last editor's name", () => {
    ...
    // checkNotNull for the two vars
    const firstName = checkNotNull(first_name);
    const lastName = checkNotNull(last_name);

    // Example: John Doe —> John D.
    const expectedName = `${firstName} ${lastName.charAt(0)}.`;
