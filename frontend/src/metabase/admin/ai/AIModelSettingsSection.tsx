      ...
      <Stack gap="lg">
        ...
        {supportsFastMode && (
          <AdminSettingInput
            name="llm-fast-mode"
            title={t`Fast mode`}
            description={t`Get faster responses from the default model at a higher price per token. Requires an Anthropic account enrolled in the fast mode research preview, and isn't available with a Priority Tier commitment.`}
            inputType="boolean"
          />
        )}
      </Stack>
