...
You can explore metrics, break them out by different dimensions compare metrics and [measures](../data-studio/measures.md) to each other, and do math with metrics (like add or divide metrics by each other) in the [Metrics Explorer](../questions/metrics-explorer.md).
