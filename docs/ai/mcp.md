...
> To learn about using the Metabase MCP server and CLI for AI data exploration, [register for the MCP and CLI workshop](https://www.metabase.com/events/workshop-metabase-mcp-cli).
