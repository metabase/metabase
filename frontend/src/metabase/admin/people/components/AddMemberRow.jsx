      ...
      <td colSpan="4" style={{ padding: 0 }}>
        ...
        >
          {Array.from(selectedUsersById.values()).map(user => (
            ...
            >
              {/* https://user-images.githubusercontent.com/1937582/171614059-e110090d-2b42-4dc3-870f-3219f23673fc.png */}
              {user.common_name}
              <Icon
  ...
  return (
    ...
    >
      ...
      <span className={cx("h3", { "text-white": selected })}>
        {/* https://user-images.githubusercontent.com/1937582/171614859-01352adf-eb88-460b-a894-6027c95e96b2.png */}
        {user.common_name}
      </span>
    </div>
  );
