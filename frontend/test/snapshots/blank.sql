...
(1, TIMESTAMP '2019-12-27 10:37:36.806', TIMESTAMP '2019-12-27 10:37:37.301', 'Sample Dataset', NULL, '{"db":"zip:~/metabase/target/uberjar/metabase.jar!/sample-dataset.db;USER=GUEST;PASSWORD=guest"}', 'h2', TRUE, TRUE, NULL, NULL, '0 50 * * * ? *', '0 50 0 * * ? *', 'America/Los_Angeles', FALSE, NULL, TRUE);     
