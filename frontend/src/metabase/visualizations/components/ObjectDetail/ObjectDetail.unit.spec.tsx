...
describe("Object Detail", () => {
  ...
  it("shows a question link on dashboards", () => {
    render(
      <ObjectDetailWrapper
        data={testDataset as any}
        question={
        ...
        zoomedRowID={0}
        dashcard={
          { name: "fakeDashCardToMakeTheTestThinkThisIsOnADashboard" } as any
        }
        tableForeignKeys={[]}
        tableForeignKeyReferences={[]}
        settings={{
    ...
    expect(screen.getByLabelText("insight icon")).toBeInTheDocument();
  });
});
