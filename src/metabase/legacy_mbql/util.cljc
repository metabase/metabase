...
(defn unique-name-generator
  ...
  escaping characters disallowed in a column alias. Note that there is unfortunately this generate is subtly broken
  when limiting the length, see [[metabase.upload.util-test/unique-name-generator-test]] for a test demonstrating it.
