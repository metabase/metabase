...
const emptyVizConfig: Record<SupportedDisplayType, EmptyVizConfig> = {
  area: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? areaEmptyState : null,
    get primaryText() {
  ...
  bar: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? barEmptyState : null,
    get primaryText() {
  ...
  combo: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? comboEmptyState : null,
    get primaryText() {
  ...
  funnel: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? funnelEmptyState : null,
    get primaryText() {
  ...
  gauge: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? gaugeEmptyState : null,
    get primaryText() {
  ...
  line: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? lineEmptyState : null,
    get primaryText() {
  ...
  map: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? mapEmptyState : null,
    get primaryText() {
  ...
  pie: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? pieEmptyState : null,
    get primaryText() {
      return t`Then pick a metric and a column to group by.`;
    },
    get secondaryText() {
  ...
  pivot: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? pivotEmptyState : null,
    get primaryText() {
  ...
  progress: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? progressEmptyState : null,
    get primaryText() {
  ...
  row: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? rowEmptyState : null,
    get primaryText() {
      return t`Then pick a metric and a column to group by.`;
    },
    get secondaryText() {
  ...
  sankey: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? sankeyEmptyState : null,
    get primaryText() {
  ...
  scalar: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? scalarEmptyState : null,
    get primaryText() {
  ...
  scatter: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? scatterEmptyState : null,
    get primaryText() {
  ...
  smartscalar: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? smartscalarEmptyState : null,
    get primaryText() {
  ...
  waterfall: {
    imgSrc: !process.env.IS_EMBEDDING_SDK ? waterfallEmptyState : null,
    get primaryText() {
