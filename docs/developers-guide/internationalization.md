...
Metabase allows for translations into many languages. An authoritative list is generated at `resources/locales.edn` by the `build-translation-resources` build script.
