  ...
  return (
    <Stack gap="lg">
      ...
      <ConfirmModal
        ...
        confirmButtonProps={{ disabled: deleting?.in_use_message != null }}
...
function getDeleteWarning(
  ...
  if (deleting?.in_use_message) {
    return deleting.in_use_message;
  }
  return providerTypes.find((type) => type.type === deleting?.type)?.managed
