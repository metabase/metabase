...
- We don't collect [Activity](#activity-log-model) and [View](#view-log-model) data on Metabase Open Source, so if you upgrade from Open Source to a Pro or Enterprise plan, you will not see usage data from before your upgrade in Usage Analytics.
