...
If your admin has [allowed domains for images](../configuring-metabase/domains.md#allowed-domains-for-images), you can add an image to a dashboard. Add a text card and use Markdown image syntax:
