...
import { SummarizePicker } from "embedding-sdk/components/private/Question/components/Summarize/SummarizePicker";
import {
  MultiStepPopover,
  type MultiStepState,
 ...
 * @category Question
 */
export type QuestionSummarizeDropdownProps = Omit<
  PopoverProps,
...
export const SummarizeDropdown = ({
  ...popoverProps
}: QuestionSummarizeDropdownProps) => {
