...
(def ^:private pattern+base-types+special-type
  ...
  [[#"^id$"                          any-type         :type/PK]
   ...
   [#"birth(?:_?)da(?:te|y)"         timestamp-type   :type/Birthdate]
   [#"da(?:te|y)(?:_?)of(?:_?)birth" timestamp-type   :type/Birthdate]
   [#"price"                         number-type      :type/Price]
   [#"password"                      text-type        :type/Password]])
