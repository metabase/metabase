...
;;; TODO -- does this test belong here, or in the `eid-translation` module?
(deftest ->id-test
  (eid-translation/clear-translation-count!)
  (is (= (assoc eid-translation/default-counter :total 0)
         (eid-translation/get-translation-count)))
  (mt/with-temp [:model/Card {card-id :id card-eid :entity_id} {}]
    ...
    (is (partial= {:ok 0 :total 0} (eid-translation/get-translation-count))
    ...
    (is (partial= {:ok 2 :total 2} (eid-translation/get-translation-count))
