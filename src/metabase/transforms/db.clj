...
(mu/defn latest-run-start-times-query
  ...
  ([transform-ids :- [:maybe [:or
                              [:set ::lib.schema.id/transform]
                              [:sequential ::lib.schema.id/transform]]]]
