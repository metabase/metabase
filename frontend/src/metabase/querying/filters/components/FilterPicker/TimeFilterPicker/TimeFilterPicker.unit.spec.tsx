...
function getTimeInputByDisplayValue(value: string) {
  const input = screen.getByDisplayValue(value);
  if (!(input instanceof HTMLInputElement)) {
    throw new Error(`Expected ${value} input to be an HTMLInputElement`);
  }
  return input;
}

function getTimeInputsByDisplayValue(value: string) {
  return screen
...
describe("TimeFilterPicker", () => {
  ...
  describe("new filter", () => {
    ...
    it("should add a filter with one value", async () => {
      ...
      const input = getTimeInputByDisplayValue("00:00");
    ...
    it("should add a filter with two values", async () => {
      ...
      const [leftInput, rightInput] = getTimeInputsByDisplayValue("00:00");
    ...
    it("should handle invalid input", async () => {
      ...
      await typeTime(getTimeInputByDisplayValue("00:00"), "32:71");
      await userEvent.click(screen.getByText("Add filter"));
  ...
  describe("existing filter", () => {
    describe("with one value", () => {
      ...
      it("should update a filter", async () => {
        ...
        await typeTime(getTimeInputByDisplayValue("00:00"), "20:45");
    ...
    describe("with two values", () => {
      ...
      it("should update a filter", async () => {
        ...
        await typeTime(getTimeInputByDisplayValue("11:15"), "8:00");
        await userEvent.click(screen.getByText("Update filter"));
        ...
        await typeTime(getTimeInputByDisplayValue("13:00"), "17:31");
        await userEvent.click(screen.getByText("Update filter"));
    ...
    it("should handle invalid filter value", async () => {
      ...
      const input = getTimeInputByDisplayValue("09:06");
