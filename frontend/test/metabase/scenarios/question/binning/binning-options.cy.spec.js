...
describe("scenarios > binning > binning options", () => {
  ...
  context("via simple question", () => {
    it("should render number binning options correctly", () => {
      ...
      getAllOptions({ options: NUMBER_OPTIONS, isSelected: "Auto bin" });
    });
    ...
    it("should render time series binning options correctly", () => {
      ...
      getAllOptions({ options: TIME_SERIES_OPTIONS, isSelected: "Month" });
    });
    ...
    it("should render longitude/latitude binning options correctly", () => {
      ...
      getAllOptions({ options: LONGITUDE_OPTIONS, isSelected: "Auto bin" });
    });
  });
...
function getAllOptions({ options, isSelected } = {}) {
  ...
  // Using `.last()` works when only one popover is open so it covers both scenarios.
  popover()
    .last()
    .within(() => {
