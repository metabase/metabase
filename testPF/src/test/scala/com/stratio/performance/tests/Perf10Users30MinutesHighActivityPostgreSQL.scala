...
class Perf10Users30MinutesHighActivityPostgreSQL extends Simulation with Common with Test_10Users
    with Test_30MinutesDuration with Test_Concurrent15SecondsUsersIncrement with Test_HighLoad
    with Test_PostgreSQLQuery {

  val executionName: String = "Launch PostgreSQL QUERY (10 users - 30 minutes - high activity)"
