...
(expect false (#'ga.qp/built-in-segment? 1000))
(expect false (#'ga.qp/built-in-segment? [:filter-literal ":("]))
(expect false (#'ga.qp/built-in-segment? [:segment 100]))
(expect true  (#'ga.qp/built-in-segment? [:segment "wow"]))
