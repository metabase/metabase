...
(deftest ^:parallel resolve-source-validation-test
...
(deftest ^:parallel response-structure-test
...
(deftest ^:parallel path-generation-test
...
(deftest ^:parallel entity-not-found-test
