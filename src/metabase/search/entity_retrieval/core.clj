(ns metabase.search.entity-retrieval.core
  ...
  (:require
   ...
   [metabase.search.entity-retrieval.db :as entity-retrieval.db]
   [metabase.search.entity-retrieval.mirror]
   [potemkin :as p]))

(comment metabase.search.entity-retrieval.mirror/keep-me)
