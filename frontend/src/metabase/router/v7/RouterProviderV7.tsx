...
/**
 * react-router v7 hosting the app as a data router. The whole facade tree goes
 * in as real data routes, so there is no descendant `<Routes>` left. No route
 * has a loader, `lazy`, or middleware yet: adding those per subtree is what
 * DEV-2291 does from here.
 *
