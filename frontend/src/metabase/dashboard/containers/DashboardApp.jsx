...
const DashboardApp = props => {
  ...
  const [addCardOnLoad, setAddCardOnLoad] = useState(options.add && parseInt(options.add));
  ...
  useEffect(() => {
    const hash = parseHashOptions(props.location.hash);
    setEditingOnLoad(hash.edit);
    setAddCardOnLoad(hash.add && parseInt(hash.add));
  }, [props.location.hash]);
