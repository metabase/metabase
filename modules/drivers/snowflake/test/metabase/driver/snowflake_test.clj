...
(deftest ddl-statements-test
  ...
  (is (= ["DROP TABLE IF EXISTS \"test-data\".\"PUBLIC\".\"users\";"
          "CREATE TABLE \"test-data\".\"PUBLIC\".\"users\" (\"name\" TEXT  ,\"last_login\" TIMESTAMP_LTZ  ,\"password\" TEXT , \"id\" INTEGER AUTOINCREMENT, PRIMARY KEY (\"id\")) ;"
          "DROP TABLE IF EXISTS \"test-data\".\"PUBLIC\".\"categories\";"
          "CREATE TABLE \"test-data\".\"PUBLIC\".\"categories\" (\"name\" TEXT , \"id\" INTEGER AUTOINCREMENT, PRIMARY KEY (\"id\")) ;"
          "DROP TABLE IF EXISTS \"test-data\".\"PUBLIC\".\"venues\";"
          "CREATE TABLE \"test-data\".\"PUBLIC\".\"venues\" (\"name\" TEXT  ,\"latitude\" FLOAT  ,\"longitude\" FLOAT  ,\"price\" INTEGER  ,\"category_id\" INTEGER , \"id\" INTEGER AUTOINCREMENT, PRIMARY KEY (\"id\")) ;"
          "DROP TABLE IF EXISTS \"test-data\".\"PUBLIC\".\"checkins\";"
          "CREATE TABLE \"test-data\".\"PUBLIC\".\"checkins\" (\"user_id\" INTEGER  ,\"venue_id\" INTEGER  ,\"date\" DATE , \"id\" INTEGER AUTOINCREMENT, PRIMARY KEY (\"id\")) ;"
          "ALTER TABLE \"test-data\".\"PUBLIC\".\"venues\" ADD CONSTRAINT \"tegory_id_categories_927642602\" FOREIGN KEY (\"category_id\") REFERENCES \"test-data\".\"PUBLIC\".\"categories\" (\"id\");"
          "ALTER TABLE \"test-data\".\"PUBLIC\".\"checkins\" ADD CONSTRAINT \"ckins_user_id_users_-815717481\" FOREIGN KEY (\"user_id\") REFERENCES \"test-data\".\"PUBLIC\".\"users\" (\"id\");"
          "ALTER TABLE \"test-data\".\"PUBLIC\".\"checkins\" ADD CONSTRAINT \"ns_venue_id_venues_-1854903846\" FOREIGN KEY (\"venue_id\") REFERENCES \"test-data\".\"PUBLIC\".\"venues\" (\"id\");"]
