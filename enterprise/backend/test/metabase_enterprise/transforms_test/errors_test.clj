...
(deftest ex-rejects-undeclared-error-type-test
  (testing "a literal keyword absent from errors/all fails at macro-expansion"
    ...
    (let [e (is (thrown? clojure.lang.Compiler$CompilerException
                         (eval '(metabase-enterprise.transforms-test.errors/ex
                                 :metabase-enterprise.transforms-test.errors/not-a-real-error-type
                                 "msg" {}))))]
  ...
  (testing "a computed keyword absent from errors/all fails at runtime"
    (let [t :metabase-enterprise.transforms-test.errors/also-not-real]
      (is (thrown-with-msg?
