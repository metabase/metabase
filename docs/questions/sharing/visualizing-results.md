...
- **Add a trend line**. If you're looking at a time series chart, you can turn on a trend line to show where things are heading. To add a trend line, you must choose exactly one time field grouping.
  ![Trend lines](../images/trend-lines.png)
