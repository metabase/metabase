...
| `id`            | integer or string | Numeric id of the alert to update. The same numeric id as a string. Alerts have no entity_id.                                                                                                                                                     |
...
| `recipients`    | array             | Who gets the email: numeric user ids, or email addresses. Defaults to you. On update this replaces the current list. Not used for channel "slack".                                                                                                |
