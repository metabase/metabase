(ns metabase-enterprise.workspaces-deprecated.api.workspace-instance
  "EE API endpoints for the workspace loaded on this (child) instance, served under
   `/api/ee/workspace-instance`. See [[metabase-enterprise.workspaces-deprecated.api.workspace-manager]]
