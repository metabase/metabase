...
(defn- jetty-config []
  (cond-> (m/filter-vals
           ...
           {:port                 (config/config-int :mb-jetty-port)
            ...
            :request-header-size  (config/config-int :mb-jetty-max_request_header_size_bytes)
            :response-header-size (config/config-int :mb-jetty-max_response_header_size_bytes)
