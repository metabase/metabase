...
summary: How admins can enable CSV uploads by connecting a database with write access, selecting an upload schema, and granting people data and collection permissions.
---
