...
(expect {:end "2016-06-06", :start "2016-05-03"} (test-relative "past3days"))
...
(expect {:end "2016-06-06", :start "2016-04-06"} (test-relative "past2months"))
(expect {:end "2016-06-06", :start "2015-03-06"} (test-relative "past13months"))
(expect {:end "2016-06-06", :start "2015-06-06"} (test-relative "past1years"))
(expect {:end "2016-06-06", :start "2000-06-06"} (test-relative "past16years"))
(expect {:end "2016-06-06", :start "2016-06-08"} (test-relative "next3days"))
(expect {:end "2016-06-15", :start "2016-06-08"} (test-relative "next7days"))
(expect {:end "2016-07-07", :start "2016-06-08"} (test-relative "next30days"))
(expect {:end "2016-06-08", :start "2016-06-08"} (test-relative "next2months"))
(expect {:end "2017-07-08", :start "2016-06-08"} (test-relative "next13months"))
(expect {:end "2017-06-08", :start "2016-06-08"} (test-relative "next1years"))
(expect {:end "2032-06-08", :start "2016-06-08"} (test-relative "next16years"))
(expect {:end "2016-06-07", :start "2016-06-08"} (test-relative "thisday"))
