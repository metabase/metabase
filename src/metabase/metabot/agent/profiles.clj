...
(register-profile!
 {:name            :nlq
  ...
  :max-iterations  10
  :temperature     0.3
  ;; `search` for the nlq profile is backed by the curated semantic layer (see
  ;; tools.search-semantic-layer), not the general instance search.
  :tools           [#'tools/search-semantic-layer-tool
                    #'tools/read-resource-tool
                    #'tools/construct-notebook-query-tool
                    #'tools/navigate-user-tool
                    #'tools/create-chart-tool
