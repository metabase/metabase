...
Once you've created your metabaseGroups attribute, you will need to update it for each user you would like to be automatically added to a Metabase group. For each of use, we recommend using the same name for the groups you would use in Metabase.
