...
(defsetting ssl-certificate-public-key
  (str (lazy-tru "Base-64 encoded public key for this site's SSL certificate.")
       (lazy-tru "Specify this to enable HTTP Public Key Pinning.")
       (lazy-tru "See {0} for more information." "http://mzl.la/1EnfqBf")))
