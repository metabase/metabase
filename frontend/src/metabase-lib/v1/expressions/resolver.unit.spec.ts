...
describe("resolver", () => {
  describe.each(["expression", "boolean"])("startRule = %s", (startRule) => {
    ...
    describe("type = string", () => {
      ...
      it("should not resolve metrics", () => {
        expect(() => string("Foo Metric")).toThrow("Unknown Field: Foo Metric");
      });
    });
    ...
    describe("type = number", () => {
      ...
      it("should not resolve metrics", () => {
        expect(() => number("Foo Metric")).toThrow("Unknown Field: Foo Metric");
      });
    });
