...
export const getEmbedServerCodeExampleOptions = (
...
): ServerCodeSampleConfig[] => [
  {
    ...
    getIframeQuerySource: node.getIframeQuerySource(params),
  ...
  },
  {
    ...
    getIframeQuerySource: ruby.getIframeQuerySource(params),
    mode: "ace/mode/ruby",
  },
  {
    name: "Python",
    ...
    getIframeQuerySource: python.getIframeQuerySource(params),
  ...
  },
  {
    ...
    getIframeQuerySource: closure.getIframeQuerySource(params),
