...
3. Make sure that Metabase is using a role with the correct privileges to connect to your data warehouse. See [Granting database privileges](../databases/connecting.md#granting-database-privileges).
