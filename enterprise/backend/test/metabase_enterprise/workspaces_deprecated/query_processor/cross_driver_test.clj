(ns ^:mb/driver-tests metabase-enterprise.workspaces-deprecated.query-processor.cross-driver-test
...
(def ^:private cross-driver-test-drivers
  "Drivers we exercise with these end-to-end remap tests. Restricted to a small
   ...
   behavior is covered by [[metabase-enterprise.workspaces-deprecated.table-remapping-test]]
   unit tests and the SQLGlot corpus tests in
   [[metabase-enterprise.workspaces-deprecated.query-processor.driver-corpus-test]]."
  #{:h2 :postgres})
