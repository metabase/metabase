...
export type QuestionProviderProps = PropsWithChildren<
  QuestionConfig &
...
export type QuestionContextType = Omit<
...
> &
  Pick<
    ...
    | "withDownloads"
  > &
  Pick<QuestionProviderProps, "variant"> & {
    plugins: QuestionConfig["componentPlugins"] | null;
