...
- Run Visual Tests: `bun test-visual:loki` (Note: do not commit screenshots from this, use the CI variant below, they will be more consistent)
- Run Visual Tests in CI: `bun test-visual:loki:ci`
- Update failing snapshots: `bun test-visual:loki-approve-diff`
- Generate an HTML Report: `bun test-visual:loki-report`
- Generate and Open Report: `bun test-visual:loki-report-open`
