...
DROP TABLE IF EXISTS "test-data"."default"."test_data_with_time_users"

CREATE TABLE "test-data"."default"."test_data_with_time_users" AS
SELECT
  *
FROM
  (
...
-- 15 rows
INSERT INTO "test-data"."default"."test_data_with_time_users" ("name", "last_login_date", "last_login_time", "password")
VALUES
