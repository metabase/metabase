2023-01-21 01:08:54,501 INFO data.sql :: No test data type mapping for driver :presto-jdbc for base type :type/DateTimeWithLocalTZ, falling back to ancestor base type :type/DateTimeWithTZ
2023-01-21 01:08:54,502 INFO data.sql :: No test data type mapping for driver :presto-jdbc for base type :type/TimeWithLocalTZ, falling back to ancestor base type :type/TimeWithTZ
2023-01-21 01:08:54,502 INFO data.sql :: No test data type mapping for driver :presto-jdbc for base type :type/TimeWithZoneOffset, falling back to ancestor base type :type/TimeWithTZ

DROP TABLE IF EXISTS "test_data"."default"."attempted_murders_attempts";

CREATE TABLE "test_data"."default"."attempted_murders_attempts" (
  "id" INTEGER,
  "date" DATE,
  "datetime" TIMESTAMP,
...
-- 20 rows
INSERT INTO "test_data"."default"."attempted_murders_attempts" ("date", "datetime", "datetime_ltz", "datetime_tz", "datetime_tz_id", "time", "time_ltz", "time_tz", "num_crows")
VALUES
(
  date '2019-11-01',
