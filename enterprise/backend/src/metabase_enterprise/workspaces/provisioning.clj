...
(mu/defn- mark-workspace! :- ::ws.schema/workspace
...
(mu/defn mark-workspace-provisioning! :- ::ws.schema/workspace
  "Atomically set `:database-provisioning`, the first status of the
   ...
   `workspace` copy."
  [workspace :- ::ws.schema/workspace]
  (mark-workspace! workspace :database-provisioning
                   (conj ws.schema/in-flight-statuses :provisioned)))

(mu/defn mark-workspace-deprovisioning! :- ::ws.schema/workspace
  "Atomically set `:instance-deprovisioning`, the first status of the
   ...
   `workspace` copy."
  [workspace :- ::ws.schema/workspace]
  (mark-workspace! workspace :instance-deprovisioning
