(ns metabase-enterprise.metabot-v3.agent.tools.create-dashboard-subscription
  ...
  (:require
   ...
   [metabase-enterprise.metabot-v3.tools.create-dashboard-subscription :as tools.create-dashboard-subscription]
...
(mu/defn ^{:tool-name          "create_dashboard_subscription"
           :capabilities       #{"backend:/api/ee/metabot-tools/create-dashboard-subscription"}
