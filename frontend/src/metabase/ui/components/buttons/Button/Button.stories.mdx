...
export const argTypes = {
  ...
  color: {
    options: { brand: "brand.1", success: "success.0", error: "error.0" },
    control: { type: "inline-radio" },
  },
  compact: {
...
export const CustomColorFullWidthGrid = GridTemplate.bind({});
CustomColorFullWidthGrid.args = {
  color: "error",
  fullWidth: true,
};

<Canvas>
  <Story name="Default size, full width, custom color">
    {CustomColorFullWidthGrid}
  </Story>
</Canvas>
...
export const CompactCustomColorFullWidthGrid = GridTemplate.bind({});
CompactCustomColorFullWidthGrid.args = {
  color: "error",
  compact: true,
  fullWidth: true,
};
...
<Canvas>
  <Story name="Compact size, full width, custom color">
    {CompactCustomColorFullWidthGrid}
  </Story>
</Canvas>
