...
export function getFilters(query: StructuredQueryObject): Array<FilterClause> {
...
export function setFilters(query: StructuredQueryObject, filters: Array<FilterClause>): StructuredQueryObject {
    if (filters.length === 0) {
