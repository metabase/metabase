...
(deftest ^:parallel combine-user-attributes-only-test
...
(deftest ^:parallel combine-user-and-tenant-attributes-test
...
(deftest ^:parallel combine-user-overrides-tenant-attributes-test
...
(deftest ^:parallel combine-system-attributes-override-everything-test
...
(deftest ^:parallel combine-empty-inputs-nil-test
  (testing "combine function with nil input"
    (is (= {} (tenants/combine nil)))))

(deftest ^:parallel combine-empty-inputs-all-nil-test
  (testing "combine function with all nil inputs"
    (is (= {} (tenants/combine nil nil nil)))))

(deftest ^:parallel combine-empty-inputs-empty-maps-test
  (testing "combine function with empty maps"
    (is (= {} (tenants/combine {} {} {})))))

(deftest ^:parallel combine-nil-user-with-tenant-and-system-test
