...
(deftest permissions-test
  (data/with-temp-copy-of-db
    (mt/with-no-data-perms-for-all-users!
      (data-perms/set-table-permission! (perms-group/all-users) (data/id :venues) :perms/data-access :unrestricted)
      ...
      (testing "They should see it if they have ad-hoc native query perms"
        (data-perms/set-database-permission! (perms-group/all-users) (data/id) :perms/native-query-editing :yes)
