...
export const METABASE_LIGHT_THEME: MetabaseThemeV2 = {
  ...
  colors: {
    ...
    "text-syntax-variable": baseColors.ocean[60],
    "text-syntax-string": baseColors.palm[60],
    "text-syntax-yellow": baseColors.dubloon[30],
    "text-syntax-constant": baseColors.lobster[60],
    "text-syntax-keyword": baseColors.octopus[60],
