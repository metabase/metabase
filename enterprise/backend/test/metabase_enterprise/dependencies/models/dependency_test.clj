...
(deftest ^{:parallel false} card-deps-maintenance-test-1-new-card
...
(deftest ^{:parallel false} card-deps-graph-test-1-mbql-card-chain
...
(deftest ^{:parallel false} card-deps-graph-test-2-native-card-chain
...
(deftest ^{:parallel false} card-deps-graph-metric-test
