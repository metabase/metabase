...
> Prefer [Transforms](../semantic-layer/transforms/transforms-overview.md) instead of model persistence. Model persistence remains supported for now, but it will be deprecated in future versions of Metabase. You can [convert models to transforms in bulk](../semantic-layer/transforms/query.md#convert-models-to-transforms).
