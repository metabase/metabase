...
DROP TABLE IF EXISTS "test-data-with-timezones"."PUBLIC"."users";

CREATE TABLE "test-data-with-timezones"."PUBLIC"."users" (
...
DROP TABLE IF EXISTS "test-data-with-timezones"."PUBLIC"."categories";

CREATE TABLE "test-data-with-timezones"."PUBLIC"."categories" (
  "id" INTEGER AUTOINCREMENT,
  "name" TEXT NOT NULL,
  PRIMARY KEY ("id")
);

DROP TABLE IF EXISTS "test-data-with-timezones"."PUBLIC"."venues";

CREATE TABLE "test-data-with-timezones"."PUBLIC"."venues" (
  "id" INTEGER AUTOINCREMENT,
  "name" TEXT,
  "category_id" INTEGER,
  "latitude" FLOAT,
...
DROP TABLE IF EXISTS "test-data-with-timezones"."PUBLIC"."checkins";

CREATE TABLE "test-data-with-timezones"."PUBLIC"."checkins" (
  "id" INTEGER AUTOINCREMENT,
  "date" DATE,
  "user_id" INTEGER,
  "venue_id" INTEGER,
...
ADD
  CONSTRAINT "tegory_id_categories_341257635" FOREIGN KEY ("category_id") REFERENCES "test-data-with-timezones"."PUBLIC"."categories" ("id");

ALTER TABLE
  "test-data-with-timezones"."PUBLIC"."checkins"
ADD
  CONSTRAINT "eckins_user_id_users_660849906" FOREIGN KEY ("user_id") REFERENCES "test-data-with-timezones"."PUBLIC"."users" ("id");

ALTER TABLE
  "test-data-with-timezones"."PUBLIC"."checkins"
ADD
  CONSTRAINT "ins_venue_id_venues_1367144309" FOREIGN KEY ("venue_id") REFERENCES "test-data-with-timezones"."PUBLIC"."venues" ("id");

-- 15 rows
INSERT INTO "test-data-with-timezones"."PUBLIC"."users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "test-data-with-timezones"."PUBLIC"."categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "test-data-with-timezones"."PUBLIC"."venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "test-data-with-timezones"."PUBLIC"."checkins" ("date", "user_id", "venue_id")
VALUES
