...
DROP TABLE IF EXISTS ` test_data_with_timezones `.` users `

CREATE EXTERNAL TABLE ` test_data_with_timezones `.` users ` (
  ` id ` INT,
  ` name ` STRING,
  ` last_login ` TIMESTAMP,
  ` password ` STRING
) LOCATION 's3://metabase-ci-athena-results/test_data_with_timezones/users/';

DROP TABLE IF EXISTS ` test_data_with_timezones `.` categories `

CREATE EXTERNAL TABLE ` test_data_with_timezones `.` categories ` (` id ` INT, ` name ` STRING) LOCATION 's3://metabase-ci-athena-results/test_data_with_timezones/categories/';

DROP TABLE IF EXISTS ` test_data_with_timezones `.` venues `

CREATE EXTERNAL TABLE ` test_data_with_timezones `.` venues ` (
  ` id ` INT,
  ` name ` STRING,
  ` category_id ` INT,
  ` latitude ` DOUBLE,
  ` longitude ` DOUBLE,
  ` price ` INT
) LOCATION 's3://metabase-ci-athena-results/test_data_with_timezones/venues/';

DROP TABLE IF EXISTS ` test_data_with_timezones `.` checkins `

CREATE EXTERNAL TABLE ` test_data_with_timezones `.` checkins ` (
  ` id ` INT,
  ` date ` TIMESTAMP,
  ` user_id ` INT,
  ` venue_id ` INT
) LOCATION 's3://metabase-ci-athena-results/test_data_with_timezones/checkins/';

-- 15 rows
INSERT INTO "test_data_with_timezones"."users" ("name", "last_login", "password")
VALUES
...
-- 75 rows
INSERT INTO "test_data_with_timezones"."categories" ("name")
VALUES
('African'),
('American'),
('Artisan'),
...
-- 100 rows
INSERT INTO "test_data_with_timezones"."venues" ("name", "category_id", "latitude", "longitude", "price")
VALUES
...
-- 1000 rows
INSERT INTO "test_data_with_timezones"."checkins" ("date", "user_id", "venue_id")
VALUES
