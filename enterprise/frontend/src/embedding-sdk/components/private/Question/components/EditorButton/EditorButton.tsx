 ...
 * @category Question
 */
export type QuestionEditorButtonProps = {
  /**
 ...
 * In custom layouts, the `EditorButton` _must_ have an {@link QuestionEditorButtonProps.onClick}` handler or the button won't do anything when clicked.
 *
 * @function
 * @category Question
 * @param props
