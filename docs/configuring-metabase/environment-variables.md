...
This will replace “Lato” as the font family.
...
Pick a dashboard to serve as the homepage. If people lack permissions to view the selected dashboard, Metabase will redirect them to the default homepage. To revert to the default Metabase homepage, simply turn off the toggle.
...
- Type: boolean
- Default: `true`
- [Exported as](../installation-and-operation/serialization.md): `enable-nested-queries`.
- [Configuration file name](./config-file.md): `enable-nested-queries`
...
Message to show while a query is running.
...
- Type: double
- Default: `60.0`
- [Configuration file name](./config-file.md): `query-caching-min-ttl`
...
- Type: integer
- Default: `10`
- [Configuration file name](./config-file.md): `query-caching-ttl-ratio`
...
- Type: boolean
- Default: `true`
- [Exported as](../installation-and-operation/serialization.md): `show-lighthouse-illustration`.
- [Configuration file name](./config-file.md): `show-lighthouse-illustration`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file.md): `ssl-certificate-public-key`

Base-64 encoded public key for this site's SSL certificate. Specify this to enable HTTP Public Key Pinning. See http://mzl.la/1EnfqBf for more information.
...
- Type: integer
- Default: `null`
- [Exported as](../installation-and-operation/serialization.md): `uploads-database-id`.
- [Configuration file name](./config-file.md): `uploads-database-id`
...
- Type: boolean
- Default: `false`
- [Exported as](../installation-and-operation/serialization.md): `uploads-enabled`.
...
- Type: string
- Default: `null`
- [Exported as](../installation-and-operation/serialization.md): `uploads-schema-name`.
- [Configuration file name](./config-file.md): `uploads-schema-name`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file.md): `uploads-table-prefix`
