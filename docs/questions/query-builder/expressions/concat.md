...
When you use non-string columns in `concat`, Metabase will ignore any [formatting](../../../data-modeling/metadata/formatting.md) that you applied to the columns when converting the column to a string.
