...
| [Hydra](https://hydras.io/blog/2022-09-28-metabase-and-hydra)                          | Hydra connections use the official [Postgres driver](https://www.metabase.com/docs/latest/databases/connections/postgresql). | Not applicable.                                                                                                              |
