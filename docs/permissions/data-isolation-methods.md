...
[Locked parameters](../embedding/parameters.md#restrict-data-with-locked-parameters) filter an embedded dashboard or question before Metabase displays it. Your app passes the filter value in a signed JWT. The filter is invisible to the person viewing the embed, and they can't change it.
...
- [Locked parameters for guest embeds](../embedding/parameters.md#restrict-data-with-locked-parameters)
