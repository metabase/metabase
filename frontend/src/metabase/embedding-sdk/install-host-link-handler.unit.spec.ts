...
import { openUrl, resetHostLinkHandler } from "metabase/urls";
import { createMockTokenFeatures } from "metabase-types/api/mocks";

import { installSdkHostLinkHandler } from "./install-host-link-handler";

describe("installSdkHostLinkHandler", () => {
