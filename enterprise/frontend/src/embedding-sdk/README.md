...
```bash
docker run -d -p 3000:3000 --name metabase metabase/metabase-dev:embedding-sdk-0.1.6-test1
```

### 2. Running the Jar file

1. Download the Jar file from http://downloads.metabase.com/sdk/v0.1.6-test1/metabase.jar
