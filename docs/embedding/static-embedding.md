...
You can, however, restrict data in static embeds for specific people or groups by [locking parameters](./parameters.md#parameters-in-iframe-embeds).
...
5. Optional: [customize the appearance of the embed](./public-links.md#appearance-parameters)
6. Optional: set each parameter to **Editable** or **Locked**. Check out [Restrict data with locked parameters](./parameters.md#restrict-data-with-locked-parameters).
7. Click **Publish**.

## Adding the embedding URL to your website

The embedding URL for a question or dashboard is the Metabase URL that'll be displayed in your website's iframe. It's generated by your web server using your [Metabase site URL](../configuring-metabase/settings.md#site-url), [signed JWT](#how-static-embedding-works), and [parameters](./public-links.md#public-embed-parameters):
...
If you change the [parameters](./parameters.md#parameters-in-iframe-embeds) of your embedded item:
...
Static embeds take the same hash parameters as public embeds. See [Appearance parameters](./public-links.md#appearance-parameters).
...
For the full list options you can parameterize, see [Appearance parameters](./public-links.md#appearance-parameters).
...
- [Public embed parameters](./public-links.md#public-embed-parameters).
