...
<Canvas>
  <Story name="Single-line">{SingleLine}</Story>
</Canvas>
...
<Canvas>
  <Story name="Multi-line">{Multiline}</Story>
</Canvas>

### Truncated

export const MultilineTruncated = args => <Multiline {...args} lineClamp={2} />;

<Canvas>
  <Story name="Multi-line, truncated">{MultilineTruncated}</Story>
</Canvas>
