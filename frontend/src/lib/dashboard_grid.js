...
export const DEFAULT_SIZE = { width: 4, height: 4 };
...
export function getPositionForNewDashCard(cards, sizeX = DEFAULT_SIZE.width, sizeY = DEFAULT_SIZE.height, width = GRID_WIDTH) {
    let row = 0;
    let col = 0;
    while (row < 1000) {
