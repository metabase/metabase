...
Metabase Enterprise Edition allows you to [set up multiple subscriptions for the same dashboard](../enterprise-guide/dashboard-subscriptions.md), so you can send different emails or Slack messages to different groups of people, and with different filter values applied.
