...
(deftest ^{:parallel false} backfill-dependency-analysis-test
...
(deftest ^{:parallel false} backfill-transform-test
...
(deftest ^{:parallel false} backfill-snippet-test
...
(deftest ^{:parallel false} backfill-snippet-in-snippet-test
...
(deftest ^{:parallel false} backfill-snippet-referencing-card-test
...
(deftest ^{:parallel false} backfill-idempotency-test
...
(deftest ^{:parallel false} backfill-scheduling-test
...
(deftest ^{:parallel false} backfill-no-trigger-pile-up-test
...
(deftest ^{:parallel false} backfill-error-logging-test
...
(deftest ^{:parallel false} backfill-partial-batch-failure-test
...
(deftest ^{:parallel false} backfill-terminal-failure-test
...
(deftest ^{:parallel false} backfill-delayed-retry-test
...
(deftest ^{:parallel false} backfill-dependencies-on-serdes-load-test
...
(deftest ^{:parallel false} backfill-dependencies-on-token-update-test
...
(deftest ^{:parallel false} backfill-version-outdated-test
...
(deftest ^{:parallel false} backfill-no-status-row-test
...
(deftest ^{:parallel false} has-stale-or-outdated?-counts-no-status-row-test
...
(deftest ^{:parallel false} backfill-batch-shares-one-metadata-provider-test
...
(deftest ^{:parallel false} backfill-records-failure-for-fatal-error-test
...
(deftest ^{:parallel false} pending-retries-licence-states-test
...
(deftest ^{:parallel false} backfill-records-failure-for-never-processed-entity-test
...
(deftest ^{:parallel false} fatal-error-still-reschedules-test
