...
class Perf150Users30MinutesLowActivityPostgreSQL extends Simulation with Common with Test_150Users
    with Test_30MinutesDuration with Test_Concurrent15SecondsUsersIncrement with Test_LowLoad
    with Test_PostgreSQLQuery {

  val executionName: String = "Launch PostgreSQL QUERY (150 users - 30 minutes - low activity)"
