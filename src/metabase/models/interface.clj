...
(defn add-entity-id
  "Add an `:entity_id` to `obj` unless:
     (a) there's already one set; or
     (b) we're deserializing. Generating them at deserialization time can lead to duplicated entities if
         they're deserialized again."
  [obj & _]
