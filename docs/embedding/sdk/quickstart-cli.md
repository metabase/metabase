...
- If you set up multi-tenancy, the tool asks you for the column you want to use to sandbox the table (e.g., a user ID column). Metabase will sandbox data based on the values in that column.

## Generates React components to import into your app
