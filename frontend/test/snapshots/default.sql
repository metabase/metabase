...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_3F9C3209_9B9E_4120_9BC7_F91BC4ED7887 START WITH 4 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_802404BA_7C5B_425F_8A47_269DE298790A START WITH 2 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_D0200B05_E259_4B4E_9A13_869D6CB9CC92 START WITH 2 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B1882735_CE8B_404A_91F5_AE3E319D0FBE START WITH 6 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_E70BD844_ADA3_46A8_9E60_91B31737FA42 START WITH 11 BELONGS_TO_TABLE;    
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_42EE1162_656D_42FC_8A12_2FCD7D725019 START WITH 9 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_E6343DDA_1C2E_4672_8436_82EE83E13ECD START WITH 2 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0D47F4C6_3CE3_4920_A9FA_F51DB34F4C4D START WITH 6 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_8A38F894_935B_43EC_9552_6B57D616019F START WITH 6 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_614D013B_A6B6_473A_A9D7_05E97C7733A4 START WITH 6 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_51D98EB4_28FD_4525_A326_3121DEF8A183 START WITH 4 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_51CFFE2D_D814_4CD5_B844_D0ADA43942F2 START WITH 8 BELONGS_TO_TABLE;     
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_7C8CB652_4885_422B_9E54_17453F2E02D5 START WITH 2 BELONGS_TO_TABLE;     
...
(1, TIMESTAMP '2020-04-02 12:36:30.115', TIMESTAMP '2020-04-02 12:36:30.115', 2, 2, 0, 0, 1, 1, '[]', '{}');             
...
(1, '{"2":{"1":{"native":"write","schemas":"all"}},"1":{"1":{"native":"write","schemas":"all"}}}', '{"1":{"1":{"native":"none","schemas":"none"}},"4":{"1":{"schemas":"none","native":"none"}},"5":{"1":{"schemas":"all","native":"write"}}}', 1, TIMESTAMP '2020-04-02 12:36:28.294', NULL);   
...
('settings-last-updated', '2020-04-02 12:36:24.149');               
...
(1, '{"4":{"root":"none"},"1":{"root":"write"},"3":{"root":"write"},"2":{"root":"write"}}', '{"4":{"root":"write"},"1":{"root":"none"}}', 1, TIMESTAMP '2020-04-02 12:36:28.373', NULL);         
...
(1, TIMESTAMP '2020-04-02 12:36:30.036', TIMESTAMP '2020-04-02 12:36:30.036', 'Orders in a dashboard', NULL, 1, '[]', NULL, NULL, FALSE, NULL, NULL, FALSE, NULL, FALSE, NULL, NULL, NULL);
...
(2, 'user-joined', TIMESTAMP '2020-04-02 12:36:23.982', 1, 'user', 1, NULL, NULL, NULL, '{}'),
(3, 'card-create', TIMESTAMP '2020-04-02 12:36:28.724', 1, 'card', 1, 1, 2, NULL, '{"name":"Orders","description":null}'),
(4, 'card-create', TIMESTAMP '2020-04-02 12:36:29.155', 1, 'card', 2, 1, 2, NULL, '{"name":"Orders, Count","description":null}'),
(5, 'card-create', TIMESTAMP '2020-04-02 12:36:29.996', 1, 'card', 3, 1, 2, NULL, '{"name":"Orders, Count, Grouped by Created At (year)","description":null}'),
(6, 'dashboard-create', TIMESTAMP '2020-04-02 12:36:30.044', 1, 'dashboard', 1, NULL, NULL, NULL, '{"description":null,"name":"Orders in a dashboard"}'),
(7, 'dashboard-add-cards', TIMESTAMP '2020-04-02 12:36:30.14', 1, 'dashboard', 1, NULL, NULL, NULL, '{"description":null,"name":"Orders in a dashboard","dashcards":[{"name":"Orders","description":null,"id":1,"card_id":1}]}');      
...
('MetabaseScheduler', 'metabase.task.sync-and-analyze.trigger.1', 'DEFAULT', 'metabase.task.sync-and-analyze.job', 'DEFAULT', 'sync-and-analyze Database 1', 1585857600000, -1, 5, 'WAITING', 'CRON', 1585856184000, 0, NULL, 2, X''),
('MetabaseScheduler', 'metabase.task.update-field-values.trigger.1', 'DEFAULT', 'metabase.task.update-field-values.job', 'DEFAULT', 'update-field-values Database 1', 1585897200000, -1, 5, 'WAITING', 'CRON', 1585856184000, 0, NULL, 2, X'');     
...
(1, TIMESTAMP '2020-04-02 12:35:57.223', TIMESTAMP '2020-04-02 12:36:24.376', 'Sample Dataset', NULL, '{"db":"./resources/sample-dataset.db;USER=GUEST;PASSWORD=guest"}', 'h2', TRUE, TRUE, NULL, NULL, '0 0 * * * ? *', '0 0 0 * * ? *', 'America/Los_Angeles', FALSE, NULL, TRUE); 
...
(1, 'admin@metabase.com', 'Bobby', 'Tables', '$2a$10$lSTAoxv.XL50W7CyAU//BeFm7lmM8o0Aczt68QRtvAzu.8897KXom', '3d8babd9-e26c-42fd-b8d2-198030bbccab', TIMESTAMP '2020-04-02 12:36:23.688', TIMESTAMP '2020-04-02 12:36:23.983', TRUE, TRUE, NULL, NULL, FALSE, FALSE, FALSE, NULL, TIMESTAMP '2020-04-02 12:36:30.166', NULL),
(2, 'normal@metabase.com', 'Robert', 'Tableton', '$2a$10$5oVCDj.AMP9IMtupdDHx8OqYhw3l23F2YPhd6EN4gJIFomVdPjDqa', 'c7a7e994-a040-492c-b36c-0c392adde90f', TIMESTAMP '2020-04-02 12:36:24.726', NULL, FALSE, TRUE, '$2a$10$Kv9o8sx./z1h0aIhZrguQOnGkXhu98nllZjYu5E0i82tcWkxLXAvi', 1585856184728, FALSE, FALSE, FALSE, NULL, TIMESTAMP '2020-04-02 12:36:30.279', NULL),
(3, 'nodata@metabase.com', 'No Data', 'Tableton', '$2a$10$1Ig0NMCG0E0yS6j.TsGoWOvvjR.Q9vb7jWY2JvwuTonbfCeOtEOa6', '255dbbd5-a1fb-4649-bedd-7912cc399727', TIMESTAMP '2020-04-02 12:36:26.565', NULL, FALSE, TRUE, '$2a$10$58zNYmuK06BtT86Q7YY7AOQAM6QyJE4Zyz7U9gL2WYR3fdI/fQb4O', 1585856186573, FALSE, FALSE, FALSE, NULL, TIMESTAMP '2020-04-02 12:36:30.326', NULL),
(4, 'nocollection@metabase.com', 'No Collection', 'Tableton', '$2a$10$ecB4zmpneIUWhNtpRWwL1OyApD3q8a2/JespAiKPJ7g/Hj5wlBgnC', 'ebdd4cb0-795a-4bd1-b62e-ff44c4bca5d0', TIMESTAMP '2020-04-02 12:36:27.345', NULL, FALSE, TRUE, '$2a$10$naQh2DmRD65ESA4ONLamnOJbVZQW/Cpuu8zC1jGNnuY.d9aUjMGBe', 1585856187347, FALSE, FALSE, FALSE, NULL, TIMESTAMP '2020-04-02 12:36:30.391', NULL),
(5, 'none@metabase.com', 'None', 'Tableton', '$2a$10$AjA6932nG6ub4PaYdUzqZe0flW7.OLfM0rfEQmnGyTRVe4OmggOHu', '3f18fadf-c56b-4bcf-9b5d-4927a3598590', TIMESTAMP '2020-04-02 12:36:27.953', NULL, FALSE, TRUE, '$2a$10$4gU9KkLLFiZHBmxu/.pjr./tXfbHBHBD.9sypqUf3hwXeOktr1whm', 1585856187957, FALSE, FALSE, FALSE, NULL, TIMESTAMP '2020-04-02 12:36:30.466', NULL);
...
('4408fbaa-4b25-468e-a6da-5c20d94b5b01', 1, TIMESTAMP '2020-04-02 12:36:23.959', NULL);       
...
(1, 1, 'card', 1, TIMESTAMP '2020-04-02 12:36:28.716'),
(2, 1, 'card', 2, TIMESTAMP '2020-04-02 12:36:29.121'),
(3, 1, 'card', 3, TIMESTAMP '2020-04-02 12:36:29.991');            
...
(1, 'Card', 1, 1, TIMESTAMP '2020-04-02 12:36:28.696', '{"description":null,"archived":false,"collection_position":null,"table_id":2,"database_id":1,"enable_embedding":false,"collection_id":null,"query_type":"query","name":"Orders","read_permissions":null,"creator_id":1,"made_public_by_id":null,"embedding_params":null,"cache_ttl":null,"dataset_query":{"database":1,"query":{"source-table":2},"type":"query"},"id":1,"display":"table","visualization_settings":{},"public_uuid":null}', FALSE, TRUE, NULL),
(2, 'Card', 2, 1, TIMESTAMP '2020-04-02 12:36:29.147', '{"description":null,"archived":false,"collection_position":null,"table_id":2,"database_id":1,"enable_embedding":false,"collection_id":null,"query_type":"query","name":"Orders, Count","read_permissions":null,"creator_id":1,"made_public_by_id":null,"embedding_params":null,"cache_ttl":null,"dataset_query":{"database":1,"query":{"source-table":2,"aggregation":[["count"]]},"type":"query"},"id":2,"display":"table","visualization_settings":{},"public_uuid":null}', FALSE, TRUE, NULL),
(3, 'Card', 3, 1, TIMESTAMP '2020-04-02 12:36:29.984', '{"description":null,"archived":false,"collection_position":null,"table_id":2,"database_id":1,"enable_embedding":false,"collection_id":null,"query_type":"query","name":"Orders, Count, Grouped by Created At (year)","read_permissions":null,"creator_id":1,"made_public_by_id":null,"embedding_params":null,"cache_ttl":null,"dataset_query":{"type":"query","query":{"source-table":2,"aggregation":[["count"]],"breakout":[["datetime-field",["field-id",15],"year"]]},"database":1},"id":3,"display":"line","visualization_settings":{},"public_uuid":null}', FALSE, TRUE, NULL),
(4, 'Dashboard', 1, 1, TIMESTAMP '2020-04-02 12:36:30.048', '{"description":null,"name":"Orders in a dashboard","cards":[]}', FALSE, TRUE, NULL),
(5, 'Dashboard', 1, 1, TIMESTAMP '2020-04-02 12:36:30.141', '{"description":null,"name":"Orders in a dashboard","cards":[{"sizeX":2,"sizeY":2,"row":0,"col":0,"id":1,"card_id":1,"series":[]}]}', FALSE, FALSE, NULL);              
...
('MetabaseScheduler', 'par.attlocal.net1585856157073', 1585856187176, 7500);    
