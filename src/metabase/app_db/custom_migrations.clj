...
(def ^:private encrypted-setter-none-settings-v58
  ...
  ["active-users-count" "ai-eval-capture" "airgap-enabled"
   ...
   ;; still registered in v58 but renamed or removed on newer versions
   "enable-ai-entity-analysis?" "enable-ai-sql-fixer?" "enable-ai-sql-generation?"
   "enable-data-studio?" "enable-llm-autodescription?" "enable-transforms?"
   "offer-metabase-ai-paid?" "offer-metabase-ai-trial?" "prometheus-server-port"
   "site-uuid-for-metabot-tools"])
