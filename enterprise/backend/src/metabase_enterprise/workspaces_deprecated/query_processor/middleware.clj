(ns metabase-enterprise.workspaces-deprecated.query-processor.middleware
  ...
  (:require
   [metabase-enterprise.workspaces-deprecated.remapping.core :as ws.remapping]
   [metabase-enterprise.workspaces-deprecated.table-remapping :as ws.table-remapping]
...
;;; `table-spec->sqlglot-key`) live in [[metabase-enterprise.workspaces-deprecated.table-remapping]]
...
(defenterprise apply-workspace-remapping
  "**Phase 1 — preprocess.** Mutate cached table metadata so every QP middleware between here
   ...
   [[metabase-enterprise.workspaces-deprecated.transform-hooks/resolve-transform-target]] applies here:
